 ...
 * @generated
 */
public class RRC_Type extends Phrase_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (RRC_Type.this.useExistingInstance) {
        ...
        return new RRC(addr, RRC_Type.this);
    }
  };
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.examples.opennlp.RRC");
