...
public class EntityAnnotation_Type extends Annotation_Type {
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (EntityAnnotation_Type.this.useExistingInstance) {
        ...
        return new EntityAnnotation(addr, EntityAnnotation_Type.this);
    }
  };
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.examples.opennlp.EntityAnnotation");
  ...
  public String getComponentId(int addr) {
    if (featOkTst && casFeat_componentId == null)
      this.jcas.throwFeatMissing("componentId", "org.apache.uima.examples.opennlp.EntityAnnotation");
