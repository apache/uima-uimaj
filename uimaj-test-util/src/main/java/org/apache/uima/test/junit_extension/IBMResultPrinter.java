 ...
 */
public class IBMResultPrinter extends ResultPrinter implements TestListener
{
	...
	public IBMResultPrinter(PrintStream writer, boolean abortOnFail, boolean teeOutputStream)
	{
		//init class members
		super(writer);
		this.fWriter = writer;
