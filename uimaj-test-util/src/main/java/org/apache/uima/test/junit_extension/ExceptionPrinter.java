...
public class ExceptionPrinter
{
	 ...
	 * 
	 * @param stackTrace a exception stack trace
	...
	public static void printException(StackTraceElement[] stackTrace, String message)
	{
		...
		/*
		System.out.println(stackTraceElement[1].getClassName()+ "." + stackTraceElement[1].getMethodName() + 
						   "(" + stackTraceElement[1].getFileName() + ")");
		*/
