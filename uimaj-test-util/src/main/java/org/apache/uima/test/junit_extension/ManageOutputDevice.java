 ...
 * Methode output like System.out.println("blah") may be 
 * send to something else than the console. 
 */
public class ManageOutputDevice {
	 ...
	 * 
	 * @param descriptor a full qualified filename {@see java.io.File#File(String pathname)}
	...
	/**
	 * sets the <code>System.out</code> to the value, which was set, when the class
	...
	/**
	 * sets the <code>System.err</code> to the value, which was set, when this class
	 * was loaded by the VM.
	 */
	...
	/**
	 * sets the <code>System.err</code> and <code>System.out</code> 
	 * to a virtual <code>java.io.ByteArrayOutputStream</code>
	 */
