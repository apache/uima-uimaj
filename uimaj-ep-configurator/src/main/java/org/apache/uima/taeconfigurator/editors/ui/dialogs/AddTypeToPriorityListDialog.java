...
public class AddTypeToPriorityListDialog extends AbstractDialog {
  ...
  private String [] m_selectedTypeNames;  //this is the selection
	 ...
	 * @param parentShell
	 */
	public AddTypeToPriorityListDialog(
	    AbstractSection aSection, 
	    Set allowableTypeNameHash, 
		  String [] typesInList) {
		super(aSection, "Add Types to Priority List",
		    "Select one or more types and press OK");
		
		m_availableTypeNames = getAvailableTypeNames(allowableTypeNameHash, 
			typesInList);		
	}
	
	private String [] getAvailableTypeNames(
	    Set allowableTypeNameHash,
		  String [] alreadyUsedTypes) {
