...
public class Utility extends MessageDialog {
   ...
   */
	...
	public static Object[] removeElementsFromArray (
			Object [] source, Object element, Class componentClass, Comparator comp) {
		if (null == source)
			return null;
		int count = 0;
		for (int i = 0; i < source.length; i++) {
	...
	public static Object [] addElementToArray(
			Object [] source, Object element, Class componentClass) {
