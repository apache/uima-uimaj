...
public class ContextForPartDialog
	extends LimitedResourceSelectionDialog 
...
//	private MultiPageEditor editor;
  ...
  private XMLizable tbe;
	...
	public ContextForPartDialog(
		Shell parentShell,
		IAdaptable rootElement,
    XMLizable thingBeingEdited,
		IPath aExcludeDescriptor,
		MultiPageEditor aEditor,
    String aInitialPath) {
...
//		editor = aEditor;
    ...
    instructions.setText(MessageFormat.format(
        ...
        new Object[]{
           ...
           (tbe instanceof ResourceManagerConfiguration) ? "Resource Manager Configuration" : "unhandled - error",
