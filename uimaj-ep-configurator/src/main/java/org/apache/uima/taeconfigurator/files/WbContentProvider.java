 ...
 * org/eclipse/ui/model/WorkbenchContentProvider.java version 2.1
 ...
 */
public class WbContentProvider implements ITreeContentProvider, IResourceChangeListener {
  ...
  /**
   * The workbench has changed. Process the delta and issue updates to the viewer, inside the UI
   * thread.
   * 
