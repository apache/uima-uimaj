...
public class Strings {
	 ...
	 * @throws Exception
	 */
	public static int computeIndentLength(String line, int numberOfIndents, int tabWidth) throws Exception {
	...
	public static String trimIndentation(String source, int tabWidth, boolean considerFirstLine) throws Exception {
		try {
			ILineTracker tracker= new DefaultLineTracker();
			tracker.set(source);
			int size= tracker.getNumberOfLines();
