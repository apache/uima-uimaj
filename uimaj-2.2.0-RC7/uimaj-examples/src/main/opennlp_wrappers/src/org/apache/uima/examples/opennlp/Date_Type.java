 ...
 * @generated
 */
public class Date_Type extends EntityAnnotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (Date_Type.this.useExistingInstance) {
        ...
        return new Date(addr, Date_Type.this);
    }
  };
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.examples.opennlp.Date");
