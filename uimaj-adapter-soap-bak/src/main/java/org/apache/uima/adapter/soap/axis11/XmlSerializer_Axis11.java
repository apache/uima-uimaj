...
public class XmlSerializer_Axis11 implements Serializer
{
      ...
      throws IOException
  {
    if (value instanceof XMLizable)
    {
      try
      {
        ...
        SerializerContentHandler contentHandler =
           new SerializerContentHandler(context);
  ...
  /**
   * Inner class that implements SAX ContentHandler and writes events through
   * to the Axis SerializationContext.
   * 
   * 
   */
