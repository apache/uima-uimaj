 ...
 */
public final class AnnotationEditor extends StatusTextEditor implements ICasEditor,
        ISelectionListener {
  ...
  private class SmartAnnotateAction extends AbstractAnnotateAction {
    ...
    public void run() {
      ...
      if (isSomethingSelected()) {
        ...
        QuickTypeSelectionDialog typeDialog = new QuickTypeSelectionDialog(Display.getCurrent()
  ...
  private void setTextSize(int newSize) {
    ...
    if (font.getFontData().length > 0) {
      ...
      getSourceViewer().getTextWidget().setFont(
              new Font(font.getDevice(), fd.getName(), newSize, fd.getStyle()));
    }
  }
  ...
  public void createPartControl(Composite parent) {
    ...
    // can be detected
    getSourceViewer().getSelectionProvider().addSelectionChangedListener(
            new ISelectionChangedListener() {
              public void selectionChanged(SelectionChangedEvent event) {
                mFeatureStructureSelectionProvider.setSelection(new AnnotationEditorSelection(
                        (ITextSelection) event.getSelection(), new StructuredSelection(
                                ModelFeatureStructure.create(getDocument(),
    ...
    preferenceStoreChangeListener = (new IPropertyChangeListener() {
      ...
      public void propertyChange(PropertyChangeEvent event) {
        if (AnnotationEditorPreferenceConstants.ANNOTATION_EDITOR_TEXT_SIZE.equals(event
                .getProperty())) {
  ...
  private void initiallySynchronizeUI() {
    if (getDocument() != null) {
      ...
      IPreferenceStore sessionPreferences = getCasDocumentProvider().getSessionPreferenceStore(
              getEditorInput());
  ...
  protected void editorContextMenuAboutToShow(IMenuManager menu) {
    ...
    menu.appendToGroup(IWorkbenchActionConstants.MB_ADDITIONS,
            getAction(ITextEditorActionDefinitionIds.DELETE));
  ...
  public AnnotationStyle getAnnotationStyle(Type type) {
    ...
    IPreferenceStore prefStore = getCasDocumentProvider().getTypeSystemPreferenceStore(
            getEditorInput());
  ...
  private void syncAnnotations() {
    ...
    while (mAnnotations.hasNext()) {
      ...
      annotationsToAdd
              .put(new EclipseAnnotationPeer(annotationFS), new Position(annotationFS.getBegin(),
  ...
  private void setEditorSessionPreferences() {
    ...
    IPreferenceStore sessionStore = getCasDocumentProvider().getSessionPreferenceStore(
            getEditorInput());
  ...
  protected void createActions() {
    ...
    QuickAnnotateAction quickAnnotateAction = new QuickAnnotateAction(getSourceViewer()
            .getTextWidget());
    ...
    FindAnnotateAction findAnnotateAction = new FindAnnotateAction(this, getSourceViewer()
    ...
    WideLeftAnnotationSideAction wideLeftAnnotationSide = new WideLeftAnnotationSideAction(
            getDocument());
  ...
  public void dispose() {
    ...
    if (provider != null)
      provider.getTypeSystemPreferenceStore(getEditorInput()).removePropertyChangeListener(
