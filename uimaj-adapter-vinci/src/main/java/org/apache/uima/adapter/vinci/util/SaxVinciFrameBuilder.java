...
/**
 * A SAX content handler that builds a VinciFrame corresponding to the
 * SAX events received.
 * 
 * 
 */
public class SaxVinciFrameBuilder extends DefaultHandler implements ContentHandler 
{
   ...
   * This MUST be called before parsing a document.
   * 
  ...
  public void endElement(String namespaceURI, String localName, String qualifiedName)
  {
    ...
    if (mCurrentFrameName != null)
    {
      ...
      AFrame parent = (AFrame)mOpenFrames.peek();
      org.apache.vinci.transport.Attributes vinciAttrs = 
         parent.aadd(mCurrentFrameName, leafContent);
  ...
  /**
   * Gets the content to be included in a FrameLeaf.  This method just
   * returns the contents of the provided StringBuffer, but subclasses can
   * override to provide specialized content.
   * 
   * @param aFrameName name of the FrameLeaf
   * @param aAttributes attributes of FrameLeaf
   * @param aContentBuf StringBuffer containing the character data obtained
   *   from the SAX parser
   * 
