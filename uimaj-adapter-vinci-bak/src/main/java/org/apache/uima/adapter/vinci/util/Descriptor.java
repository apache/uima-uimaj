...
/**
 *  Instance of this class handles parsing of the xml descriptor files. It also retrieves values of the
 *  named attributes of the named elements.
 *  
 *
 * 
 */
public class Descriptor extends DefaultHandler 
{
	 ...
	 * 
	 * @param Fully qualified path the xml descriptor.
	 */
	 ...
	 * @param resourceSpecifierPath The resourceSpecifierPath to set
	 */
	 ...
	 * @param serializerClassName The serializerClassName to set
	 */
