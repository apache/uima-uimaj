...
public class AnnotatorTester
{
    ...
    * analysis engine.
    * 
    * @param descFilePath descriptor file path
    * @throws Exception if an analysis engine initialze error occurs.
    */
   ...
   /**
    * change the parameter name for the given tae
    * 
    ...
    */
   public void changeDelegateParameterSetting(
      String delegeteKey,
      String groupName,
      String paramName,
      Object paramValue)
      throws InvalidXMLException, ResourceInitializationException, IOException
   {
      ...
      AnalysisEngineDescription taeSpecifier =
         UIMAFramework.getXMLParser().parseAnalysisEngineDescription(new XMLInputSource(this.descFile));

      //get delegates
      Map delegates = taeSpecifier.getDelegateAnalysisEngineSpecifiers();
      ...
      if (delegates.containsKey(delegeteKey))
      {
         ...
         {
            delegate.getMetaData().getConfigurationParameterSettings().setParameterValue(
               groupName,
               paramName,
               paramValue);
         }
      ...
      //produce new tae
      this.ae = UIMAFramework.produceAnalysisEngine(taeSpecifier, this.mgr, null);
    ...
    * @param language the document text languge
    * @return TCAS - results of the analysis
    * @throws Exception
    */
   public TCAS performTest(String text, String language) throws Exception
   {
      try
      {
         // Create a new TCAS.
         TCAS cas = this.ae.newTCAS();
         // Set the document text on the CAS.
   ...
   /**
    * performs a test with a special annotator configuration. For this a new TAE is created and used to
    * process the specified document for the specified language.
    * 
    * @param text a document text
    * @param language the document text languge
    * @return TCAS - results of the analysis
    * @throws Exception
    */
   public static TCAS performTest(String descFilePath, String text, String language) throws Exception
   {
      try
      {
         AnalysisEngine ae = null;
    ...
    * 
    * @param file a file with the source
    ...
    * 
    * @param cas a cas with the analysed data
    * @param AnnotationTypes respected annotation types 
    * @param refFile reference output
    * @throws Exception
    */
