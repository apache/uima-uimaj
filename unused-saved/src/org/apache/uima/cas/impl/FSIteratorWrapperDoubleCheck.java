 ...
 * @param <T> -
 */
public class FSIteratorWrapperDoubleCheck<T extends FeatureStructure> extends FSIterator_concurrentmod<T> {
  ...
  <TT extends AnnotationFS> void moveTo(int begin, int end) {
    ((FSIterator_concurrentmod<TT>)(this.nonFlatIterator)).moveTo(begin, end);
