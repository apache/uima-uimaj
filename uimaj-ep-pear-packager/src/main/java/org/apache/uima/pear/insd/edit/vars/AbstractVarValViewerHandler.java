...
abstract class AbstractVarValViewerHandler {
	...
	public AbstractVarValViewerHandler(Composite parent, String[] columnNames, 
									  int numParentColumns, VarValList tableRowList,
	...
	/**
	 * InnerClass that acts as a proxy for the VarValList 
	 * providing content for the Table. It implements the IVarValListViewer 
	...
	protected void createButtons(Composite parent) {
		...
		delete.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				VarVal tableRow = (VarVal) ((IStructuredSelection) 
