...
public class CasProcessorMaxRestartsImpl extends MetaDataObject_impl implements CasProcessorMaxRestarts
{
	...
	protected AttributesImpl getXMLAttributes()
	{
		...
		{
			attrs.addAttribute("", "waitTimeBetweenRetries", "waitTimeBetweenRetries", "CDATA", String.valueOf(getWaitTimeBetweenRetries()));
		}
		return attrs;
	}
	...
	static final private XmlizationInfo XMLIZATION_INFO = new XmlizationInfo("maxConsecutiveRestarts", new PropertyXmlInfo[0]);
