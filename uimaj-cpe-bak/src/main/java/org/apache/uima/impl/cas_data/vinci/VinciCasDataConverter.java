...
package org.apache.uima.impl.cas_data.vinci;
...
import org.apache.uima.impl.cas_data.CasDataUtils;
import org.apache.uima.impl.cas_data.XCasToCasDataSaxHandler;
...
public class VinciCasDataConverter
{
	 ...
	 * @param aIncludeAnnotationSpannedText if true, when generating XCas for an
	 *   annotation, the spanned text of the annotation will be included as the
	 *   content of the XCas element.
	 */
	public VinciCasDataConverter(String aUeidType, String aUeidFeature,
	  String aCasDataDocTextType, String aCasDataDocTextFeature,
	  String aXCasDocTextTag, boolean aIncludeAnnotationSpannedText)
	{
		mUeidType = aUeidType;
	 ...
	 *
	 * @deprecated Use appendVinciFrameToCasData(Aframe, CasData) or
	 *                 vinciFrameToCasData(AFrame)
	 */
	public void vinciFrameToCasData(AFrame aCasFrame, CasData aCasData)
	  throws SAXException
	{
	 ...
	 * @param aCasData CasData to which FeatureStructures from XCAS will be appended
	 */
	public void appendVinciFrameToCasData(AFrame aCasFrame, CasData aCasData)
		throws SAXException
	{                             
