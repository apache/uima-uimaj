...
public class TypeComplianceConverterImpl
{
	 ...
	 * 
	 * @param aSourceString - String to convert
	 * @param aPattern - pattern for matching
	 * @param aReplaceString - replacement String for aPattern
	...
	public static void main(String[] args)
	{
		...
		System.out.println(TypeComplianceConverterImpl.replace("Detag_dash_DetagContent","_dash_","-"));
