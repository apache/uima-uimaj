 ...
 */
public class CpeCollectionReaderCasInitializerImpl extends MetaDataObject_impl implements CpeCollectionReaderCasInitializer
{
	...
	static final private XmlizationInfo XMLIZATION_INFO =
	  new XmlizationInfo("casInitializer",
		new PropertyXmlInfo[]{
