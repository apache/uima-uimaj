...
import org.apache.uima.impl.collection.cpm.container.deployer.socket.SocketTransport;
...
/**
 * Implementation of the {@link CasObjectProcessor} interface used for both Local and Remote CasObjectProcessors. 
 * This objects plugs in a transport object defined in the CPE Descriptor and uses it to delegate analysis of CAS
 * to a remote AE. 
 *
 */
public class CasObjectNetworkCasProcessorImpl implements CasObjectProcessor
{
	...
	/**
	 * Using information from the CPE descriptor creates an instance of Transport class. The transport class will
	 * delegate analysis of CAS to a remote object.
	 * 
	 * @param aCasProcessorType - Cas Process configuration from the CPE descriptor 
	 */
	public CasObjectNetworkCasProcessorImpl(CpeCasProcessor aCasProcessor) throws ResourceConfigurationException
	{
		if (aCasProcessor.getDeploymentParams() != null)
		{
			...
			{
				throw new ResourceConfigurationException(InvalidXMLException.INVALID_CLASS, new Object[] { "transport" }, e);
			}
		...
		{
			throw new ResourceConfigurationException(InvalidXMLException.INVALID_CPE_DESCRIPTOR, new Object[] {"transport"},
					new Exception( CpmLocalizedMessage.getLocalizedMessage(CPMUtils.CPM_LOG_RESOURCE_BUNDLE, "UIMA_CPM_EXP_bad_transport__WARNING",
	 ...
	 * 
	 * @param aTransportClass - name of the Transport class
	 ...
	 * 
	 * @param aURL - contains service endpoint info (hots and port)
	 * 
	 ...
	 * 
	 * @param aCASes[] - CASes to be analyzed
	 * 
	 * @throws ResourceInitializationException
	 */
	...
	/**
	 * Returns {@link ProcessingResourceMetaData} object returned from the remote
	 * CasProcessor.
	 * 
	 */
