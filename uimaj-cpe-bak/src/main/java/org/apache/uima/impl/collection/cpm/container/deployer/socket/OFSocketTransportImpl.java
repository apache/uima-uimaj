...
public class OFSocketTransportImpl implements SocketTransport
{
	...
	/* (non-Javadoc)
	 * @see org.apache.uima.impl.collection.cpm.container.deployer.socket.SocketTransport#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.apache.uima.impl.collection.cpm.container.deployer.socket.SocketTransport#connect(java.net.URL, long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.apache.uima.impl.collection.cpm.container.deployer.socket.SocketTransport#invoke(java.net.Socket, org.apache.uima.cas.CAS)
	 */
	public CAS process(Socket aSocket, CAS aCas) throws SocketTimeoutException, SocketException
	{
		...
		try
		{
			if (aSocket.isClosed())
			{
				aSocket = connect(new URL("http", aSocket.getInetAddress().getHostName(), aSocket.getPort(), ""), 100000);
			}
			if (UIMAFramework.getLogger().isLoggable(Level.FINEST))
			{
	...
	/* (non-Javadoc)
	 * @see org.apache.uima.impl.collection.cpm.container.deployer.socket.SocketTransport#getProcessingResourceMetaData()
	 */
