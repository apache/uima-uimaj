...
package org.apache.uima.collection.base_cpm.container;
...
/**
 * Base interface for implementing a Container object responsible for managing
 * Cas Processor instances at runtime. Aggregates stats and totals and 
...
public abstract class ProcessingContainer extends Resource_ImplBase implements ConfigurableResource, CasProcessorController
{
	...
	public abstract void incrementCasProcessorErrors(Throwable aThrowable)
		throws Exception;
