...
public class DescriptorMakeUtil
{
   ...
   public static String makeAnalysisEngine(
      String descFileName,
      boolean shouldCrash,
      String functionName,
      int errorCount,
      ...
      throws Exception
   {
      ...
      aed.getMetaData().getConfigurationParameterSettings().setParameterValue(
         "default",
         "TestAnnotator",
         new Boolean(shouldCrash));
      if (shouldCrash)
      {
         aed.getMetaData().getConfigurationParameterSettings().setParameterValue(
            functionName,
   ...
   public static String makeCasConsumer(
      String descFileName,
      boolean shouldCrash,
      String functionName,
      int errorCount,
   ...
   public static String makeCollectionReader(String descFileName, int documentCount) throws Exception
   {
      ...
      throws Exception
   {
      ...
      XMLInputSource in = new XMLInputSource(descFileName);
      CollectionReaderDescription crd = UIMAFramework.getXMLParser().parseCollectionReaderDescription(in);
   ...
   private static void serializeDescriptor(ResourceCreationSpecifier specifier, OutputStream out) throws Exception
   {
     specifier.toXML(out);
