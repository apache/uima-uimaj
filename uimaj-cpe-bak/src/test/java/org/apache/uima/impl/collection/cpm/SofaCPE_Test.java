    ...
    Throwable firstFailure;
		...
		protected void setUp() throws Exception {
			...
			cpeDesc = UIMAFramework.getXMLParser().parseCpeDescription(
								  new XMLInputSource(cpeSpecifierFile));
			//instantiate a cpe			
      ...
      if (firstFailure != null)
		...
		class StatusCallbackListenerImpl1 implements StatusCallbackListener 
		{
		  ...
		  if (debug) System.out.println(" Collection Processsing managers initialization " +
			  "is complete ");
		  }
		  ...
		  public synchronized void collectionProcessComplete() {
			if (debug)  System.out.println(" Completed "+entityCount+" documents  ; "+ size/1000
					   + " kB");
				  elapsedTime = System.currentTimeMillis() - startTime;
			if (debug) System.out.println(" Time Elapsed : "+ elapsedTime+" ms ");
            finished = true;
	        notifyAll();
		  }
		  ...
		  public synchronized void resumed() {
				 if (debug) System.out.println("Resumed");
		  }
