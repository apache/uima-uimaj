...
public class FunctionErrorStore {
	...
	public synchronized void methodeCalled1() throws AnnotatorProcessException {
		...
		if (functionCounted >= functionCounter) {
			...
			logger.log(
				...
				"the function "
					+ functionName
					+ " is trying to throw the following exception: "
					+ functionError);
	...
	public static String printStats(){
		...
		sb.append("CollectionReader 'getNext'-methode call count: " + collectionReaderGetNextCount + LS);
