 ...
 * should be bracketed as SBAR, not SBARQ. Updated by JCasGen Fri Dec 02 14:22:24 EST 2005
 * 
 * @generated
 */
public class SBARQ_Type extends Clause_Type {
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (SBARQ_Type.this.useExistingInstance) {
        ...
        return new SBARQ(addr, SBARQ_Type.this);
    }
  };
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.examples.opennlp.SBARQ");
