...
/**
 * Clause level syntactic parse annotation. Updated by JCasGen Fri Dec 02 14:22:24 EST 2005
 * 
 * @generated
 */
public class Clause_Type extends SyntaxAnnotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (Clause_Type.this.useExistingInstance) {
        ...
        return new Clause(addr, Clause_Type.this);
    }
  };
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.examples.opennlp.Clause");
