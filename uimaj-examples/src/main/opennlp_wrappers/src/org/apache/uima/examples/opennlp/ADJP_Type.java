...
/**
 * Adjective Phrase. Updated by JCasGen Fri Dec 02 14:22:24 EST 2005
 * 
 * @generated
 */
public class ADJP_Type extends Phrase_Type {
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
    public FeatureStructure createFS(int addr, CASImpl cas) {
      if (ADJP_Type.this.useExistingInstance) {
        ...
        return new ADJP(addr, ADJP_Type.this);
    }
  };
   ...
   * @modifiable
   */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.examples.opennlp.ADJP");
