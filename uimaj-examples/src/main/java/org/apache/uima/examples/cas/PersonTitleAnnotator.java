...
public class PersonTitleAnnotator extends CasAnnotator_ImplBase 
{
   ...
   * 
   * @param aCAS CAS containing document text and previously discovered
   ...
   */
  protected void annotateRange(CAS aCAS, String aText, int aBeginPos, 
    String aTitleType, String[] aTitles)
    throws AnnotatorContextException
  {
   ...
   *   of the <code>Kind</code> feature.
   */
  protected void createAnnotation(CAS aCAS, int aBeginPos, int aEndPos, 
     String aTitleType)
  {
    AnnotationFS title = aCAS.createAnnotation(mPersonTitleType, 
        aBeginPos, aEndPos);
