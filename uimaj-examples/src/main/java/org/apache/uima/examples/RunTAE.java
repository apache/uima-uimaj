 ...
 * though a Text Analysis Engine, and produces XML files with inline 
 * annotations.  This application uses the {@link CollectionProcessingManager}
 * to drive the processing.  For a simpler introduction to using TAEs in an
 ...
 * be output.  Tis can be useful when only interested in performance statistics.
 * <p>
 * <u>OPTIONS</u>
 * <p>
 ...
 * the input documents.  Some TAEs,particularly TAF TAEs, require this.
 * <br>
