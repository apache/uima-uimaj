...
/**
 * Annotates UIMA acronyms and provides their expanded forms.  When combined
 * in an aggregate TAE with the UimaMeetingAnnotator, demonstrates the
 * use of the ResourceManager to share data between annotators.
 * 
 * 
 */
  ...
  {    
    ...
    while (tokenizer.hasMoreTokens())
    {
      ...
      if (expandedForm != null)
      {
        //create annotation
        UimaAcronym annot = 
            new UimaAcronym(aJCas, pos, pos + token.length(), expandedForm);
        annot.addToIndexes();
      }
