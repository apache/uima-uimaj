...
public class ConcreteType extends AbstractType {
  ...
  private final static CallSite _FC_concreteString = TypeSystemImpl
          .createCallSite(ConcreteType.class, "concreteString");
  ...
  public String getConcreteString() {
    return _getStringValueNc(wrapGetIntCatchException(_FH_concreteString));
  }
