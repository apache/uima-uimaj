...
public class Root extends TOP {
  ...
  private final static CallSite _FC_arrayInt = TypeSystemImpl.createCallSite(Root.class,
          "arrayInt");
  private final static MethodHandle _FH_arrayInt = _FC_arrayInt.dynamicInvoker();
  private final static CallSite _FC_arrayRef = TypeSystemImpl.createCallSite(Root.class,
          "arrayRef");
  private final static MethodHandle _FH_arrayRef = _FC_arrayRef.dynamicInvoker();
  private final static CallSite _FC_arrayFloat = TypeSystemImpl.createCallSite(Root.class,
          "arrayFloat");
  private final static MethodHandle _FH_arrayFloat = _FC_arrayFloat.dynamicInvoker();
  private final static CallSite _FC_arrayString = TypeSystemImpl.createCallSite(Root.class,
          "arrayString");
  private final static MethodHandle _FH_arrayString = _FC_arrayString.dynamicInvoker();
  private final static CallSite _FC_plainInt = TypeSystemImpl.createCallSite(Root.class,
          "plainInt");
  private final static MethodHandle _FH_plainInt = _FC_plainInt.dynamicInvoker();
  private final static CallSite _FC_plainFloat = TypeSystemImpl.createCallSite(Root.class,
          "plainFloat");
  private final static MethodHandle _FH_plainFloat = _FC_plainFloat.dynamicInvoker();
  private final static CallSite _FC_plainString = TypeSystemImpl.createCallSite(Root.class,
          "plainString");
  private final static MethodHandle _FH_plainString = _FC_plainString.dynamicInvoker();
  private final static CallSite _FC_plainRef = TypeSystemImpl.createCallSite(Root.class,
          "plainRef");
  private final static MethodHandle _FH_plainRef = _FC_plainRef.dynamicInvoker();
  private final static CallSite _FC_plainLong = TypeSystemImpl.createCallSite(Root.class,
          "plainLong");
  private final static MethodHandle _FH_plainLong = _FC_plainLong.dynamicInvoker();
  private final static CallSite _FC_plainDouble = TypeSystemImpl.createCallSite(Root.class,
          "plainDouble");
  private final static MethodHandle _FH_plainDouble = _FC_plainDouble.dynamicInvoker();
  private final static CallSite _FC_arrayLong = TypeSystemImpl.createCallSite(Root.class,
          "arrayLong");
  private final static MethodHandle _FH_arrayLong = _FC_arrayLong.dynamicInvoker();
  private final static CallSite _FC_arrayDouble = TypeSystemImpl.createCallSite(Root.class,
          "arrayDouble");
  ...
  public IntegerArray getArrayInt() {
    return (IntegerArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_arrayInt)));
  }
  ...
  public FSArray getArrayRef() {
    return (FSArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_arrayRef)));
  }
  ...
  public FloatArray getArrayFloat() {
    return (FloatArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_arrayFloat)));
  }
  ...
  public StringArray getArrayString() {
    return (StringArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_arrayString)));
  }
  ...
  public int getPlainInt() {
    return _getIntValueNc(wrapGetIntCatchException(_FH_plainInt));
  }
  ...
  public float getPlainFloat() {
    return _getFloatValueNc(wrapGetIntCatchException(_FH_plainFloat));
  }
  ...
  public String getPlainString() {
    return _getStringValueNc(wrapGetIntCatchException(_FH_plainString));
  }
  ...
  public Root getPlainRef() {
    return (Root) (_getFeatureValueNc(wrapGetIntCatchException(_FH_plainRef)));
  }
  ...
  public long getPlainLong() {
    return _getLongValueNc(wrapGetIntCatchException(_FH_plainLong));
  }
  ...
  public double getPlainDouble() {
    return _getDoubleValueNc(wrapGetIntCatchException(_FH_plainDouble));
  }
  ...
  public LongArray getArrayLong() {
    return (LongArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_arrayLong)));
  }
  ...
  public DoubleArray getArrayDouble() {
    return (DoubleArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_arrayDouble)));
  }
