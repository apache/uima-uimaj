...
public class LanguagePair extends TOP {
  ...
  private final static CallSite _FC_lang1 = TypeSystemImpl.createCallSite(LanguagePair.class,
          "lang1");
  private final static MethodHandle _FH_lang1 = _FC_lang1.dynamicInvoker();
  private final static CallSite _FC_lang2 = TypeSystemImpl.createCallSite(LanguagePair.class,
          "lang2");
  private final static MethodHandle _FH_lang2 = _FC_lang2.dynamicInvoker();
  private final static CallSite _FC_description = TypeSystemImpl.createCallSite(LanguagePair.class,
          "description");
  ...
  public String getLang1() {
    return _getStringValueNc(wrapGetIntCatchException(_FH_lang1));
  }
  ...
  public String getLang2() {
    return _getStringValueNc(wrapGetIntCatchException(_FH_lang2));
  }
