...
public class TaeDescription_implTest {
  ...
  public void setUp() throws Exception {
    try {
      ...
      var type1 = typeSystem.addType("Fake", "A Fake Type", "Annotation");
      var feature1 = type1.addFeature("TestFeature", "For Testing Only", TYPE_NAME_STRING);
      ...
      // precond1.setComparisonValue("en,de");
