...
public class AnalysisEngine_implTest extends TestCase {
   ...
   * @param arg0
   */
  public AnalysisEngine_implTest(String arg0) throws java.io.FileNotFoundException {
    super(arg0);
  }
  ...
  public void testProcess() throws Exception {
    try {
      ...
      TaeDescription aggWithCcDesc = UIMAFramework
                      .getXMLParser()
                      .parseTaeDescription(
                                      new XMLInputSource(
                                                      JUnitExtension
  ...
  public void testProcessDelegateAnalysisEngineMetaData() throws Exception {
    try {
      ...
      // TypeSystem
      TypeSystemDescription typeSys = tae.getAnalysisEngineMetaData().getTypeSystem();
  ...
  public void testProcessAndOutputNewCASes() throws Exception {
    try {
      // primitive
      AnalysisEngineDescription segmenterDesc = UIMAFramework
                      .getXMLParser()
      ...
      AnalysisEngineDescription aeDesc = UIMAFramework.getXMLParser()
                      .parseAnalysisEngineDescription(
                                      new XMLInputSource(JUnitExtension
                                                      .getFile("SequencerTest/Annotator1.xml")));
