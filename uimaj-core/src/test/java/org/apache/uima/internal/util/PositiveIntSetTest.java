...
public class PositiveIntSetTest {
  ...
  public void testSwitchFromHashToBitWithOffset() {
    ...
    s.add(x[ix++] = 100001 + 14); // switches to hashSet, size = 64 entries in short table = 32
                                  // words + 11
    for (int i = 0; i < 24; i++) {
      s.add(x[ix++] = 100100 + i);
    }
  ...
  public void testBasic() {
    ...
    for (int i = 10; i < 20000/* 5122 */; i = i << 1) {
      s.add(i); // switches to hash set when i = 2560. == 1010 0000 0000 (>>5 = 101 0000 = 80
                // (decimal)
      ...
      // if (!s.isBitSet) {
      // System.out.println("is Bit set? " + s.isBitSet + ", i = " + i + ", # of entries is " +
      // s.size());
      // }
      reached = i >= 2560;
  ...
  public void testBit2ShortHash() {
    ...
    int[] sv = s.toIntArray();
    Arrays.sort(sv);
    assertTrue(Arrays.equals(sv, new int[] { 1, 874, 1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007,
        1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 10000, 100000 }));
    ...
    sv = s.toIntArray();
    Arrays.sort(sv);
    assertTrue(Arrays.equals(sv, new int[] { 1000, 1001, 1002, 1003, 1004, 1005, 1006, 1007, 1008,
        1009, 1010, 1011, 1012, 1013, 1014, 1015, 10000, 100000 }));
    ...
    s.add(1015);
    assertTrue(s.isBitSet && s.isOffsetBitSet());
    assertTrue(Arrays.equals(s.toIntArray(), new int[] { 1000, 1001, 1002, 1003, 1004, 1005, 1006,
        1007, 1008, 1009, 1010, 1011, 1012, 1013, 1014, 1015, 1259 }));
