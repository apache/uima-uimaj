...
public class OfShorts extends Annotation {
  ...
  private final static CallSite _FC_f1Shorts = TypeSystemImpl.createCallSite(OfShorts.class,
          "f1Shorts");
  ...
  public ShortArray getF1Shorts() {
    return (ShortArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_f1Shorts)));
  }
