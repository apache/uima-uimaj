...
/**
 * Updated by JCasGen Sun Oct 08 19:26:22 EDT 2017 XML source:
 * C:/au/svnCheckouts/uv3/trunk/uimaj-v3/uimaj-core/src/test/resources/ExampleCas/testTypeSystem_arrays.xml
 * 
 * @generated
 */
public class OfStrings extends Annotation {
  ...
  private final static CallSite _FC_f1Strings = TypeSystemImpl.createCallSite(OfStrings.class,
          "f1Strings");
  ...
  public StringArray getF1Strings() {
    return (StringArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_f1Strings)));
  }
