...
public class NewPrimitiveTypesTest extends TestCase {
	...
	public void testXCASSerialization() throws Exception {
		...
		createExampleFS(cas);
			...
			//deserialize
			InputStream inputXCAS = new FileInputStream(JUnitExtension.getFile("ExampleCas/newprimitives.xcas"));
    ...
    //System.out.print(fs.toString());
		...
		StringArrayFS strArrayFS = (StringArrayFS) fs
				.getFeatureValue(stringArrayFeature);
		...
		IntArrayFS intArrayFS = (IntArrayFS) fs
				.getFeatureValue(intArrayFeature);
		...
		FloatArrayFS floatArrayFS = (FloatArrayFS) fs
				.getFeatureValue(floatArrayFeature);
		...
		ByteArrayFS byteArrayFS = (ByteArrayFS) fs
				.getFeatureValue(byteArrayFeature);
		...
		BooleanArrayFS boolArrayFS = (BooleanArrayFS) fs
				.getFeatureValue(booleanArrayFeature);
		...
		ShortArrayFS shortArrayFS = (ShortArrayFS) fs
				.getFeatureValue(shortArrayFeature);
		...
		LongArrayFS longArrayFS = (LongArrayFS) fs
				.getFeatureValue(longArrayFeature);
		...
		DoubleArrayFS doubleArrayFS = (DoubleArrayFS) fs
				.getFeatureValue(doubleArrayFeature);
