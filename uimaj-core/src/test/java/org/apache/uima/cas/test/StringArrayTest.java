...
public class StringArrayTest extends TestCase {
  ...
  public void tearDown(){
    ...
    String lemmaListName = 
      CASTestSetup.TOKEN_TYPE + TypeSystem.FEATURE_SEPARATOR + CASTestSetup.LEMMA_LIST_FEAT;
    ...
    assertTrue(lemmaList != null);
		...
		FeatureStructure token =
			cas.createFS(this.ts.getType(CASTestSetup.TOKEN_TYPE));
