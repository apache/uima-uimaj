...
import static org.apache.uima.cas.text.AnnotationPredicateTestData.ZERO_WIDTH_WIDE_NARROW_TEST_CASES;
...
public class AnnotationPredicates_WNTest {
    private static CAS cas;
    private AnnotationPredicates_WN sut;
    ...
    private List<TestCase> testCases = union(
        ...
        ZERO_WIDTH_WIDE_NARROW_TEST_CASES);
    ...
    public void setup() throws Exception {
      ...
      sut = new AnnotationPredicates_WN();
    }
