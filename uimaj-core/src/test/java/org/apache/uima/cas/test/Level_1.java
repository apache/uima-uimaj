...
/**
 * Updated by JCasGen Fri Dec 16 10:23:12 EST 2016 XML source:
 * C:/au/svnCheckouts/branches/uimaj/v3-alpha/uimaj-core/src/test/java/org/apache/uima/jcas/test/generatedx.xml
 * 
 * @generated
 */
public class Level_1 extends Annotation {
  ...
  /**
   * getter for id - gets id of document. (For example, file:///MyDirectory/myFile.txt for a simple
   * file or http://incubator.apache.org/uima/index.html for content from a web source.)
   * 
   * @generated
   * @return value of the feature
   */
  public float getId() {
    return _getFloatValueNc(wrapGetIntCatchException(_FH_id));
  }

  /**
   * setter for id - sets id of document. (For example, file:///MyDirectory/myFile.txt for a simple
   * file or http://incubator.apache.org/uima/index.html for content from a web source.)
   * 
   * @generated
   * @param v
