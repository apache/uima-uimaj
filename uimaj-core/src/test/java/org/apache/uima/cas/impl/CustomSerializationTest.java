...
public class CustomSerializationTest {
    ...
    private EnrichedEntity fixture() throws CASException, ResourceInitializationException, IOException,
            InvalidXMLException {
        File typeSystemFile =
                JUnitExtension.getFile("ExampleCas/CustomSerializable.xml");
    ...
    public void verifyFeatureMapDeserialization(SerialFormat format) throws CASException,
        ...
        List<EnrichedEntity> annotations = jCas.select(EnrichedEntity.class).collect(Collectors.toList());
    ...
    @Test
    public void verifyCustomSerializationForCompressedFilteredBinary6() throws CASException,
            ResourceInitializationException, IOException, InvalidXMLException {
