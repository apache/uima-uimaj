...
public class Token extends Annotation {
  ...
  private final static CallSite _FC_tokenFloatFeat = TypeSystemImpl.createCallSite(Token.class,
          "tokenFloatFeat");
  ...
  private final static CallSite _FC_lemmaList = TypeSystemImpl.createCallSite(Token.class,
          "lemmaList");
  ...
  public TokenType getTtype() {
    return (TokenType) (_getFeatureValueNc(wrapGetIntCatchException(_FH_ttype)));
  }
  ...
  public float getTokenFloatFeat() {
    return _getFloatValueNc(wrapGetIntCatchException(_FH_tokenFloatFeat));
  }
  ...
  public StringArray getLemmaList() {
    return (StringArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_lemmaList)));
  }
