...
public class Sentence extends Annotation {
  ...
  private final static CallSite _FC_sentenceLength = TypeSystemImpl.createCallSite(Sentence.class,
          "sentenceLength");
  ...
  public int getSentenceLength() {
    return _getIntValueNc(wrapGetIntCatchException(_FH_sentenceLength));
  }
