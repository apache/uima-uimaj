...
public class Token_Type extends Annotation_Type {
  ...
  public String getLemmaList(int addr, int i) {
    if (featOkTst && casFeat_lemmaList == null)
      ...
      return ll_cas.ll_getStringArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_lemmaList), i, true);
  ...
  public Token_Type(JCas jcas, Type casType) {
    ...
    casFeat_tokenFloatFeat  = jcas.getRequiredFeatureDE(casType, "tokenFloatFeat", "uima.cas.Float", featOkTst);
    casFeatCode_tokenFloatFeat = (null == casFeat_tokenFloatFeat) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_tokenFloatFeat).getCode();
    ...
    casFeat_lemmaList       = jcas.getRequiredFeatureDE(casType, "lemmaList", "uima.cas.StringArray", featOkTst);
