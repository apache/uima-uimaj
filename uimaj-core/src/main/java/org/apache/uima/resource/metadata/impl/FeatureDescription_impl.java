 ...
 * 
 */
public class FeatureDescription_impl extends MetaDataObject_impl
  implements FeatureDescription
{
   ...
   * @param aRangeTypeName name of the feature's range type
   */
  public FeatureDescription_impl(String aName, String aDescription, 
  ...
  /**
   * Creates a new FeatureDescription_impl with the specified field values.  This version is
   * used for array or list valued features, which may have additional attributes.
   * 
   * @param aName name of the feature
   * @param aDescription verbose description of the feature
   * @param aRangeTypeName name of the feature's range type
  ...
  static final private XmlizationInfo XMLIZATION_INFO =
    new XmlizationInfo("featureDescription",
      new PropertyXmlInfo[]{
