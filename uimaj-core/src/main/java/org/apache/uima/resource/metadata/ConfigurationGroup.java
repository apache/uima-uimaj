...
/**
 * A group of {@link ConfigurationParameter}s.  Actually, a single
 * <code>ConfigurationGroup</code> object can have multiple group names, in
 * which case it represents multiple groups that all share the same
 * parameters.
 * 
 * 
 */
public interface ConfigurationGroup extends MetaDataObject
{
   ...
   *    each of which describes a configuration parameter in this group.
   */
  ...
  public void setConfigurationParameters(ConfigurationParameter[] aParams);
	 ...
	 *   (must be == with an ConfigurationParameter in this group,
