...
/**
 * A type of <code>ResourceSpecifier</code> that locates an existing
 * <code>Resource</code> service by its URI.
 *    
 * 
 */
public interface URISpecifier extends ResourceServiceSpecifier
{
  ...
  public static final String RESOURCE_TYPE_CAS_CONSUMER = "CasConsumer";
	...
	/**
	 * Retrieves the type of Resource (e.g. Analysis Engine, CAS Consumer) that the service
	 * at this URI is expected to implement.  This is optional, but useful for clients to know
	 * what to do with the URISpecifier.
	 * 
	 * @return the type of Resource.  This should be one of the constants on this class, or null
	 *    if the resource type is not specified.
	 */
  public String getResourceType();
  
	/**
	 * Sets the type of Resource (e.g. Analysis Engine, CAS Consumer) that the service
	 * at this URI is expected to implement.  This is optional, but useful for clients to know
	 * what to do with the URISpecifier.
	 * 
	 * @param aResourceType the type of Resource.  This should be one of the constants on this class,
	 *   or null to indicate that the resource type is not specified. 
	 */
   ...
   * Protocol names are defined in the {@link org.apache.uima.Constants} class.
   * 
   ...
   * Protocol names are defined in the {@link org.apache.uima.Constants} class.
   * 
   * @param aProtocol the name of the protocol.  
   */
