...
/**
 * Thrown to indicate that a {@link Resource} has encountered a problem
...
/**
  ...
  */
  public ResourceProcessException(String aResourceBundleName,
  ...
  */
  ...
  public static final String RESOURCE_DATA_NOT_VALID = 
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * This component requires a FeatureStructure of type {0}, which is not present in the CAS.
	 */	
	public static final String REQUIRED_FEATURE_STRUCTURE_MISSING_FROM_CAS = 
		"required_feature_structure_missing_from_cas";   
}
