...
/**
 * Thrown to indicate that an error has occurred during communication with 
...
/**
  ...
  */
  public ResourceServiceException(String aResourceBundleName,
  ...
  * "A failure occurred while serializing objects."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "A failure occurred while deserializing objects."
  */
  ...
  */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Unexpected service return value type.  Expected {0}, but received {1}."
   */
