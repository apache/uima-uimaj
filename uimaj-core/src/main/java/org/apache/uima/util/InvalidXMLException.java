...
/**
 * Thrown by the {@link XMLParser} to indicate that an XML document is invalid
 * or does not specify a valid object of the desired class.
 * 
 * 
 */
...
/**
  ...
  */
  public InvalidXMLException(String aResourceBundleName,
  ...
  * "Invalid descriptor file {0}."
  */
  public static final String INVALID_DESCRIPTOR_FILE = "invalid_descriptor_file";   

 /**
  * Message key for a standard UIMA exception message:
  * "The XML parser encountered an unknown element type: {0}."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "An object of class {0} was requested, but the XML input contained an
  * object of class {1}."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "Expected an element of type {0}, but found an element of type {1}."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "Required element type {0} not found within element type {1}."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "Required attribute {0} not found within element type {1}."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "The XML document attempted to include an external file "{0}", 
  *  which was not found."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "The text "{0}" is not valid content for the element "{1}"."
  */
  public static final String INVALID_ELEMENT_TEXT = 
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Malformed URL {0} in import declaration.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * An import could not be resolved.  No .xml file with name "{0}" was found in the class path or data path.
	 */
    ...
    /**
     * Message key for a standard UIMA exception message:
     * Import failed.  Could not read from URL {0}.
     */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid import declaration.  Import declarations must have a "name" or a "location" attribute,
	 * but not both.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * This is not a valid CPE descriptor.
	 */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * An xi:include element was not resolved.  Please note that <xi:includes> are deprecated...
   */
   public static final String UNRESOLVED_XINCLUDE = 
           "unresolved_xinclude"; 
   
   /**
    * Message key for a standard UIMA exception message:
    * The element "fsIndexes" cannot occur outside the containing element "fsIndexCollection"
    */
