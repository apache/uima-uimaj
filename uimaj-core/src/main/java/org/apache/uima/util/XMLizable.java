...
public interface XMLizable {
   ...
   * <p>
   * The XML String that is produced will have a header
   * <code>&lt;?xml version="1.0" encoding="UTF-8"?&gt;</code>. Therefore you should not write this
   * string out in any encoding other than UTF-8 (for example do not use the default platform
   * encoding), or you will produce output that will not be able to be parsed.
   * 
   * @param aWriter
   ...
   * method just calls <code>toXML(aContentHandler,false)</code>, so subclasses should override that
   * version of this method, not this one.
   * 
