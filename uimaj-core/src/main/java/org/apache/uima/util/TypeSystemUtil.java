...
public class TypeSystemUtil
{
   ...
   * @param aTypeSystem type system object to convert
  ...
  public static TypeSystemDescription typeSystem2TypeSystemDescription(TypeSystem aTypeSystem)
  {
    ...
    while (typeIter.hasNext())
    {
      ...
      if (!type.getName().startsWith("uima.cas") &&
          !type.getName().equals("uima.tcas.Annotation"))
      {
   ...
   * @param aType type object to convert
   * @param aTypeSystem the TypeSystem that contains <code>aType</code>
   ...
   * @param aFeature feature object to convert
   ...
   * @param aType the type, which must be a subtype of uima.cas.String
   * @return array of allowed values for <code>aType</code>
