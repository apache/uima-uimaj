      ...
      if (cTruncated == c) {
        if (logger.isLoggable(Level.FINE)) {
          try { throw new Throwable();}
            ...
            message = "Error count: " + c + "; " + message + ". Error count indicates messages skipped to avoid potential flooding.\n" + baos.toString();
            logger.log(Level.FINE, message);
          }
        } else {
          message = "Error count: " + c + "; " + message + ". Error count indicates messages skipped to avoid potential flooding. Set FINE logging level for stacktrace.";
