...
/**
 * Generates an inline XML representation of a CAS.  Annotation types are
...
public class CasToInlineXml
{
  ...
  /**
   * Formats a CAS as a String.  Only FeatureStructures matching the
   * given filter will be output.
   */
  public String format(CAS aCAS, FSMatchConstraint aFilter)
    throws CASException
  {
   ...
   */
  public String generateXML(CAS aCAS, FSMatchConstraint aFilter)
    throws CASException
  {
