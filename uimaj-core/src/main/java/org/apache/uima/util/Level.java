...
public class Level
{
  ...
  /**
	...
	/**
	 * method isGreaterOrEqual() returns true if the argument level
	 * is greater or equal to the specified level.
	 * 
	 * @param r argument level passed to the method
	 * 
