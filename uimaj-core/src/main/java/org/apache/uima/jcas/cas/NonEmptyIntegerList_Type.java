...
public class NonEmptyIntegerList_Type extends IntegerList_Type {
  ...
  public final static boolean featOkTst = JCasImpl.getFeatOkTst("uima.cas.NonEmptyIntegerList");
  ...
  public int getHead(int addr) {
    if (featOkTst && casFeat_head == null)
      JCasImpl.throwFeatMissing("head", "uima.cas.NonEmptyIntegerList");
  ...
  public int getTail(int addr) {
    if (featOkTst && casFeat_tail == null)
      JCasImpl.throwFeatMissing("tail", "uima.cas.NonEmptyIntegerList");
