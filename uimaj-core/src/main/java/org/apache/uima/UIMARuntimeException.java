...
public class UIMARuntimeException extends RuntimeException implements I18nExceptionI {
  ...
  // */
  // public static final String ILLEGAL_CAS_COPY_TO_SAME_CAS_SAME_VIEW =
  // "illegal_copy_same_cas_same_view";

  /**
   * Message key for a standard UIMA exception message: CAS Copying of Feature "{0}": range names
  ...
  /**
   * Message key for a standard UIMA exception message: Saved UIMA context is null; probable cause:
  ...
  /**
   * Message key for a standard UIMA exception message: Saved result specification is null; probable
  ...
  /**
   * Message key for a standard UIMA exception message: In CasCopier, the {0} view is doesn't belong
  ...
  /**
   * Message key for a standard UIMA exception message: Unsupported invocation of CasCopier
  ...
  /**
   * Message key for a standard UIMA exception message: It is not permitted to use CasCopier to copy
  ...
  /**
   * Message key for a standard UIMA exception message: Illegal update of indexed Feature Structure
  ...
  /**
   * Categories of constructor 0 args 1 arg: throwable cause 1 - n args: First String message key,
   * rest Object arguments 2 - n args: First is throwable, 2nd is String message key, rest Object
   * arguments
   * 
   */
  /**
  ...
  public UIMARuntimeException(Throwable aCause, String messageBundle, String messageKey,
          Object... aArguments) {
