...
/**
 * The <code>InternationalizedRuntimeException</code> class adds 
 * internationalization support to the standard functionality provided by 
 * <code>java.lang.RuntimeException</code>.  Because this is a
 * <code>RuntimeException</code>, it does not need to be declared in the
 * throws clause of methods.
 * <p>
 * To support internationalization, the thrower of an exception must not
 * specify a hardcoded message string.  Instead, the thrower specifies a
 * key that identifies the message.  That key is then looked up in a 
 * locale-specific {@link java.util.ResourceBundle ResourceBundle} to find
 * the actual message associated with this exception.
 * <p>
 * This class also supports arguments to messages.  The full message will
 * be constructed using the {@link java.text.MessageFormat MessageFormat} class.
 * For more information on internationalization, see the
 * <a href="http://java.sun.com/j2se/1.4/docs/guide/intl/index.html">
 * Java Internationalization Guide</a>.
 * <p>
 * This version of this class works with JDK versions prior to 1.4, since
 * it does not assume support for exception chaining.  The file 
 * <code>InternationalizedException.java_1_4</code> is a version that
 * uses the exception chaining support built-in to JDK1.4.
 * 
 * 
 */
...
/**
  * Creates a new <code>InternationalizedRuntimeException</code> with a null
  * message.
  */
 ...
 /**
  * Creates a new <code>InternationalizedRuntimeException</code> with the 
 ...
 /**
  * Gets the identifier for this exception's message.  This identifier
  * can be looked up in this exception's 
  ...
  * <code>InternationalizedRuntimeException</code> to have a compound message,
  * made up of multiple parts that are concatenated in a language-neutral way.  
  * 
  ...
  * <code>Locale</code>.
  *
  * @param aLocale  the locale to use for localizing the message
  *  
  ...
  public String getLocalizedMessage(Locale aLocale)
  {
    ...
    try
    {
      ...
      ResourceBundle bundle =
        ResourceBundle.getBundle(getResourceBundleName(), aLocale);  
  ...
  * <code>InternationalizedRuntimeException</code> to have a compound message, made
