...
public class FileUtils {
    ...
    /**
     * Get a list of all files in a directory. Optionally, get files in
     ...
     * @return ArrayList A list of <code>File</code> objects.
     *         <code>null</code> if <code>directory</code> does not exist,
    ...
    /**
     * Read the contents of a file into a string, using the default platform
     * encoding.
     * 
     * @param file
    ...
    /**
     * Read the contents of a file into a string using a specific character
     * encoding.
     * 
     * @param file
     *            The input file.
     * @param fileEncoding
     *            The character encoding of the file (see your Java
     *            documentation for supported encodings).
     * @return String The contents of the file.
     * @throws IOException
     *             Various I/O errors.
     */
    public static String file2String(File file, String fileEncoding)
            throws IOException {
        // Read the file into a string using a char buffer.
        char[] buf = new char[10000];
        int charsRead;
     ...
     */
    public static void saveString2File(String fileContents, File file)
            throws IOException {
     ...
     *             If for any reason the file can't be written.
     */
    public static void saveString2File(String s, File file, String encoding)
            throws IOException {
     ...
     * @return boolean Will fail if directory already exists, or File.mkdir()
     ...
     * @return A file object corresponding to the newly created dir, or
     *         <code>null</code> if none could be created for some reason
     *         (e.g., if the parent is not writable).
     */
    ...
    /**
     * Copy file <code>file</code> to location <code>dir</code>. This
     * method will not fail silently. Anything that prevents the copy from
     * happening will be treated as an error condition. If the method does not
     * throw an exception, the copy was successful.
     * 
     * <p>
     * <b>Note: </b> this is a completely brain-dead implementation of file
     * copy. The complete file is read into memory before it is copied. If you
     * need something more sophisticated for copying large files, feel free to
     ...
     * @throws IOException
     *             For various reason: if <code>file</code> does not exist or
     *             is not readable, if the destination directory does not exist
     *             or isn't a directory, or if the file can't be copied for any
     *             reason.
     */
