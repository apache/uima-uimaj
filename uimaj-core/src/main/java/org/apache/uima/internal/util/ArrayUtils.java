...
public abstract class ArrayUtils
{
  ...
  /**
   * Combines two arrays.  If the two arrays are of the same type, the
   * resulting array will also be of that type, otherwise it will be
   * an <code>Object[]</code>.
   * 
   * @param aArray1  first non-null array to combine
   * @param aArray2  second non-null array to combine
   * 
   * @return an array consisting of all the elements of <code>aArray1</code>
   *    followed by all the elements of <code>aArray2</code>.
   */
