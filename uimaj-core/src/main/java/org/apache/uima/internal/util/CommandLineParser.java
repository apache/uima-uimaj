 ...
 * 
 * <p>
 * The parser can only handle parameters that take 0 or 1 arguments. That is,
 * you can parse command lines like
 * 
 * <pre>
 ...
 * 
 * <p>
 * The syntax of parameters is left to the user, no common prefix is assumed or
 * enforced. Parameter names can be arbitrarily long. You can define aliases for
 * parameters: <code>-h</code>, <code>/H</code> and <code>--help</code>
...
public class CommandLineParser {
     ...
     * @param hasArg
     *            If the command line argument following this parameter should
     *            be interpreted as an argument to the parameter.
    ...
    /**
     * Add a new switch. This is the same as calling
     * <code>addParameter(name, false)</code>.
     * 
     * @param paramName
     *            The name of the parameter.
     * @return <code>false</code> iff <code>paramName</code> already exists.
     ...
     * @param alias
     *            The alias.
     * @return <code>false</code> iff the parameter does not exist or the
     *         alias is already known.
     */
    public boolean addAlias(String param, String alias) {
        if (this.paramMap.containsKey(alias)
                || !this.paramMap.containsKey(param)) {
            return false;
        }
     ...
     * @throws Exception
     *             If a parameter that requires an argument does not have one
     *             (i.e., is the last parameter in the list).
     */
    public void parseCmdLine(String[] args) throws Exception {
        ...
        while (i < args.length) {
            ...
            if (this.paramMap.containsKey(cmdLineArg)) {
                CmdLineParam metaParam = (CmdLineParam) this.paramMap
                        .get(cmdLineArg);
                if (metaParam.hasArg) {
                    ++i;
                    if (i >= args.length) {
                        ...
                        throw new Exception(
                                "Required argument to parameter missing: "
                                        + cmdLineArg);
                    }
                ...
                System.arraycopy(args, i, this.restArgs, 0,
                        this.restArgs.length);
                return;
            }
            ++i;
        }
     ...
     * @param paramName
     *            The name of the parameter.
     * @return <code>true</code> iff the name is known and was used as a
     ...
     * @param paramName
     *            The name of the parameter.
     * @return The argument to the parameter if the parameter was used and takes
     *         an argument; <code>null</code>, else.
     */
