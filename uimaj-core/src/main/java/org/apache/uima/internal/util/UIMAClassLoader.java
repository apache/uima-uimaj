...
/**
 * UIMAClassLoader is used as extension ClassLoader for UIMA to load additional components 
 * like annotators and resources. The classpath of the classloader is specified as string.
 * 
...
public class UIMAClassLoader extends URLClassLoader
{
	 ...
	 * 
	 * @param classpath an array of wellformed classpath URL's
	 */
	...
	/**
	 * Creates a new UIMAClassLoader based on a classpath URL's. Also a 
	 * parent ClassLoader can be specified.
	 * 
	 * @param classpath an array of wellformed classpath URL's
	 * @param parent specify the parent of the classloader
	 */
	...
	/**
	 * Creates a new UIMAClassLoader based on a classpath string. 
	 * Also a parent ClassLoader can be specified.
	 * 
	 * @param classpath a classpath string
	 * @param parent specify the parent of the classloader
	 * 
