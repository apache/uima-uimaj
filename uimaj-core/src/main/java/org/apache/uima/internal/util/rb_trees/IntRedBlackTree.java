...
/**
 * See the {@link org.apache.uima.internal.util.rb_trees.RedBlackTree RedBlackTree} class.
 * This is a specialized instance with ints as elements.
 * 
 * 
 */
public class IntRedBlackTree {
     ...
     * {@link org.apache.uima.internal.util.rb_trees.IntRBTArray IntRBTArray} for the memory
     * layout of the array. Note that the red-black information is lost in the
     * translation. The resulting array is only meant to be read, not grown. The
     * array is meant as input to construct an
     * {@link org.apache.uima.internal.util.rb_trees.IntRBTArray IntRBTArray} object.
     * 
     * @param offset
     *            An offset for internal addressing. If <code>offset > 0</code>,
     *            the addresses generated for right daughters in two-daughter
     *            nodes are shifted to the right. This is useful if the
     *            resulting array will be copied to a certain
     *            <code>offset</code> position in a different array.
