 ...
 * This is not part of the stable UIMA API and may change in future releases.
 * 
 * 
 */
public class AnalysisEnginePool
{
   ...
   *    created
   */
  public AnalysisEnginePool(String aName, int aNumInstances, 
    ...
    throws ResourceInitializationException
  {
    ...
    mPool = new ResourcePool(aNumInstances, aResourceSpecifier, 
      getResourceClass(), aResourceInitParams);
   ...
   * 
   * @return an AnalysisEngine for use by the client.  Returns <code>null</code>
  ...
  /**
   * Checks in an AnalysisEngine to the pool.  Also notifies other Threads that
  ...
  /**
   * Checks out an AnalysisEngine from the pool.  If none is currently 
   * available, wait for the specified amount of time for one to be checked in.
   * 
  ...
  public void setResultSpecification(ResultSpecification aResultSpec)
  {
    ...
    try
    {
      ...
      {   
        ...
        AnalysisEngine ae = 
          (AnalysisEngine)mPool.getResource(0); //wait forever
  ...
  /**
   * Returns the size of this pool - the total number of AnalysisEngine
   * instances it would contain if no instances were checked out.
   * 
