...
/**
 * An <code>AnnotatorConfigurationException</code> is thrown by an
 * annotator if the settings of its configuration parameters are invalid.
 *  
 * 
 */
...
/**
  ...
  */
  public static final String PARAMETER_NOT_VALID = 
    "annotator_parameter_not_valid";   

 /**
  * Message key for a standard UIMA exception message:
  * "One of the following parameters must be specified: {0}."
  */
  public static final String ONE_PARAM_REQUIRED = 
    "annotator_one_param_required";   

 /**
  * Message key for a standard UIMA exception message:
  * "Only one of the following parameters may be specified: {0}."
  */
