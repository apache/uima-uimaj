...
/**
 * Base class for CAS Initializers, which developers should extend with their
 * own CAS Initializer implementation classes.
 * 
 *  
    ...
    implements CasInitializer
{
  ...
  /**
   * Notifies this CAS Initializer that its configuration parameter settings have
   * been changed.  By default this method just calls {@link #destroy()} followed
   * by {@link #initialize()}.  CAS Initializers that have expensive initialization
