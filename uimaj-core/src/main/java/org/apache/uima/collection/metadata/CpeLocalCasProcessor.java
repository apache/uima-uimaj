 ...
 * means of defining and obtaining configuration for CasProcessors deployed locally, ie
 * same machine as CPE but different process.
 * <p>
...
public interface CpeLocalCasProcessor extends CpeCasProcessor
{
	 ...
	 * 
	 * @param aJava - true if java, false otherwise
	 */
	 ...
	 * A program can be a java exec, a shell script, or any program that can
	 * run in a separate process.
	 * 
	 * @param aCasProcessorExecutable - name of a program
	 * 
