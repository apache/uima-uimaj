 ...
 * <p>
 * CAS Initializers may be used by some {@link CollectionReader} 
 * implementations.
 * 
...
public interface CasInitializer extends ConfigurableResource
{
   ...
   * The CollectionReader must call this method whenever the
   * CollectionReader's typeSystemInit() method is called.
   * <p>
   * In this method, the CasInitializer should use the {@link TypeSystem} to
   ...
   *    compatible with this CAS Initializer
   */
