 ...
 * CasProcossor. It provides the means of configuring max # of restarts for CasProcessor,
 * error thresholds, and max timeout.  
 * 
 * 
 */
...
{
	/**
	 * Sets max number of restarts allowed for a CasProcessor and an action to take by the CPE
	 * in case the threshold is reached.
	 * 
	 * @param aCasPRestarts - {@link org.apache.uima.collection.metadata.CasProcessorMaxRestarts} instance
	 */
	public void setMaxConsecutiveRestarts(CasProcessorMaxRestarts aCasPRestarts );
	/**
	 * Returns max number of restarts allowed for a CasProcessor and an action to take by the CPE
	 * in case the threshold is reached.
	 * 
	...
	/**
	 * Sets max number of errors allowed for a CasProcessor and an action to take by the CPE
	 * in case the threshold is reached.
	 * 
	 * @param aCasPErrorThreshold - {@link org.apache.uima.collection.metadata.CasProcessorErrorRateThreshold}
	 */
	 ...
	 * 
	 * @param aTimeout {@link org.apache.uima.collection.metadata.CasProcessorTimeout}
	 */
