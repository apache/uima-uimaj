 ...
 * means of configuring CPE checkpoint. The checkpoint contains a name of the file
 * where the recovery information will be stored and a frequency of checkpoints.
 *  
 * 
 */
public interface CpeCheckpoint extends MetaDataObject
{
	 ...
	 * 
	 * @param aCheckpointFilePath - checkpoint file path
	 * @throws CpeDescriptorException
	 */
	public void setFilePath( String aCheckpointFilePath ) 
		throws CpeDescriptorException;
	/**
	...
	/**
	 * Sets frequency of checkpoints. Currently only time-based checkpointing
	 * is supported.
	 * 
	 * @param aFrequency - number of millis between checkpoints
	 * @param aTimeBased - true if checkpoint is based on time
	 */
