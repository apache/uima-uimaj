...
public class Referent extends TOP {
    ...
    /**
     * Determines if the given type is one of the types for the
     * referent.  Unlike {@link #hasSubsumedClass(String)}, this method
     * only returns true if the given string is literally in the type 
     * list; it does not investigate whether the entity is some subtype
    ...
    /**
     * Determines if the given type subsumes one of the types for the
     * referent.  For example, if referent iso1 has a referent type
     * org.Example.IsoscelesTriangle, and the type system of the CAS
     * that iso1 is in states that org.Example.IsoscelesTriangle is a
     * subtype of org.Example.Triangle, then the following call would
     * return true: iso1.hasSubsumedType("org.Example.Triangle").
     * 
     * @param typeName The fully qualified name of a type.
     * @return True if and only if typeName is in the types list 
     */
  ...
  public FSList getLinks() {
    ...
    return (FSList)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Referent_Type)jcasType).casFeatCode_links)));}
  ...
  public void setLinks(FSList v) {
    if (Referent_Type.featOkTst && ((Referent_Type)jcasType).casFeat_links == null)
      JCas.throwFeatMissing("links", "org.apache.uima.klt.Referent");
    jcasType.ll_cas.ll_setRefValue(addr, ((Referent_Type)jcasType).casFeatCode_links, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public StringArray getClasses() {
    ...
    return (StringArray)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Referent_Type)jcasType).casFeatCode_classes)));}
  ...
  public void setClasses(StringArray v) {
    if (Referent_Type.featOkTst && ((Referent_Type)jcasType).casFeat_classes == null)
      JCas.throwFeatMissing("classes", "org.apache.uima.klt.Referent");
    jcasType.ll_cas.ll_setRefValue(addr, ((Referent_Type)jcasType).casFeatCode_classes, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public String getClasses(int i) {
    if (Referent_Type.featOkTst && ((Referent_Type)jcasType).casFeat_classes == null)
      JCas.throwFeatMissing("classes", "org.apache.uima.klt.Referent");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Referent_Type)jcasType).casFeatCode_classes), i);
    return jcasType.ll_cas.ll_getStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Referent_Type)jcasType).casFeatCode_classes), i);}
  ...
  public void setClasses(int i, String v) { 
    if (Referent_Type.featOkTst && ((Referent_Type)jcasType).casFeat_classes == null)
      JCas.throwFeatMissing("classes", "org.apache.uima.klt.Referent");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Referent_Type)jcasType).casFeatCode_classes), i);
    jcasType.ll_cas.ll_setStringArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Referent_Type)jcasType).casFeatCode_classes), i, v);}
  ...
  public String getCanonicalForm() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr, ((Referent_Type)jcasType).casFeatCode_canonicalForm);}
  ...
  public void setCanonicalForm(String v) {
    if (Referent_Type.featOkTst && ((Referent_Type)jcasType).casFeat_canonicalForm == null)
      JCas.throwFeatMissing("canonicalForm", "org.apache.uima.klt.Referent");
    jcasType.ll_cas.ll_setStringValue(addr, ((Referent_Type)jcasType).casFeatCode_canonicalForm, v);}    
  ...
  public StringList getVariantForms() {
    ...
    return (StringList)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Referent_Type)jcasType).casFeatCode_variantForms)));}
  ...
  public void setVariantForms(StringList v) {
    if (Referent_Type.featOkTst && ((Referent_Type)jcasType).casFeat_variantForms == null)
      JCas.throwFeatMissing("variantForms", "org.apache.uima.klt.Referent");
    jcasType.ll_cas.ll_setRefValue(addr, ((Referent_Type)jcasType).casFeatCode_variantForms, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public String getComponentId() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr, ((Referent_Type)jcasType).casFeatCode_componentId);}
