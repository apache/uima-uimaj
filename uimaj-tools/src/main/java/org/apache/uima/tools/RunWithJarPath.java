 ...
 *    
 *    The paths added are added in an arbitrary order, but searched ahead of the
 *    normal classpath.
 *   
...
public class RunWithJarPath {
  ...
  public static void main(String[] args) throws SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, MalformedURLException, IOException, URISyntaxException {
    if (args == null || args.length == 0) {
      ...
      System.err.println("  The classpath created from this specification will be searched ahead of the normal classpath.");
    ...
    URL[] urls = getUrls();
    URLClassLoader cl = new TryFirstClassLoader(urls);
  ...
  private static class TryFirstClassLoader extends URLClassLoader {
 
    /**
     * Creates a new TryFirstClassLoader 
     * 
     * @param urls
