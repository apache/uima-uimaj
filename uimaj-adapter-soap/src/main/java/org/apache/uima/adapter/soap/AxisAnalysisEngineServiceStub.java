...
/**
 * Proxy to an {@link AnalysisEngineService} that makes use of Axis SOAP to 
 * communicate with the service.
 * 
 * 
 */
public class AxisAnalysisEngineServiceStub 
  extends AxisResourceServiceStub implements AnalysisEngineServiceStub
{  
   ...
   * @param aTimeout the timeout period in millseconds, or null to use Axis's
   *    default value
   * 
   ...
   * @param aTimeout the timeout period in millseconds, or null to use Axis's
   *    default value
   * @param aUseAttachments whether attachments should be used to send
   ...
   */
  public AnalysisEngineMetaData callGetAnalysisEngineMetaData()
    ...
    throws ResourceServiceException
  {
    ...
    try
    {
      ...
      call.registerTypeMapping(ResultSpecification.class, 
        resultSpecTypeQName,
        new XmlSerializerFactory(),
        new XmlDeserializerFactory());
      call.registerTypeMapping(ServiceDataCargo.class,
        serviceDataCargoTypeQName, 
      ...
      if (result instanceof AttachmentPart)
      {
        ...
        try
        {
          DataHandler dataHandler = 
              AttachmentUtils.getActivationDataHandler((AttachmentPart)result);
