...
public class XmlDeserializer extends DeserializerImpl
{
    ...
    public XmlDeserializer()
    {
      ...
      {
        mNesting = 0;
        mDeser = new SaxDeserializer_impl(UIMAFramework.getXMLParser(),null,null,new XMLParser.ParsingOptions(false,false));
  ...
  /**
   * @see org.apache.axis.message.SOAPHandler#onStartElement(java.lang.String, java.lang.String, java.lang.String, org.xml.sax.Attributes, org.apache.axis.encoding.DeserializationContext)
   */
  public void onStartElement(
    ...
    throws SAXException
  {
    //System.out.println("AxisResourceServiceDeserializer::onStartElement(" + arg0 + "," + arg1 + "," + arg2  + ")");
  ...
  {
    //System.out.println("AxisResourceServiceDeserializer::characters(" + new String(ch,start,length) + ")");
