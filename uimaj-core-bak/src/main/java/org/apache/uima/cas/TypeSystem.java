 ...
 * {@link org.apache.uima.cas.Type types} and
 * {@link org.apache.uima.cas.Feature features} using their String identifiers.
 * This is a pure access interface. Types and features are defined using
 * Component Descriptors, written in XML.
 * 
 * <p>
 * Get the type system from a {@link CAS CAS} object with
 * {@link CAS#getTypeSystem getTypeSystem()}.
 * 
 * <p>
 * There are a few methods to list the existing types in a type system.
 * Information about which feature is appropriate for which type is available
 * through the {@link Type Type} and {@link Feature Feature} classes.
 * 
 * 
 */
public interface TypeSystem {
     ...
     * Ex.: <code>uima.cas.Annotation:begin</code>.
     */
    public static final char FEATURE_SEPARATOR = ':';

    /**
     * This is the character that separates name spaces. Ex.:
     * <code>uima.cas.Annotation</code>
     */
    public static final char NAMESPACE_SEPARATOR = '.';

    /**
     * Get a type object for a given type name. See documentation on <a
     * href="./Type.html#names">type names</a>.
     * 
     * @param typeName
     ...
     * 
     * @param componentType
     *            The type of the elements of the resulting array type. This can
     *            be any type, even another array type.
     ...
     * @deprecated Use {@link #getDirectSubtypes(Type) getDirectSubtypes(Type)}
     *             instead.
     */
     ...
     * @return A <code>TypeNameSpace</code> object corresponding to
     *         <code>name</code>, or <code>null</code>, if
     *         <code>name</code> is not a legal type name space identifier.
     */
     ...
     * 
     * @return The
     *         {@link org.apache.uima.cas.impl.LowLevelTypeSystem LowLevelTypeSystem}
