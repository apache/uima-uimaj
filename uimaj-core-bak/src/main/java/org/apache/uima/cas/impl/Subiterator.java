...
public class Subiterator extends FSIteratorImplBase {
    ...
    Subiterator(FSIterator it, AnnotationFS annot, final boolean ambiguous,
    ...
    private void initAmbiguousSubiterator(FSIterator it, AnnotationFS annot,
            final boolean strict) {
    ...
    private void initUnambiguousSubiterator(FSIterator it, AnnotationFS annot,
            final boolean strict) {
        final int start = annot.getBegin();
        final int end = annot.getEnd();
        it.moveTo(annot);
        ...
        // position.
        while (it.isValid()
                && ((start > annot.getBegin()) || (strict && annot.getEnd() > end))) {
            it.moveToNext();
        }
        // Add annotations.
        AnnotationFS current, next;
