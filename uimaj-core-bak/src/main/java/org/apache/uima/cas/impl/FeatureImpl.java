...
public class FeatureImpl implements Feature {
    ...
    /**
     * Get the internal code of this feature. Necessary when using low-level
     * APIs.
     */
    public int getCode() {
        return this.code;
    ...
    public String getShortName() {
        return this.name.substring(this.name
                .indexOf(TypeSystem.FEATURE_SEPARATOR) + 1, this.name.length());
    }
    ...
    /**
     * Note: you can only compare features from the same type system. If you
     * compare features from different type systems, the result is undefined.
     */
