...
/**
 * This exception is thrown by an Analysis Engine when it receives a
 * request to generate results that it cannot produce.  More specifically,
 * this exception is thrown by the Analysis Engine's 
 * {@link AnalysisEngine#process(CAS,ResultSpecification)} method when it is
 * given a  {@link org.apache.uima.analysis_engine.ResultSpecification}
 * that is outside the scope of its 
...
/**
  ...
  * "No sequence of AnalysisEngines could be constructed to satisfy the requested result."
  */
