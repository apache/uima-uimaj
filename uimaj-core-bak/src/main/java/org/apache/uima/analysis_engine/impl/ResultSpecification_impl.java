...
public class ResultSpecification_impl extends MetaDataObject_impl implements ResultSpecification
{
  ...
  /**
   * @see org.apache.uima.analysis_engine.ResultSpecification#setResultTypesAndFeatures(org.apache.uima.analysis_engine.TypeOrFeature[], java.lang.String[])
   */
  ...
  /**
   * @see org.apache.uima.analysis_engine.ResultSpecification#addResultTypeOrFeature(org.apache.uima.analysis_engine.TypeOrFeature, java.lang.String[])
   */
  ...
  /**
   * @see org.apache.uima.analysis_engine.ResultSpecification#addResultType(java.lang.String, boolean)
   */
  ...
  /**
   * @see org.apache.uima.analysis_engine.ResultSpecification#addResultType(java.lang.String, boolean, java.lang.String[])
   */
  ...
  /**
   * @see org.apache.uima.analysis_engine.ResultSpecification#addResultFeature(java.lang.String, java.lang.String[])
   */
   ...
   * @param t
   */
  private void addTypeRecursive(Type type, TypeSystem typeSystem, HashSet languages, boolean allFeatures)
  {   
  ...
  public boolean containsType(String aTypeName, String language)
  {
    ...
    if (!mCompiledNameToLanguageMap.isEmpty())
    {
      ...
      if (languages != null)
      {
        ...
        if (UNSPECIFIED_LANGUAGE.equals(language) ||
    ...
    else
    {
      ...
      while (it.hasNext())
      {
        ...
        if ((!elem.isType() && aFullFeatureName.equals(elem.getName()))
            || (elem.isType() && elem.isAllAnnotatorFeatures() && typeName.equals(elem.getName())))
        {
          return true;
        }
      }
  ...
  /**
   * @see org.apache.uima.analysis_engine.ResultSpecification#addCapabilities(org.apache.uima.resource.metadata.Capability[], boolean)
   */
  ...
  /**
   * Map from TypeOrFeature objects to HashSets that include
   * the language codes (Strings) for which that type or feature 
   * should be produced.
   */
  private Map mTypesAndFeatures = new HashMap();

  /**
   * Map from String type or feature names to HashSets that include
   * the language codes (Strings) for which that type or feature should
   * be produced.  This is populated by the compile() method, and 
   * includes subtypes as well as the individual feature names for
   * types that have allAnnotatorFeatures=true.
   */
