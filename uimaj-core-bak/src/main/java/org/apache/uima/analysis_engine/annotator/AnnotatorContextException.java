...
/**
 * An <code>AnnotatorContextException</code> is thrown by an
 * {@link AnnotatorContext} if it
 * cannot complete the invoked operation due to a failure in the underlying 
 * implementation.
 *  
 * 
 */
...
/**
  ...
  */
  public AnnotatorContextException(String aResourceBundleName,
