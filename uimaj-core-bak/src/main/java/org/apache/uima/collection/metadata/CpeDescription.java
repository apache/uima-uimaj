 ...
 * Generate an instance of this class by calling either the 
 * {@link org.apache.uima.util.XMLParser#parseCpeDescription(XMLInputSource)}
 * or {@link org.apache.uima.collection.impl.metadata.cpe.CpeDescriptorFactory#produceDescriptor()}.
 * A CPE instance can then be created by calling
...
public interface CpeDescription extends MetaDataObject
{
	 ...
	 * 
	 * <p>
	 * Currently the CPE supports only one CollectionReader instance. A future version of the
	 * CPM will include support for more.
	 * </p>
	 * @param aCollectionReaderPath - path to the CollectionReader descriptor
	 ...
	 * 
	 * @param aCasInitializerPath - path to the CasInitializer descriptor
   ...
   * @deprecated As of v2.0 CAS Initializers are deprecated.
	 */
	public CpeCollectionReaderCasInitializer addCasInitializer(String aCasInitializerPath) throws CpeDescriptorException;
	/**
	...
	public void setAllCollectionCollectionReaders(CpeCollectionReader[] readers) throws CpeDescriptorException;
	...
	/**
	 * Appends a instance of {@link org.apache.uima.collection.metadata.CpeCasProcessor} to the 
	 * end of the list containing CPE CasProcessors.
	 * 
	 ...
	 * <li> Cas Consumer
	 * </ul>
	 * @param aCasProcessor - instance of {@link org.apache.uima.collection.metadata.CpeCasProcessor}
	 * to add.
	 * @throws CpeDescriptorException
	 */
	 ...
	 * location in the list of CPE CasProcessors. If the index is greater than the list size, the
	 * new {@link org.apache.uima.collection.metadata.CpeCasProcessor} instance is appended to the list.
	 * 
	 * @param index - insertion point for the {@link org.apache.uima.collection.metadata.CpeCasProcessor}
	...
	/**
	 * Defines the size for the InputQueue. This queue is used by the CPE to store bundles of CAS
	 * as read by a CollectionReader. The queue is shared between the CollectionReader and ProcessingUnits.
	 ...
	 * the speed of analysis and available memory.
	 *  
	 * @param aSize - size of the queue
	 * 
	 * @throws CpeDescriptorException
	 */
	 ...
	 *  
	 * @param aCheckpointFile - path for the checkpoint file
	 * @param aFrequency - frequency in terms of mills for checkpoints
	 */
	 ...
	 * This timer will be used by the CPE to time events.
	 * 
	 * @param aTimerClass - name of the UimaTimer class
	 */
