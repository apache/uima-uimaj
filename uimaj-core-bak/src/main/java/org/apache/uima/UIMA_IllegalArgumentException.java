...
/**
  ...
  * "Value "{0}" is not valid for argument "{1}" of method {2}."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "The value {0} does not match the data type of metadata attribute {1}."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "An attempt was made to register class {0} with the XML parser.  This
  *  class does not implement the XMLizable interface."
  */
