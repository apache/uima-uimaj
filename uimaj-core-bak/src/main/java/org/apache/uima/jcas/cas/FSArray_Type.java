...
//*********************************
/** The java Cas model for the CAS FSArray Type
 * This is <b>not final</b> because the migration
 * from pre v08 has the old FSArray_Type as a subclass of this.
 */
public class FSArray_Type extends CommonArray_Type {
  ...
  private final FSGenerator fsGenerator = new FSGenerator() {
	...
	private FSArray_Type(){}	// block default new operator    
