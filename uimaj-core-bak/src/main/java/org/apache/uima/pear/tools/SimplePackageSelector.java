...
/**
 * The <code>SimplePackageSelector</code> class provides simple command line  
 * dialog for selecting root directories of installed PEAR packages, as well 
 * as PEAR package files, which contain components that need to be installed.
 * 
 */
...
public class SimplePackageSelector 
	 ...
	 * 
	 * @param stdOut The given standard output stream writer.
	 * @param stdErr The given standard error stream writer.
	 */
	...
	/**
	 * Allows entering the installation directory path for a given 
	 * component from the console window.
	 * 
	 * @param componentId The given component ID.
	 * @return The installation directory for the given component or 
	 * <code>null</code>, if the entered string is empty.
	 */
	public File selectPackageDirectory( String componentId ) {
		if( _stdOut != null ) {
			...
			_stdOut.print( 
				"> enter the " + componentId + " root directory: " );
			_stdOut.flush();
		} else {
	...
	/**
	 * Allows entering the PEAR file path for a given component from the 
	 * console window.
	 * 
	 * @param componentId The given component ID.
	 * @return The PEAR file for the given component or <code>null</code>, 
	 * if the entered string is empty.
	 */
	public File selectPackageFile( String componentId ) {
		if( _stdOut != null ) {
			_stdOut.print( 
				"> Enter the " + componentId + " PEAR file path: " );
			_stdOut.flush();
		} else {
			System.out.print( 
					"> Enter the " + componentId + " PEAR file path: " );
	...
	/**
	 * Allows entering the PEAR package URL for a given component from the 
	 * console window.
	 * 
	 * @param componentId The given component ID.
	...
	public URL selectPackageUrl( String componentId ) {
		if( _stdOut != null ) {
			_stdOut.print( 
				"> Enter the " + componentId + " PEAR package URL: " );
			_stdOut.flush();
		} else {
			System.out.print( 
					"> Enter the " + componentId + " PEAR package URL: " );
