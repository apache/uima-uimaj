...
public class CasDataToXCas
{
   ...
   * 
   * @param aXCasDocTextTag the document text tag
   */
  ...
  /**
   * Generates XCAS for a CasData.  SAX events representing the XCAS will be
   * sent to the ContentHandler registered via {@link #setContentHandler(ContentHandler)}.
   * 
   * @param aCasData the CasData from which XCAS will be generated
   * 
   * @throws SAXException if the ContentHandler throws a SAX Exception
   */
  ...
  /**
   * Special form of {@link #generateXCas(CasData)} that allows a UEID
   * (Universal Entity ID) element to be added as the first element in the XCAS.
   * 
   * @param aCasData the CasData from which XCAS will be generated
   * @param aUEID the UEID to add to the XCAS
   * 
   * @throws SAXException if the ContentHandler throws a SAX Exception
   */
   ...
   * Special form of {@link #generateXCas(CasData)} that allows a UEID
   * (Universal Entity ID) element to be added as the first element in the XCAS
   * and also allows start/end document SAX calls to be supressed.
   * 
   * @param aCasData the CasData from which XCAS will be generated
   * @param aUEID the UEID to add to the XCAS
   * @param aSendStartAndEndDocEvents true to send SAX events for start and end
   *   of document, false to supress them.
   * 
   * @throws SAXException if the ContentHandler throws a SAX Exception
   */
  ...
  private void _generate(FeatureStructure aFS, DocTextHolder aDocTextHolder) throws SAXException
  {
    ...
    {
      //generate attributes for features (except "value" feature, which is represented in element text)
  ...
  /**
   * Gets the XCAS element name for a FS.  This is usually the same as the type name,
   * but the sequences _colon_ and _dash_ are translated to the characters : and -, respectively.
   *
   * @param aFS feature structures 
