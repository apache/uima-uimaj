...
/**
 * Thrown by {@link Resource#initialize(ResourceSpecifier,Map)} to indicate
 * that a failure has occurred during initialization.
 * 
 * 
 */
...
/**
  ...
  */
  public ResourceInitializationException(String aResourceBundleName,
  ...
  */
   ...
   * "Error initializing "{0}" from descriptor {1}."
   */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "Annotator class name is required for a primitive Text Analysis Engine."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "Annotator class "{0}" was not found."
  */
  ...
  */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Annotator class {0} does not implement an Annotator interface
   *  that is supported by Analysis Engine implementation {1}."
   */
  ...
  /**
  * Message key for a standard UIMA exception message:
  * "Could not instantiate Annotator class "{0}".  Check that your annotator
  * class is not abstract and has a zero-argument constructor."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "Initialization of annotator class "{0}" failed."
  */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "The feature {0} is declared twice, with incompatible range types {1} and {2}." 
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "The Type {0} is declared twice, with incompatible supertypes {1} and {2}."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Undefined type "{0}", referenced in feature "{1}" declared on type "{2}"."
   */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "The Analysis Engine Descriptor is invalid - a Type System may not
  *  be explicitly set for an aggregate Analysis Engine."
  */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Type {0} extends String and must specify a list of allowed values."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Type {0} specifies a list of allowed values but is not a subtype
   *  of uima.cas.String.  You may only specify a list of allowed values
   *  for string subtypes."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Duplicate configuration parameter name "{0}" in component "{1}"."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "This resource requires {0} parameter(s)."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "No resource could be found for the parameters {0}."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Could not access the resource data at {0}."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "The Resource class {0} could not be found."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "The Resource Factory does not know how to create a resource of
   *  class {0} from the given ResourceSpecifier."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "The class {0} does not implement org.apache.uima.resource.SharedResourceObject."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "For resource "{0}", could not load data from class {1} into class {2},
   *  because class {1} is not a Data Resource."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "No resource with name "{0}" has been declared in this Analysis Engine."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "The resource with name "{0}" does not implement the required interface {1}."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "There is no resource satisfying the required resource dependency with 
   *  key "{0}"."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "The configuration data {0} for Configuraion parameter {1} in the resource is absent or not valid"
   */   
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Configuration setting for {0} is absent
	 */	
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Two different CAS FeatureStructure indexes with name "{0}" have been defined.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Configuration parameter "{0}" in primitive Analysis Engine "{1}" declares an override.
	 * Parameter overrides are allowed only in aggregate Analysis Engines.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid configuration parameter override syntax "{0}" in
	 * parameter "{1}" of Analysis Engine "{2}".  Overrides
	 * must be of the form "&lt;delegateKey>/&lt;paramName>"
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid configuration parameter override "{0}" in
	 * parameter "{1}" of Analysis Engine "{2}" -- delegate Analysis Engine
	 * "{3}" does not exist.
	 */
	 ...
	 * Invalid configuration parameter override "{0}" in
	 * parameter "{1}" of Analysis Engine "{2}" -- delegate Analysis Engine
	 * "{3}" does not declare parameter {4}.
	 */
	 ...
	 * Invalid configuration parameter override "{0}" in
	 * parameter "{1}" of Analysis Engine "{2}" -- delegate Analysis Engine
	 * "{3}" does not declare parameter {4} in group {5}.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * The output Sofa "{0}" in component "{1}" is not mapped to any
	 * output Sofa in its containing aggregate, "{2}".
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * The input Sofa "{0}" in component "{1}" is not an input of the
	 * containing aggregate, "{2}", nor is it an output of another component
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * The Sofa "{0}" in aggregate "{1}" is not mapped to any sofa
	 * of any component in that aggregate.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * The Sofa "{0}" in component "{1}" of aggregate "{2}" has 
	 * conflicting mappings to aggregate sofas "{3}" and "{4}".
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 *An implementation class name is missing from the descriptor.
	 */
   ...
   /**
    * Message key for a standard UIMA exception message:
    * "Error creating CAS Processor with name "{0}".  The descriptor type "{1}"
    *  is not allowed - you must specify an AnalysisEngine or CAS Consumer
    *  descriptor."
    */
    ...
    /**
     * Message key for a standard UIMA exception message:
     * "A CollectionReader descriptor specified implementation class "{0}",
     *  but this class does not implement the CollectionReader interface."
     */
    public static final String NOT_A_COLLECTION_READER =
     ...
     /**
      * Message key for a standard UIMA exception message:
      * "A CasConsumer descriptor specified implementation class "{0}",
     ...
     /**
      * Message key for a standard UIMA exception message:
      * "A CasInitializer descriptor specified implementation class "{0}",
      *  but this class does not implement the CasInitializer interface."
      */
     ...
     /**
      * Message key for a standard UIMA exception message:
      * "Initialization of CAS Processor with name "{0}" failed.
      */
     ...
     /**
      * Message key for a standard UIMA exception message:
      * "The descriptor for aggregate AnalysisEngine "{0}" declared 
      *  multipleDeploymentAllowed == true, but its copmonent "{1}" declared 
      ...
      */
       ...
       * Message key for a standard UIMA exception message:
       * "The descriptor for aggregate AnalysisEngine "{0}" declared 
       *  modifiesCas == false, but its copmonent "{1}" declared modifiesCas 
       *  == true, which is inconsistent." 
       */
      ...
      /**
       * Message key for a standard UIMA exception message:
       * "Type "{0}" does not define a supertype."
       */
      public static final String NO_SUPERTYPE = "no_supertype";

      /**
       * Message key for a standard UIMA exception message:
       * Undefined component key "{1}", referenced in Sofa mapping for
       * Sofa "{2}" of aggregate "{3}".
       */
      ...
      /**
       * Message key for a standard UIMA exception message:
       * Component "{0}" does not contain Sofa "{1}", referenced in Sofa mapping 
       * for Sofa "{2}" of aggregate "{3}".
       */
      ...
      /**
       * Message key for a standard UIMA exception message:
       * "The class {0} is not a valid Analysis Component.  You must specify
      ...
      /**
       * Message key for a standard UIMA exception message:
       * "An Aggregate Analysis Engine specified a Flow Controller descriptor {0} of
       * an invalid type ({1})).  A FlowControllerDescription is required." 
       */
      ...
      /**
       * Message key for a standard UIMA exception message:
       * "{0} is not a supported framework implementation" 
       */
       ...
       * Message key for a standard UIMA exception message:
       * "The descriptor for aggregate AnalysisEngine "{0}" declared 
       *  outputsNewCASes == true, but all of its components declared 
       *  outputsNewCASes == false, which is inconsistent."
       */
      ...
      /**
       * Message key for a standard UIMA exception message:
       * "The aggregate AnalysisEngine "{0}" declared an empty
       *  <flowController/> element.  You must specify an import or a 
      ...
      /**
       * Message key for a standard UIMA exception message:
       * "The primitive AnalysisEngine "{0}" has an annotator of type
       *  {1} but its descriptor declares input or output Sofas.  Text annotators
       *  are not allowed to declare input or output Sofas.  Consider extending
       *  CasAnnotator_ImplBase or JCasAnnotator_ImplBase instead."
       */
