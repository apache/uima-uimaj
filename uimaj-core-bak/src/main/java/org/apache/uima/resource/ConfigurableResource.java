...
/**
 * A {@link Resource} that has configuration parameters that can be changed
 * after the Resource has been instantiated.
 * <p>
 * To set configuration parameters, call the 
 * {@link #setConfigParameterValue(String,String,Object)} method for each 
 * parameter that is to be set, and then call the {@link #reconfigure()}
 * method to cause the Resource to re-read its configuration settings.
 * <p>
 * Note that if the Resource attempts to access its configuration settings between
 * the call to <code>setConfigParameterValue</code> and the call to <code>reconfigure</code>,
 * it may retrieve either the old value or the new value.  This decision is left 
 * to the framework's {@link ConfigurationManager} implementation.
 * 
 * 
 */
public interface ConfigurableResource extends Resource
{
  ...
  /**
   * Looks up the value of a configuration parameter.  This method will only 
   * return the value of a parameter that is not defined in any group.
   * <p>
   ...
   *   <code>null</code> is either the parameter does not exist or it 
  ...
  /**
   * Looks up the value of a configuration parameter in a group.  If the
   * parameter has no value assigned within the group, fallback strategies
   * will be followed.
   * <p>
   * This method returns <code>null</code> if the parameter is optional and
   * has not been assigned a value.  (For mandatory parameters, an exception
   ...
   * configuration parameter with the specified name.
   * 
   * @param aGroupName the name of a configuration group.  If the group name is
   ...
   * guarantee that the change will take effect until {@link #reconfigure()}
   * is called.
   * 
   * @param aParamName the name of a parameter that is not in any group
