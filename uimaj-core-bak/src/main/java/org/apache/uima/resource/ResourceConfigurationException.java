...
/**
 * Thrown to indicate that a {@link Resource}'s configuration paramters could
 * not be set.  Most commonly this will be because the caller has specified
 * a nonexistent parameter name or a value of the incorrect data type.
 * 
 * 
 */
...
/**
  ...
  */
   ...
   * "No configuration parameter with name {0} is declared in component "{1}."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "No configuration parameter with name {0} is declared in group {1} in
   *  this component "{2}"."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Parameter type mismatch in component "{0}".  A value of class {1} cannot be assigned to 
   * the configuration parameter {2}, which has type {3}."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Configuration parameter "{0}" in component "{1}" is multi-valued and must be assigned an
   *  array for its value."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "No value has been assigned to the mandatory configuration parameter {0}."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "Could not load properties file "{0}"."
   */
   public static final String PROPERTIES_FILE_NOT_FOUND =
		  "properties_file_not_found";

	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid value for parameter "{0}" in component "{1}" --
