...
/**
 * A description of a CAS Type.  This implements <code>MetaDataObject</code>,
...
public interface TypeDescription extends MetaDataObject
{
   ...
   * 
   * @param aName the name of this Type
   */
   ...
   * 
   * @param aDescription the description of this Type
   */
  public void setDescription(String aDescription);


  /**
   * Gets the name of the supertype for this Type.  This is the Type from
  ...
  /**
   * Sets the name of the supertype for this Type.  This is the Type from
   * which this Type inherits.
   * 
   * @param aTypeName the name of the supertype for this Type
   */
   ...
   * 
   * @param aFeatures descriptions of the features for this Type.
   */
  public void setFeatures(FeatureDescription[] aFeatures); 
  
  
  /**
   * Gets the allowed values for instances of this Type.  This is used only
   * for special "enumerated types" that extend the String type and define a 
   * specific set of allowed values.  For all other Types this will return
   * <code>null</code>.  Note that if a type has allowed values, it may
   * not have features.
   * 
  ...
  /**
   * Sets the allowed values for instances of this Type.  This is used only
   * for special "enumerated types" that extend the String type and define a 
   * specific set of allowed values.  For all other Types this property
   * should be <code>null</code>.  Note that if a type has allowed values, it 
   * may not have features.
   * 
   * @param aAllowedValues the allowed values for instances of this Type
   */
  ...
  /**
   * Convenience method which adds a FeatureDescription to this TypeDescription.  Used for
   * array or list valued features, which have additional attributes.
   * 
   * @param aFeatureName name of feature to add
   * @param aDescription verbose description of the feature
   * @param aRangeTypeName name of feature's range type
   * @param aElementTypeName type of element expected to be contained in the array or list
   * @param aMultipleReferencesAllowed whether an array or list that's assigned to this feature
   *   can also be referenced from another feature.  This is a Boolean object so that the null
   *   value can be used to represent the case where the user has not specified a value.
   * 
   * @return description of the new Feature
   */
  public FeatureDescription addFeature(String aFeatureName, String aDescription, 
