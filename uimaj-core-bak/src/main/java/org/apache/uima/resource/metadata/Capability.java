...
/**
 * A <code>Capability</code> defines an operation that an Resource can 
 * carry out.  Each Capability consists of the following information:
 * <ul>
 ...
 * <li>Preconditions that must be satisfied in order for processing to begin.
 *     In a text analysis engine, the most common precondition is a check on 
 *     the language of the document.</li>
 * </ul>
 * 
 * As with all {@link MetaDataObject}s, a <code>Capability</code>
...
public interface Capability extends MetaDataObject
{
   ...
   * 
   * @param aDescription aDescription the description of this Capability.
   */
  ...
  * 
  * @return an array of references to Types or Features in this Resource's
  *    Type System.
  */
 ...
 /**
  * Retrieves the preconditions that must be satisfied in order for the
  * Resource to begin processing.
  * 
  * @return an unmodifiable list of 
  *    {@link Precondition Precondition}s.
  */
  ...
  * <code>Capability</code> and returns the ISO language identifiers that
  * the Resource supports.  This is only meaningful when analyzing
  * text documents.
  * 
  * @return an array of ISO language identifiers.  An empty array means that
  *    the Resource claims to be language-independent.
  */
  ...
  /**
   * A convenience method that analyzes the preconditions of this
   * <code>Capability</code> and returns the MIME types that
   * the Resource can take as input.
   * 
   * @return an array of MIME types.  This may be empty if the Resource 
   *    does not declare MIME type preconditions.
   */
  ...
  * 
  * @param aInputs an array of references to Types or Features in this Resource's
  *    TypeSystem.
  */
 ...
 /**
   ...
   * 
   * @param aOutputs an array of references to Types or Features in this 
 ...
 /**
   ...
   * 
   * @param aInputSofas an array of strings containing SofA names
   */
 ...
 /**
   ...
   * @param aOutputSofas an array of strings containing SoFA name
   */
  ...
  * 
  * @param aPreconditions an array of <code>Precondition</code> objects
  *
  * @throws org.apache.uima.UIMA_UnsupportedOperationException if this 
  ...
  */
  ...
  /**
   * A convenience method that sets the languages that this Resource
   * supports.  This is only meaningful when text documents are analyzed.
   * <p>
   * Calling this method affects the preconditions of this <code>Capability</code>.
   * All other language support preconditions will be removed, but
   * non-language related preconditions will be unaffected.
   * 
   * @param aLanguageIDs  an array of ISO language identifiers.  An empty array 
   *    means that the Resource claims to be language-independent.
   */
  public void setLanguagesSupported(String[] aLanguageIDs);
  

  /**
   * A convenience method that sets the MIME types that this Resource
   * can take as input.
   * <p>
   * Calling this method affects the preconditions of this <code>Capability</code>.
   * All other MIME type preconditions will be removed, but other preconditions
   * will be unaffected.
   * 
   * @param aMimeTypes an array of MIME types.  This may be empty if the 
   *    Resource does not declare MIME type preconditions.
   */
   ...
   * 
   * @param aTypeName the fully qualified type name
   * @param aAllAnnotatorFeatures if true, indicates that this Capability 
   *    requires as input all features of this type that are specified in
   *    the same AnalysisEngine descriptor.  If false, features must be explicitly
   *    declared by calling {@link #addInputFeature(String)}. 
   */
   ...
   * 
   * @param aFeatureName the fully qualified feature name
   */
   ...
   * @param aTypeName the fully qualified type name
   * @param aAllAnnotatorFeatures if true, indicates that this Capability 
   *    declares as output all features of this type that are specified in
   *    the same AnalysisEngine descriptor.  If false, features must be explicitly
   *    declared by calling {@link #addOutputFeature(String)}. 
   */
   ...
   * 
   * @param aLanguage the ISO language identifier
   */
