...
/**
 * A class that stores the name of an attribute and the Class of that
 * attribute's value.
 *  
 * 
 */
...
{  
   ...
   * @param aClassName the name of the class of that attribute's value
   */
  ...
  /**
   * Determines if two NameClassPairs are equal.  Two NameClassPairs are
   * equal if both their Name and ClassName properties are equal.
   * 
   * @return the class name
   */
  public boolean equals(Object aObj)
  {
    ...
    boolean classNameMatch =
      this.getClassName() == null ? 
          that.getClassName() == null : 
