...
/**
 * A <code>Logger</code> is a component used to log messages.  This interface
 * defines the standard way for UIMA components to produce log output.
 * <p>
 * In the UIMA SDK, this interface is implemented using the Java 1.4 logger as a back
...
public interface Logger
{
	 ...
	 * @param aMessageKey key of message to localize with message level INFO
	 ...
	 * @deprecated use new function with log level
	 * 
	 * @param aException the exception to be logged with message level INFO
	 */
	public void logException(Exception aException);

	/**
	 * Sets the output stream to which log messages will go.  Setting the output
	 * stream to <code>null</code> will disable the logger.
	 * 
	 * @deprecated use external configuration possibility
	 * 
	 * @param aStream <code>PrintStream</code> to which log messages will be printed
	 */
	 ...
	 * @deprecated use external configuration possibility
	 * 
	 * @param aStream <code>OutputStream</code> to which log messages will be printed
	 */
	 ...
	 * @param level message level
	 * @param aMessage the message to be logged
	 * @param params message parameter array
	 */
	 ...
	 * @param sourceMethod source method name
	 * @param bundleName resource bundle
	 ...
	 * The real message is extracted from a resource bundle.
	 * 
	 * @param level message level
	 * @param sourceClass source class name
	 * @param sourceMethod source method name
	 * @param bundleName resource bundle
	 * @param msgKey message key
	 * @param params message parameter array with an arbitrary number of parameters
	 */
	...
	/**
	 * Sets the level of messages that will be logged by this logger.  Note that if you
     * call <code>UIMAFramework.getLogger().setLevel(level)</code>, this will only
     * change the logging level for messages produced by the UIMA framework.  It will NOT
     * change the logging level for messages produced by annotators.  To change the
     * logging level for an annotator, use
     * <code>UIMAFramework.getLogger(YourAnnotatorClass.class).setLevel(level)</code>.
	 * <p>
     * If you need more flexibilty it configuring the logger, consider using the
     * standard Java logger properties file or the java.util.logging APIs.
     * 
	 * @param level message level
	 */
    ...
    /**
     * Sets the ResourceManager to use for message localization.  This method
     * is intended for use by the framework, not by user code.  
     * @param resourceManager A resource manager instance whose extension ClassLoader
     *   (if any) will be used for message localization by this logger.
     */
