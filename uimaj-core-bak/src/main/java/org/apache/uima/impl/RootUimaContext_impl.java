...
/**
 * Implementation of the root {@link UimaContext}.  UIMA Contexts are arranged in
 * a tree structure corresponding to the nested structure of the components in
 * a CPE or Aggregate AE.  The root UimaContext has direct references to shared
 * compoennts such as the ResourceManager and ConfigurationManager.  The
 * children UimaContexts reference these through the root.
 */
public class RootUimaContext_impl extends UimaContext_ImplBase
{
	...
	/* (non-Javadoc)
	 * @see org.apache.uima.UimaContextAdmin#initialize(org.apache.uima.resource.ResourceCreationSpecifier, org.apache.uima.util.Logger, org.apache.uima.resource.ResourceManager, ConfigurationManager)
	 */
...
/**
  ...
  private ResourceManager mResourceManager;
	 ...
	 */
	private InstrumentationFacility_impl mInstrumentationFacility
		= new InstrumentationFacility_impl(null);
