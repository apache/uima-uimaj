 ...
 * Applications cannot use this class directly.  Use the static methods
 * on {@link UIMAFramework} instead.
 * <p>
 * This class is a singleton which will be accessed by many threads
 * simulatenously.  It must be threadsafe.
 * 
 * 
 */
public class UIMAFramework_impl extends UIMAFramework
{
    ...
    throws Exception
  {
    ...
    mDefaultPerformanceTuningProperties.load(
      UIMAFramework_impl.class.getResourceAsStream("performanceTuning.properties"));
  ...
  /**
   * Retrieves a reference to the <code>ResourceFactory</code> used 
   * by the UIMA reference implementation.
   *
      ...
      ResourceManager aResourceManager)
  {
    try
    {
      ...
      Constructor constructor =
        cpmClass.getConstructor(new Class[]{ResourceManager.class});
      return (CollectionProcessingManager)constructor.newInstance(
          new Object[]{aResourceManager});
  ...
  /**
   * To be implemented by subclasses; this should return a reference to the
   * UIMA {@link Logger) used by this implementation.
   * 
  ...
  protected ResourceManager _newDefaultResourceManager()
  {
    try
    {
      return (ResourceManager)
         Class.forName(mResourceManagerImplClassName).newInstance();
    }
	...
	protected ConfigurationManager _newConfigurationManager()
	{
		try
		{
			return (ConfigurationManager)
				 Class.forName(mConfigurationManagerImplClassName).newInstance();
		}
		catch (InstantiationException e)
		{
			throw new UIMARuntimeException(e);
	...
	protected UimaContextAdmin _newUimaContext()
	{
		try
		{
			return (UimaContextAdmin)
				 Class.forName(mUimaContextImplClassName).newInstance();
		}
		catch (InstantiationException e)
		{
			throw new UIMARuntimeException(e);
	...
	protected UimaTimer _newTimer()
	{
		...
		{
			return (UimaTimer)
				 Class.forName(mTimerClassName).newInstance();
		}
		catch (InstantiationException e)
		{
			throw new UIMARuntimeException(e);
	...
	/* (non-Javadoc)
	 * @see org.apache.uima.UIMAFramework#_produceCollectionProcessingEngine(org.apache.uima.collection.metadata.cpeDescription, java.util.Map)
	 */
		...
		throws ResourceInitializationException
	{
		try
		{
			CollectionProcessingEngine cpe = (CollectionProcessingEngine)
			  	 Class.forName(mCpeClassName).newInstance();
  ...
  /**
   * Parses the factoryConfig.xml file and sets up the ResourceFactory,
   * ResourceSpecifierFactory, and XMLParser. 
   * 
   * @throws ParserConfigurationException if the XML parser could not be
   *    configured
   * @throws SAXException if factoryConfig.xml could not be parsed
   */ 
  ...
  {        
    ...
    reader.parse(new InputSource(
        UIMAFramework_impl.class.getResourceAsStream("factoryConfig.xml")));
  }

     
  /**
   * The <code>ResourceFactory</code> used by the UIMA
   * reference implemenation.
   */     
  private CompositeResourceFactory mResourceFactory;   

  /**
   * The <code>ResourceSpecifierFactory</code> used by the UIMA
   * reference implemenation.
   */     
  private ResourceSpecifierFactory mResourceSpecifierFactory;   
  /**
   * The <code>XMLParser</code> used by the UIMA
   * reference implemenation.
   */     
  private XMLParser mXMLParser;   
  
  /**
   * The class of the <code>Logger</code> used by the UIMA
   * reference implemenation.
   */     
  private Class mLoggerClass;

  /**
   * The default <code>Logger</code> instance used by the UIMA
   * reference implemenation.
   */     
  private Logger mDefaultLogger;
  
  /**
   * CollectionProcessingManager implementation class, an instance of
   * which will be returned by {@link #newCollectionProcessingManager()}.
   */     
  private String mCpmImplClassName;

  /**
   * ResourceManager implementation class, an instance of
   * which will be returned by {@link #newDefaultResourceManager()}.
   */     
  private String mResourceManagerImplClassName;

	/**
	 * ConfigurationManager implementation class, an instance of
	 * which will be returned by {@link #newConfigurationManager()}.
	 */     
	private String mConfigurationManagerImplClassName;

	/**
	 * The class of the <code>UimaContext</code> used by the UIMA
	 * reference implemenation.
	 */     
	private String mUimaContextImplClassName;

	/**
	 * The class of the <code>CollectionProcessingEngine</code> used by the UIMA
	 * reference implemenation.
	 */     
      ...
      throws SAXException
    {
      ...
      else if ("cpm".equals(qName))
      {
        if (context != CONTEXT_FACTORY_CONFIG)
        {
          throw new SAXException(
            I18nUtil.localizeMessage(
              UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
              "element_unexpected_in_context", new Object[]{"<cpm>"}));
        }
      ...
      else if ("resourceManager".equals(qName))
      {
        if (context != CONTEXT_FACTORY_CONFIG)
        {
          throw new SAXException(
            I18nUtil.localizeMessage(
              UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
              "element_unexpected_in_context", new Object[]{"<resourceManager>"}));
        }
			...
			else if ("configurationManager".equals(qName))
			{
				if (context != CONTEXT_FACTORY_CONFIG)
				{
					throw new SAXException(
						I18nUtil.localizeMessage(
							UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
							"element_unexpected_in_context", new Object[]{"<configurationManager>"}));
				}
			...
			else if ("uimaContext".equals(qName))
			{
				if (context != CONTEXT_FACTORY_CONFIG)
				{
					throw new SAXException(
						I18nUtil.localizeMessage(
							UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
							"element_unexpected_in_context", new Object[]{"<uimaContext>"}));
				}
			...
			else if ("cpe".equals(qName))
			{
				if (context != CONTEXT_FACTORY_CONFIG)
				{
					throw new SAXException(
						I18nUtil.localizeMessage(
							UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
							"element_unexpected_in_context", new Object[]{"<cpe>"}));
				}
			...
			else if ("timer".equals(qName))
			{
				if (context != CONTEXT_FACTORY_CONFIG)
				{
					throw new SAXException(
						I18nUtil.localizeMessage(
							UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
							"element_unexpected_in_context", new Object[]{"<timer>"}));
				}
      ...
      else if("resourceSpecifier".equals(qName))
      {
        if (mLoggerClass == null)
        {
          throw new SAXException(
            I18nUtil.localizeMessage(
              UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
              "expected_x_but_found_y", new Object[]{"<logger>","<resourceSpecifier>"}));
        }
      ...
      else if ("resource".equals(qName))
      {
        if (mLoggerClass == null)
        {
          throw new SAXException(
            I18nUtil.localizeMessage(
              UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
              "expected_x_but_found_y", new Object[]{"<logger>","<resource>"}));
        }
      ...
      else if ("simpleFactory".equals(qName))
      {
        if (context != CONTEXT_RESOURCE)
        {
          throw new SAXException(
            I18nUtil.localizeMessage(
              UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
              "element_unexpected_in_context", new Object[]{"<simpleFactory>"}));
        }
      ...
      else if ("binding".equals(qName))
      {
        if (context == CONTEXT_RESOURCE_SPECIFIER)
        {
          try
          {
            mXMLParser.addMapping(
              attributes.getValue("element"),
              attributes.getValue("class"));
            mResourceSpecifierFactory.addMapping(
        ...
        else if (context == CONTEXT_SIMPLE_FACTORY)
        {
          try
          {
            simpleFactory.addMapping(
              attributes.getValue("specifier"),
        ...
        else
        {
          throw new SAXException(
            I18nUtil.localizeMessage(
              UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
              "element_unexpected_in_context", new Object[]{"<binding>"}));
        }  
      }
      else if ("customFactory".equals(qName))
      {
        if (context != CONTEXT_RESOURCE)
        {
          throw new SAXException(
            I18nUtil.localizeMessage(
              UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
              "element_unexpected_in_context", new Object[]{"<customFactory>"}));
        }        
        try
        {
      ...
      else if ("factoryConfig".equals(qName))
      {
        if (context != CONTEXT_NONE)
        {
          throw new SAXException(
            I18nUtil.localizeMessage(
              UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
              "element_unexpected_in_context", new Object[]{"<factoryConfig>"}));
        }
      ...
      else
      {
        throw new SAXException(
          I18nUtil.localizeMessage(
            UIMAException.STANDARD_MESSAGE_CATALOG, Locale.getDefault(),
            "sax_unknown_element", new Object[]{qName}));
      }
    }
    ...
    {     
      if (_getLogger() != null)
      {
        UIMAFramework.getLogger(CLASS_NAME).logrb(
		   ...
		   "warning", 
		   LOG_RESOURCE_BUNDLE, 
		   "UIMA_factory_config_parse__WARNING",e.getLocalizedMessage());
      }
    }
