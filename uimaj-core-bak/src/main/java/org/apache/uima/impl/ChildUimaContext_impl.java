...
public class ChildUimaContext_impl extends UimaContext_ImplBase implements UimaContextAdmin
{
		...
		Map aSofaMappings)
	{
		...
		mSessionNamespaceView = new SessionNamespaceView_impl(
			mRootContext.getSession(), mQualifiedContextName);
   ...
   * <p>
	...
	{
		//must update root session first, in case it has been changed, for example by the deployment wrapper
