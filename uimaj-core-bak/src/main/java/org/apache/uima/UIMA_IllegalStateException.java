 ...
 * In other words, the object on which the method was called is not in an
 * appropriate state for the requested operation.  This extends 
 * <code>RuntimeException</code> and so does not need to be delcared in the 
...
/**
  ...
  */
  public UIMA_IllegalStateException(String aResourceBundleName,
  ...
  * "The UIMA framework implementation (class {0}) could not be created."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "The initialize(ResourceSpecifier) method on Resource {0} was 
  *  called more than once.  A Resource may only be initialized once."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "The XML parser was configured to instantiate class {0}, but that
  *  class is not able to be instantiated."
  */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "This ASB has not been provided with any Analysis Engines with
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "The method {0} must be called before the method {1}."
  */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * CasIterator.next was called when there were no more CASes remaining to be read.
   */ 
