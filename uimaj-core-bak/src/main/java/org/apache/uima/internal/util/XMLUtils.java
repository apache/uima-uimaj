...
public abstract class XMLUtils 
{
  ...
  /** 
   * Normalizes the given string for output to XML.  This converts all
   * special characters, e.g. &lt;, %gt;, &amp;, to their XML representations,
   * e.g. &amp;lt;, &amp;gt;, &amp;amp;.  The normalized string is appended to
   * the specified StringBuffer.
   * 
   * @param aStr input string
   * @param aResultBuf the StringBuffer to which the normalized string will
   *    be appended
   */
   ...
   * Normalizes the given string for output to XML.  This converts all
   * special characters, e.g. &lt;, %gt;, &amp;, to their XML representations,
   * e.g. &amp;lt;, &amp;gt;, &amp;amp;.  Also may convert newlines to spaces,
   * depending on the <code>aNewlinesToSpaces</code> parameter.  The normalized
   * string is appended to the specified StringBuffer.
   * 
   * @param aStr input string
   * @param aNewlinesToSpaces iff true, newlines (\r and \n) will be converted
   *    to spaces
   * @param aResultBuf the StringBuffer to which the normalized string will
   *    be appended
   */
  ...
  /** 
   * Normalizes the given string for output to XML, and writes the normalized
   * string to the given Writer.  Normalization converts all special characters,
   * e.g. &lt;, %gt;, &amp;, to their XML representations, e.g. &amp;lt;, 
   * &amp;gt;, &amp;amp;.  Also may convert newlines to spaces,
   * depending on the <code>aNewlinesToSpaces</code> parameter.
   * 
   * @param aStr input string
   * @param aWriter a Writer to which the normalized string will be written
   * @param aNewlinesToSpaces iff true, newlines (\r and \n) will be converted
   *    to spaces
   *
   * @throws IOException if an I/O failure occurs when writing to 
   *   <code>aWriter</code>
   */
  public static void writeNormalizedString(String aStr, Writer aWriter,
                                           boolean aNewlinesToSpaces)
    throws IOException
  {    
    if (aStr == null)
  ...
  /** 
   * Writes a standard XML representation of the specified Object, in the
   * form:<br>
   * <code>&lt;className&gt;string value%lt;/className%gt;</code>
   * <p>
   * where <code>className</code> is the object's java class name without the
   * package and made lowercase, e.g. "string","integer", "boolean" and 
   * <code>string value</code> is the result of <code>Object.toString()</code>.
   * <p>
   * This is intended to be used for Java Strings and wrappers for primitive
   * value classes (e.g. Integer, Boolean).
   * 
   * @param aObj the object to write
   * @param aWriter a Writer to which the XML will be written
   * 
   * @throws IOException if an I/O failure occurs when writing to 
   *   <code>aWriter</code>
   */
  public static void writePrimitiveValue(Object aObj, Writer aWriter)
    throws IOException
  {
   ...
   * 
   * @param aObj the object to write
   * @param aContentHandler the SAX ContentHandler to which events will be sent
   * 
   ...
   * 
   * @param aElem the parent element
   * @param aName tag name of the child to retrieve
   * 
   * @return the first child of <code>aElem</code> with tag name 
   *   <code>aName</code>, <code>null</code> if there is no such child.
   */
   ...
   * @param aElem the parent element
   * 
   * @return the first child of <code>aElem</code>, <code>null</code>
   ...
   * (This is the representation produced by {@link #writePrimitiveValue).
   * <p>
   * This is intended to be used for Java Strings and wrappers for primitive
   * value classes (e.g. Integer, Boolean).
   * 
   * @param aElem the element representing the value
   * 
   * @return the value that was read, <code>null</code> if a primitive value
   *   could not be constructed from the element
   */
  ...
  /** 
   * Gets the text of this Element.  Leading and trailing whitespace is 
   * removed.
   * 
   * @param aElem the element
   * 
  ...
  /** 
   * Gets the text of this Element.  Leading and trailing whitespace is 
   * removed.  Environment variable references of the form
   * &lt;envVarRef%gt;PARAM_NAME&lt;/envVarRef&gt; may be expanded.
   * 
   * @param aElem the element
   * @param aExpandVarRefs whether to expand environment variable references.
   *   Defaults to false.
   * 
   * @return the text of <code>aElem</code>
   */
