...
/**
 * Like {@link java.util.Vector java.util.Vector}, but elements are
 * <code>int</code>s. This is a bare-bones implementation. May add features
 * as I need them.
 * 
 * 
 * 
...
public class IntVector implements Serializable {
    ...
    /**
     * Construct an IntVector from an array. The array is not copied and may
    ...
    /**
     * Specify the initial capacity of this vector. Use to avoid internal
     * copying if you know ahead of time how large your vector is going to get
     * (at least).
     * 
     * @param capacity
    ...
    /**
     * Specify the initial capacity, growth factor and multiplication limit of
     * this vector. Use to avoid internal copying if you know ahead of time how
     * large your vector is going to get (at least).
     * 
     * @param capacity
     *            Initial capacity of vector.
     * @param growth_factor
    ...
    /**
     * Add an element at a certain position in the vector. Elements later in the
     * vector are shifted right by one. If the position is past the end of the
     * current vector, new <code>0</code>-valued elements are added.
     */
    public void add(int index, int element) {
        if (index >= this.pos) {
            ...
            System.arraycopy(this.array, index, this.array, index + 1, this.pos
                    - (index + 1));
        }
     ...
     * <code>IntVector</code> for equality. Two <code>IntVector</code>s are
     * equal if and only if the object passed in <code>o</code> is of type
     * <code>IntVector</code>, <code>this.size() == o.size()</code>, and
     * the <i>n</i>-th element in this <code>IntVector</code> is equal to the
     * <i>n</i>-th element in <code>o</code> for all <i>n</i> &lt;
     * <code>this.size()</code>.
     * 
     * @return <code>true</code> if the <code>IntVector</code>s are equal,
    ...
    /**
     * Tests if the specified <code>int</code> is a component of this
     * <code>IntVector</code>.
     * 
     * @return <code>true</code> if and only if the <code>int</code> is an
     *         element of this <code>IntVector</code>, <code>false</code>
     *         otherwise.
     */
    ...
    /**
     * Return the underlying int array, where the length of the returned array
     * is equal to the vector's size. This is not a copy!
     */
    public int[] toArray() {
        trimToSize();
        return this.array;
    ...
    /**
     * Returns the index of the first occurence of the element specified in this
     * vector.
     * 
     ...
     * You should only use this if you know that your vector will not grow
     * anymore.
     */
    ...
    public void ensure_size(int req) {
        this.array = IntArrayUtils.ensure_size(this.array, req,
                this.growth_factor, this.multiplication_limit);
        if (this.pos < req) {
            this.pos = req;
        }
    }
