...
public class StringUtils {
     ...
     *            Writer to print to.
     */
    public static final void printSpaces(int n, Writer writer)
            throws IOException {
        for (int i = 0; i < n; i++) {
            writer.write(" ");
        }
    ...
    public static final void write(Writer writer, String string)
            throws IOException {
        writer.write(string, 0, string.length());
    }

    /**
     * Converts occurance of patterns in a sourceString with provided
     * replacement String.
     * 
     * @param aSourceString -
     *            String to convert
     ...
     */
    public static String replaceAll(String aSourceString, String aPattern,
