...
public final class Timer {
    ...
    /**
     * Create a new timer. The new timer will NOT be started automatically. You
     * need to invoke {@link #start() start()} explicitly.
     */
    public Timer() {
        super();
        this.time = 0;
    ...
    /**
     * Get the currently accumulated time. This method may be called while the
     * timer is running, or after it has been stopped.
     * 
