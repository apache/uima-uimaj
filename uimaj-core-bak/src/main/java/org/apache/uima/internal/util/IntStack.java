...
/**
 * A stack of integers. Follows {@link java.util.Stack Stack} pretty closely,
 * except that push() returns the position of the added element in the stack.
 * Inherits from IntVector, so those methods are also available.
 */
public class IntStack extends IntVector {
    ...
    /**
     * Creates an empty stack with specified capacity, growth_factor and
    ...
    /**
     * Clears the stack. The amount of space reserved for this stack remains
     * unchanged.
     */
    public void clear() {
        this.pos = 0;
