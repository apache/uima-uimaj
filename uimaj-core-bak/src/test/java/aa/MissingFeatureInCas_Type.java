...
public class MissingFeatureInCas_Type extends TOP_Type {
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  		     ...
  		     return fs;
        } else return new MissingFeatureInCas(addr, MissingFeatureInCas_Type.this);
  	  }
    };
  /** @generated */
  ...
  public MissingFeatureInCas_Type(JCas jcas, Type casType) {
    ...
    casFeat_haveThisOne = jcas.getRequiredFeatureDE(casType, "haveThisOne", "uima.cas.Integer", featOkTst);
    casFeatCode_haveThisOne  = (null == casFeat_haveThisOne) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_haveThisOne).getCode();

 
    casFeat_missingThisOne = jcas.getRequiredFeatureDE(casType, "missingThisOne", "uima.cas.Float", featOkTst);
    casFeatCode_missingThisOne  = (null == casFeat_missingThisOne) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_missingThisOne).getCode();

 
    casFeat_changedFType = jcas.getRequiredFeatureDE(casType, "changedFType", "uima.cas.String", featOkTst);
    casFeatCode_changedFType  = (null == casFeat_changedFType) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_changedFType).getCode();
