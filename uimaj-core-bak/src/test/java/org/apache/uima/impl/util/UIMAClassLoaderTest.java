...
public class UIMAClassLoaderTest extends TestCase
{
  ...
  private String testClassPath;
	...
	public void testSimpleClassloadingSampleString() throws Exception
	{
		...
		testClass = cl.loadClass("org.apache.uima.impl.util.ClassloadingTestClass");	
				
		Assert.assertNotNull(testClass);
		Assert.assertEquals(cl,testClass.getClassLoader());
    
//	TODO: the below don't work if the test is run under a separate ClassLoader, as is done in Maven.	
//		testClass = cl.loadClass("org.apache.uima.impl.flow.capability_language.AnalysisSequenceCapabilityNode");	
//			
//		Assert.assertNotNull(testClass);
