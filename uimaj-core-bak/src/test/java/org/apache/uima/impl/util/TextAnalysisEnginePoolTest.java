...
package org.apache.uima.impl.util;
...
import org.apache.uima.impl.analysis_engine.ResultSpecification_impl;
import org.apache.uima.impl.analysis_engine.TaeDescription_impl;
import org.apache.uima.impl.analysis_engine.TestAnnotator;
...
public class TextAnalysisEnginePoolTest extends TestCase {
	 ...
	 * @param arg0
	 */
	public TextAnalysisEnginePoolTest(String arg0)
	...
	protected void setUp() throws Exception {
		try {
			...
			mSimpleDesc.setAnnotatorImplementationName(
				"org.apache.uima.impl.analysis_engine.TestAnnotator");
	...
	public void testProcess() throws Exception {
		try {
			...
			TextAnalysisEnginePool pool =
				new TextAnalysisEnginePool("taePool", 3, mSimpleDesc);
			...
			aggDesc.getDelegateAnalysisEngineSpecifiersWithImports().put(
				"Test",
				mSimpleDesc);
		...
		try {
			...
			primitiveDesc
				...
				.setParameterSettings(
					new NameValuePair[] {
						 new NameValuePair_impl("StringParam", "Test1")});

			//create pool  
			TextAnalysisEnginePool pool =
				new TextAnalysisEnginePool("taePool", 3, primitiveDesc);
	 ...
	 */
	protected void _testProcess(
		TextAnalysisEnginePool aPool,
		int i,
		boolean isAggregate)
