...
/**
 * Segmenter that requests three CASes in every next() method
 * but only asks for four in its getCasInstancesRequired() method.
 * It will run out on the second call.  For testing that we can
