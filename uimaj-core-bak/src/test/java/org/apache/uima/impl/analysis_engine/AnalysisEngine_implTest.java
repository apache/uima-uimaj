...
import org.apache.uima.impl.resource.metadata.FeatureDescription_impl;
...
//      e.printStackTrace();
  ...
  public void testCreateAnalysisProcessData() throws Exception
  {
    try
    {
      ...
      desc.setAnnotatorImplementationName("org.apache.uima.impl.analysis_engine.TestAnnotator");
