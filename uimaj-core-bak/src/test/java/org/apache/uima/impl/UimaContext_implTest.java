...
import org.apache.uima.impl.resource.ResourceCreationSpecifier_impl;
import org.apache.uima.impl.resource.TestResourceInterface;
import org.apache.uima.impl.resource.metadata.PropertyXmlInfo;
import org.apache.uima.impl.resource.metadata.ResourceMetaData_impl;
...
public class UimaContext_implTest extends TestCase
{
  ...
  public void testGetResourceURLString() throws Exception
  {
    try
    {
      ...
      URL url5 = mContext
          .getResourceURL("org/apache/uima/impl/analysis_engine/testDataFile3.dat");
  ...
  public void testGetResourceAsStreamString() throws Exception
  {
    try
    {
      ...
      InputStream strm4 = mContext
          .getResourceAsStream("org/apache/uima/impl/analysis_engine/testDataFile3.dat");
