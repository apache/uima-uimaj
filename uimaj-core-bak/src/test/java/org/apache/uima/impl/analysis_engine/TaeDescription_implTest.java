...
import org.apache.uima.impl.analysis_engine.metadata.FixedFlow_impl;
import org.apache.uima.impl.resource.URISpecifier_impl;
import org.apache.uima.impl.resource.metadata.AllowedValue_impl;
import org.apache.uima.impl.resource.metadata.Capability_impl;
import org.apache.uima.impl.resource.metadata.ConfigurationGroup_impl;
import org.apache.uima.impl.resource.metadata.ConfigurationParameter_impl;
import org.apache.uima.impl.resource.metadata.FsIndexDescription_impl;
import org.apache.uima.impl.resource.metadata.FsIndexKeyDescription_impl;
...
import org.apache.uima.impl.util.SerializationUtils;
...
public class TaeDescription_implTest extends TestCase
{
  ...
  protected void setUp() throws Exception
  {
    try
    {
        ...
        TypeDescription type1 = 
          typeSystem.addType("Fake","A Fake Type", "Annotation");
        FeatureDescription feature1 = 
        type1.addFeature(
          "TestFeature",
          "For Testing Only",
      ...
      primitiveDesc.setAnnotatorImplementationName(
        "org.apache.uima.examples.TestAnnotator");
        ...
        cfgGrp1.setConfigurationParameters(
          new ConfigurationParameter[]{cfgParam1, cfgParam2});
      ...
      cfgGrp2.setConfigurationParameters(
        new ConfigurationParameter[] { cfgParam3 });
      ...
      NameValuePair nvp2 =
        new NameValuePair_impl("param2", Integer.valueOf("42"));
      NameValuePair nvp3a =
        new NameValuePair_impl("param3", Float.valueOf("2.718281828459045"));
      NameValuePair nvp3b =
        new NameValuePair_impl("param3", Float.valueOf("3.1415927"));
      ConfigurationParameterSettings settings =
        md.getConfigurationParameterSettings();
      settings.getSettingsForGroups().put(
        "cfgGrp1",
        new NameValuePair[] { nvp1, nvp2 });
      settings.getSettingsForGroups().put(
        "cfgGrp2a",
        new NameValuePair[] { nvp3a });
      settings.getSettingsForGroups().put(
        "cfgGrp2b",
        new NameValuePair[] { nvp3b });
      ...
      resMgrCfg.setExternalResources(
          new ExternalResourceDescription[]{extRes});
			ExternalResourceBinding binding = 
					UIMAFramework.getResourceSpecifierFactory().createExternalResourceBinding();
      ...
      aggregateDesc.setResourceManagerConfiguration(resMgrCfg);
        ...
        //AnalysisSequencerCrea1tionSpecifier seqSpec = new AnalysisSequencerCreationSpecifier_impl();
      ...
      md.setCapabilities(
        primitiveDesc.getAnalysisEngineMetaData().getCapabilities());
  ...
  public void testXMLization() throws Exception
  {
    try
    {
      ...
      TaeDescription newPrimitiveDesc = 
      ...
      TaeDescription newAggregateDesc = 
          UIMAFramework.getXMLParser().parseTaeDescription(
              new XMLInputSource(is,null));
  ...
  public void testSerialization() throws Exception
  {
  	try
  	{
		  ...
		  TaeDescription_impl primitiveDesc2 = (TaeDescription_impl)SerializationUtils.deserialize(primitiveDescBytes);
		  Assert.assertEquals(primitiveDesc, primitiveDesc2);
	
			byte[] aggregateDescBytes = SerializationUtils.serialize(aggregateDesc);
			TaeDescription_impl aggregateDesc2 = (TaeDescription_impl)SerializationUtils.deserialize(aggregateDescBytes);
