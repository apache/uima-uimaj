...
public class ResultSpecification_implTest extends TestCase
{
  ...
  public void testAddCapabilities() throws Exception
  {
    try
    {
      ...
      ResultSpecification_impl resultSpecLanguage =
        new ResultSpecification_impl();
  ...
  public void testSetResultTypesAndFeaturesWithLanguage() 
    throws Exception
  {
    try
    {
      ResultSpecification_impl rs = new ResultSpecification_impl();
      rs.setResultTypesAndFeatures(
        mTypesAndFeatures,
  ...
  public void testAddResultTypeOrFeatureWithLanguage() throws Exception
  {
    try
    {
      ...
      for (int i = 0; i < mTypesAndFeatures.length; i++)
      {
        rs.addResultTypeOrFeature(
          mTypesAndFeatures[i],
          (String[]) languages.get(i));
      }
  ...
  public void testContainsFeatureWithLanguage() throws Exception
  {
    try
    {
      ...
      Assert.assertFalse(
        rs.containsFeature("FakeType:FakeFeature2", "x-unspecified"));
      Assert.assertTrue(rs.containsFeature("AnotherType:AnotherFeature", "en"));
      Assert.assertTrue(
        rs.containsFeature("AnotherType:YetAnotherFeature", "de"));
      Assert.assertFalse(
        rs.containsFeature("AnotherType1:YetAnotherFeature", "de"));
  ...
  public void testXmlization() throws Exception
  {
    try
    {
      ...
      ResultSpecification newRS =
        UIMAFramework.getXMLParser().parseResultSpecification(
