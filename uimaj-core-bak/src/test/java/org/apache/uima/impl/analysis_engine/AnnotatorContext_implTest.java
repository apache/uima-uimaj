...
import org.apache.uima.impl.resource.TestResourceInterface;
...
public class AnnotatorContext_implTest extends TestCase
{
  ...
  protected void setUp() throws Exception
  {
    try
    {
      ...
      XMLInputSource in2 = new XMLInputSource(
          JUnitExtension.getFile("AnnotatorContextTest/AggregateTaeWithConfigParamOverrides.xml"));
      AnalysisEngineDescription aggDesc =
        UIMAFramework.getXMLParser().parseTaeDescription(in2);
      AggregateAnalysisEngine_impl aggTae = new AggregateAnalysisEngine_impl();
      aggTae.initialize(aggDesc, map);
      //get the primitive TAE
      PrimitiveAnalysisEngine_impl primTae = (PrimitiveAnalysisEngine_impl)
        aggTae._getASB().getComponentAnalysisEngines().values().toArray()[0];
      //this should include an annotator context
      ...
      AnalysisEngineDescription resTestDesc =
        UIMAFramework.getXMLParser().parseTaeDescription(in3);
      ...
      XMLInputSource in4 = new XMLInputSource(
          JUnitExtension.getFile("AnnotatorContextTest/AnnotatorWithDefaultFallbackConfiguration.xml"));
      AnalysisEngineDescription desc4 =
        UIMAFramework.getXMLParser().parseTaeDescription(in4);
      ...
      mAC4 = new AnnotatorContext_impl(tae4.getUimaContextAdmin());
			...
			XMLInputSource in5 = new XMLInputSource(
					JUnitExtension.getFile("AnnotatorContextTest/AnnotatorWithConfigurationParameters.xml"));
			AnalysisEngineDescription desc5 =
				UIMAFramework.getXMLParser().parseTaeDescription(in5);
   ...
   */
  public void testGetConfigParameterValueString()
    throws Exception
  {
    try
    {
   ...
   */
  public void testGetConfigParameterValueStringString()
    throws Exception
  {
    try
    {
      ...
      String[] strArr4 = (String[])mAC2.getConfigParameterValue("x-unspecified","StringArrayParam");
  ...
  public void testGetResourceObjectString()
    throws Exception
  {
    try
    {
    ...
    throws Exception
  {
    try
    {
      ...
      URL url5 = mAC3.getResourceURL("org/apache/uima/impl/analysis_engine/testDataFile3.dat");
    ...
    throws Exception
  {
    try
    {
      ...
      //passthrough to class loader
      InputStream strm4 = mAC3.getResourceAsStream("org/apache/uima/impl/analysis_engine/testDataFile3.dat");
  ...
  public void testGetResourceObjectStringStringArray()
    throws Exception
  {
    try
    {
      //standard data resource
      Object r = mAC3.getResourceObject("TestFileLanguageResource",
          new String[]{"en"});
      Assert.assertNotNull(r);
      Assert.assertTrue(r instanceof DataResource);
      Object r2 = mAC3.getResourceObject("TestFileLanguageResource",
          new String[]{"de"});
      Assert.assertNotNull(r2);
      Assert.assertTrue(r2 instanceof DataResource);
      ...
      //custom object
      Object r3 = mAC3.getResourceObject("TestLanguageResourceObject",
          new String[]{"en"});
      Assert.assertNotNull(r3);
      Assert.assertTrue(r3 instanceof TestResourceInterface);    
      Object r4 = mAC3.getResourceObject("TestLanguageResourceObject",
          new String[]{"de"});
  ...
  public void testGetResourceAsStreamStringStringArray()
    throws Exception
  {
    try
    {
  ...
  public void testGetResourceURLStringStringArray()
    throws Exception
  {
    try
    {
      //standard data resource
      URL url = mAC3.getResourceURL("TestFileLanguageResource",
          new String[]{"en"});
      Assert.assertNotNull(url);
      
      URL url2 = mAC3.getResourceURL("TestFileLanguageResource",
          new String[]{"de"});
      Assert.assertNotNull(url2);
      Assert.assertFalse(url2.equals(url));
      
      //custom object (should return null)
      URL url3 = mAC3.getResourceURL("TestLanguageResourceObject",
          new String[]{"en"});
      Assert.assertNull(url3);
