...
public class TypeSystemTest extends TestCase {
    ...
    private class SetupTest implements AnnotatorInitializer {
        ...
        public void initTypeSystem(TypeSystemMgr tsm) {
            ...
            // type.
            assertTrue(tsm.getFeatureByFullName(annot2name
            ...
            assertTrue(tsm.getFeatureByFullName(annot2name
                    + TypeSystem.FEATURE_SEPARATOR + inhTestFeat) != null);
            ...
            // subtype.
            /*
             * Test commented out with defect 3351: it's ok to want to create
             * the same feature on a subtype. try { feat2 =
             * tsm.addFeature(featName, annot3, annot); } catch
             * (CASAdminException e) { assertTrue(false); } assertTrue(feat2 ==
             * null);
             */
            ...
            assertTrue(feat.getName().equals(
                    annot4Name + TypeSystem.FEATURE_SEPARATOR + featName));
    ...
    public void testGetFeatures() {
        ...
        String annotPrefix = TCAS.TYPE_NAME_ANNOTATION
                + TypeSystem.FEATURE_SEPARATOR;
        String arrayPrefix = CAS.TYPE_NAME_ARRAY_BASE
                + TypeSystem.FEATURE_SEPARATOR;
        assertTrue(arrayPrefix != null);
        String tokenPrefix = CASTestSetup.TOKEN_TYPE
                + TypeSystem.FEATURE_SEPARATOR;
    ...
    public void testGetDirectlySubsumedTypes() {
        List subTypes = this.ts.getDirectSubtypes(this.ts
                .getType(CAS.TYPE_NAME_TOP));
    ...
    public void testBuiltinTypes() {
        assertTrue(this.cas.getTypeSystem().getType(CAS.TYPE_NAME_FLOAT)
                .isInheritanceFinal());
        assertTrue(this.cas.getTypeSystem().getType(CAS.TYPE_NAME_FLOAT)
                .isFeatureFinal());
    ...
    public void testArrayTypes() {
        ...
        assertTrue(fsArrayType.equals(this.ts
                .getArrayType(this.ts.getTopType())));
        ...
        assertTrue(intArrayType.getComponentType().equals(
                this.ts.getType(CAS.TYPE_NAME_INTEGER)));
        assertTrue(intArrayType.equals(this.ts.getArrayType(this.ts
                .getType(CAS.TYPE_NAME_INTEGER))));
        ...
        Type annotationArray = this.ts.getArrayType(this.ts
                .getType(TCAS.TYPE_NAME_ANNOTATION));
