 ...
 * 
 * These tests set up various type priorities, and then
 * test that the total linear order gives the expected type order
 * 
 * Types:  For this tests, we use types whose names encode their position
 * in a type tree.
 * 
 * Encoding:  Each type name has a root based on a single letter, e.g. a, b, c
 *   name of type is its root preceeded by its ancestors to the top
 */
...
//	  	 System.out.println("added type " + roots[i] + "a and b");
    ...
    *                        aa                                              ab                        
    *           aaa                     aab                     aba                     abb           
    *    aaaa        aaab        aaba        aabb        aaba        aabb        aaba        aabb     
