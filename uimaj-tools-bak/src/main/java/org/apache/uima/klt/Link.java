...
public class Link extends TOP {
    protected static java.util.LinkedList getLinks(
        ...
        public static java.util.LinkedList getFromValues(
            FSList aLinks,
            Class aClass) {
            java.util.LinkedList retval = new java.util.LinkedList();
            if (aLinks != null)
        ...
        public static java.util.LinkedList getToValues(
            FSList aLinks,
            Class aClass) {
            java.util.LinkedList retval = new java.util.LinkedList();
            if (aLinks != null)
        ...
        public static Link addLink(
            ...
            try {
                ...
                java.lang.reflect.Constructor linkConstructor =
                    linkClass.getConstructor(new Class[] { JCas.class });
                newLink =
                    (Link) linkConstructor.newInstance(new Object[] { jcas });
            } catch (Exception e) {
            }
            if (newLink != null) {
         ...
         * @param obj The object containing the link
         * @param link The link
         */
  ...
  public TOP getFrom() {
    ...
    return (TOP)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Link_Type)jcasType).casFeatCode_from)));}
  ...
  public TOP getTo() {
    ...
    return (TOP)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Link_Type)jcasType).casFeatCode_to)));}
