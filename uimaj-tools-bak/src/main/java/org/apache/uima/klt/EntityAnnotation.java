...
public class EntityAnnotation extends Annotation {
    public String toString() {
        return "(ENTITY-ANN \"" + getCoveredText() + "\" " + getComponentId() + " " + getClass().getName() + ":" + getMentionType() + ")";
    }
  ...
  public FSList getLinks() {
    ...
    return (FSList)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((EntityAnnotation_Type)jcasType).casFeatCode_links)));}
  ...
  public void setLinks(FSList v) {
    if (EntityAnnotation_Type.featOkTst && ((EntityAnnotation_Type)jcasType).casFeat_links == null)
      JCas.throwFeatMissing("links", "org.apache.uima.klt.EntityAnnotation");
    jcasType.ll_cas.ll_setRefValue(addr, ((EntityAnnotation_Type)jcasType).casFeatCode_links, jcasType.ll_cas.ll_getFSRef(v));}    
  ...
  public String getComponentId() {
    if (EntityAnnotation_Type.featOkTst && ((EntityAnnotation_Type)jcasType).casFeat_componentId == null)
      JCas.throwFeatMissing("componentId", "org.apache.uima.klt.EntityAnnotation");
    return jcasType.ll_cas.ll_getStringValue(addr, ((EntityAnnotation_Type)jcasType).casFeatCode_componentId);}
  ...
  public void setComponentId(String v) {
    if (EntityAnnotation_Type.featOkTst && ((EntityAnnotation_Type)jcasType).casFeat_componentId == null)
      JCas.throwFeatMissing("componentId", "org.apache.uima.klt.EntityAnnotation");
    jcasType.ll_cas.ll_setStringValue(addr, ((EntityAnnotation_Type)jcasType).casFeatCode_componentId, v);}    
  ...
  public String getMentionType() {
    if (EntityAnnotation_Type.featOkTst && ((EntityAnnotation_Type)jcasType).casFeat_mentionType == null)
      JCas.throwFeatMissing("mentionType", "org.apache.uima.klt.EntityAnnotation");
    return jcasType.ll_cas.ll_getStringValue(addr, ((EntityAnnotation_Type)jcasType).casFeatCode_mentionType);}
  ...
  public void setMentionType(String v) {
    if (EntityAnnotation_Type.featOkTst && ((EntityAnnotation_Type)jcasType).casFeat_mentionType == null)
      JCas.throwFeatMissing("mentionType", "org.apache.uima.klt.EntityAnnotation");
    jcasType.ll_cas.ll_setStringValue(addr, ((EntityAnnotation_Type)jcasType).casFeatCode_mentionType, v);}    
  }
