 ...
 *
 * A specialist component used to create input forms
 * in a 2 or 4 column layout with right-aligned labels
 * on the left and corresponding component left-aligned
 * in the right column.
 * Components are arranged in the order that they are added.
 */
...
public class FormPanel extends JPanel
{
	...
	/**
		 * Given a configuration parameter name, this method returns
		 * a suitable field caption string.
		 * e.g. outputDir would return Output Dir:
