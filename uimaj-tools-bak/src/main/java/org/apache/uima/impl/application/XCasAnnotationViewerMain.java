...
package org.apache.uima.impl.application;
...
import org.apache.uima.impl.application.docanalyzer.PrefsMediator;
import org.apache.uima.impl.application.docanalyzer.XCasAnnotationViewerDialog;
...
/**
 * Main XCAS Annotation Viewer GUI.  Allows user to choose directory of XCAS or XMI
 * files, then launches the XCasAnnotationViewerDialog.
 * 
 * 
 */
public class XCasAnnotationViewerMain extends JFrame
{
    private static final String HELP_MESSAGE =
            "Instructions for using XCAS Annotation Viewer:\n\n" +
...
// Need to set other colors as well
	 ...
	 //create about dialog
	 aboutDialog =new SplashScreenDialog(
			 this,"About XCAS Annotation Viewer");
...
//    Set default values for input fields
    inputDir = new File(uimaHomeDir, "docs/examples/data/processed");
    ...
    taeDescriptorFileSelector = new FileSelector("",
                      "TAE Descriptor File",
                      JFileChooser.FILES_ONLY,
                      uimaHomeDir);

    File descriptorFile = new File(uimaHomeDir, "docs/examples/descriptors/analysis_engine/PersonTitleAnnotator.xml");
    ...
    throws InvalidXMLException, IOException, ResourceInitializationException
  {
    ...
    XCasAnnotationViewerDialog viewerDialog = 
      new XCasAnnotationViewerDialog(this, "Analyzed Documents",
          prefsMed, styleMapFile, null, tcas.getTypeSystem(),
          null, false, tcas);
    viewerDialog.pack();
  ...
  public void restorePreferences()
  {
    ...
    File defaultTaeDescriptorFile = new File(uimaHomeDir,"docs/examples/descriptors/analysis_engine/PersonTitleAnnotator.xml");
	...
	/**
	 ...
	 public void displayError(String aErrorString) {
		 ...
		 StringTokenizer tokenizer =
			 new StringTokenizer(aErrorString, " \n", true);
