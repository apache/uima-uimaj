...
public class StyleMapEntry
{
	...
	/**
	 * Label that identifies the type of annotation.  This will appear in
	 * the legend in the annotation viewer.
	 */
...
public void setChecked(Boolean chk) {
	...
	/**
	 * This method returns a pattern representing either simply
	 * an annotation type or else an annotation type/feature value.
	 * In the case of the latter:
	 * e.g. SYNTAX_ANNOT_TYPE[@SYNTAXLABEL_STRING='NP']
	 */
