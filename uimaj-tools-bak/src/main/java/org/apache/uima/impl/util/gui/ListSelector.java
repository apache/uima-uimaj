...
/**
 *
 * A composite component comprising a JList and associated controls
 * used to add and remove list elements and to control their ordering.
 */
public class ListSelector extends JPanel implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (source == removeButton)
		{
			...
			if (selectedValue != null)
			{
				int rv = JOptionPane.showConfirmDialog(
								(Component) source,
								"Are you sure you want to remove " + selectedValue,
								null,
			...
			else
			{
				JOptionPane.showMessageDialog(this,
											"You must first select an item to be removed",
											null,
		...
		else		// It's a move button
		{
			...
			{
				JOptionPane.showMessageDialog(this,
											"You must first select an item to reorder",
											null,
											JOptionPane.WARNING_MESSAGE);
			}
		}
