...
/*
 *
 *Manages the reading and storing of Preferences for the DocumentAnalyzer
 *Contains preference code so directory names can be known throughout the 
 *application.
 */
import java.io.File;
...
public class PrefsMediator {
     ...
     * In interactive mode, we append "/interactive_out" to the end,
     * but we don't want to save this in the preferences.  To support
     * that, this method takes one parameter which is the output dir to
     * be set and used by the application, and a second parameter to
     * set the directory that is saved to the preferences.
     * 
     * @param outputDir the output dir to set
     * @param outputDirToSave the output dir to save to the preferences
     */
    public void setOutputDirForInteractiveMode(String outputDir, 
