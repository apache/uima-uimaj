...
/**
 * A GUI that displays annotation results in a Swing tree viewer.  This
 * class extends {@link JPanel} and so can be reused within any Swing
 * application.
 * 
 */
public class CasTreeViewer extends JPanel
{
  ...
  * 
  * @param aTCAS the TCAS containing the annotations to be displayed in
  *    the tree viewer GUI
  */ 
          ...
          if (selPath != null)
          {
            ...
            if (userObj instanceof AnnotationTreeNodeObject)
            {
              AnnotationFS annotation = 
                ((AnnotationTreeNodeObject)userObj).getAnnotation();
 ...
 /**
  * Called when the user selects a new node in the JTree.  Refreshes the
  * right pane to display information about the selected annotation.
  * 
  * @param aAnnotation the annotation that was selected in the JTree
  */ 
  ...
  * 
  * @param aRootNode an existing root node for the tree
  * @param aCAS CAS from which annotations will be extracted
  */ 
  private TreeNode buildTree(CAS aCAS)
    throws CASException
  {
  ...
  * 
  * @param aParentNode root node of tree to be built
  * @param aIterator iterator over all annotation in CAS
  * @param aStartPos text position at which to begin processing
  * @param aEndPos text position at which to end processing
  */ 
  private void _buildTree(DefaultMutableTreeNode aParentNode, 
    FSIterator aIterator, int aStartPos, int aEndPos)
  {   
      ...
      if (curAnnotEnd <= aEndPos)
      {
        ...
        if (curAnnotStart < curAnnotEnd) //account for bug in JTalent
        {
          ...
          DefaultMutableTreeNode newNode = 
            new DefaultMutableTreeNode(new AnnotationTreeNodeObject(curAnnot));
 ...
 /**
  * Main program.  Runs a TAE and displays the resulting annotations in 
  * the tree viewer.
  *
  * @param args Command-line arguments - two are reguired:  the path to the
  *    TAE descriptor and a file to be analyzed.
  */ 
 ...
 /**
  * Gets text to be processed by the TAE.  If the document contains XML tags
  * named TEXT like this:
  * <code>&lt;TEXT%gt;Process this text.&lt;/TEXT%gt;</code>,
  * then only the text within those tags is returned.  Otherwise the whole
  * document is returned.
  * 
  * @param aFile file to process
  * @param aTAE Text Analysis Engine that will process the file
  */ 
