...
package org.apache.uima.impl.util.htmlview;
...
/**
 * Utility that uses XSL stylesheets to produce an HTML view (w/ Javascript)
...
public class AnnotationViewGenerator {
    ...
    /** XSL transform used to translate a style map XML file into the CSS stylesheet
     *  used in the annotation viewer. */
    private Templates mStyleMapToCss;

    /** XSL transform used to translate a style map XML file into the HTML legend used
     *  in the annotation viewer. */
    private Templates mStyleMapToLegend;

    /** XSL transform used to translate a style map XML file into ANOTHER XSL file,
     *  which can then be applied to an annotated document to produce the main
     *  document HTML view. */
     ...
     *
     * @param aOutputDir directory in which this program will write its output
     *    files.
     */
     ...
     * 
     * @param filename name of .xsl file, to be looked up in the classpath,
    ...
    {
      InputStream is = AnnotationViewGenerator.class
     ...
     * 
     * @param filename name of the file, to be looked up in the classpath,
     *    under the same package as this class.
     * @return outputDir directory of output file.  Output file will be named
     *    the same as the <code>filename</code> parameter.
     */
     ...
     * </UL>
     *
     * @param aInlineXmlDoc path to style map to be processed
     */
     ...
     * generated by a previous call to {@link processStyleMap(File)}.
     * Generates a file named docView.html, which represents the HTML view
     * of the annotated document.
     *
     * @param aInlineXmlDoc path to annotated document to be processed
     */
    public void processDocument(File aInlineXmlDoc)
            throws TransformerException {
        //Generate document view HTML from Inline XML
        Transformer docHtmlTransformer =
                mTFactory.newTransformer(
                        new StreamSource(new File(mOutputDir, "docFrame.xsl")));
     ...
     *
     * @param aTaeMetaData Metadata of the Text Analysis Engine whose outputs 
     *    will be viewed using the generated style map.
     *
    ...
    public static String autoGenerateStyleMap(AnalysisEngineMetaData aTaeMetaData)
    {
      ...
      final String[] STYLES = 
      {"color:black; background:lightblue;", "color:black; background:lightgreen;",
       "color:black; background:orange;", "color:black; background:yellow;",
       "color:black; background:pink;", "color:black; background:salmon;", 
       "color:black; background:cyan;", "color:black; background:violet;", 
       "color:black; background:tan;", "color:white; background:brown;", 
       "color:white; background:blue;", "color:white; background:green;", 
       "color:white; background:red;", "color:white; background:mediumpurple;"};   


        //get list of output types from TAE
        ArrayList outputTypes = new ArrayList();
        Capability[] capabilities =
                aTaeMetaData.getCapabilities();
    ...
    /**
     * Automatically generates a style map file for the given analysis 
     * engine.  The style map will be written to the file <code>aStyleMapFile</code>.
     *
     * @param aAE the Analysis Engine whose outputs will be viewed using
     *    the generated style map.
     * @param aStyleMapFile file to which autogenerated style map will be
     *    written
     */
     ...
     * metadata.  The style map will be written to the file <code>aStyleMapFile</code>.
     *
     *
     * @param aMetaData Metadata of the Analysis Engine whose outputs 
     *    will be viewed using the generated style map.
     * @param aStyleMapFile file to which autogenerated style map will be
     *    written
     */
