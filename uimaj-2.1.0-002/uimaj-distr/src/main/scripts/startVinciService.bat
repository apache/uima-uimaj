...
@set VNS_HOST=%~2
@:execute
"%JAVA_HOME%\bin\java" -cp "%UIMA_CLASSPATH%" "-Duima.datapath=%UIMA_DATAPATH%" -DVNS_HOST=%VNS_HOST% -DVNS_PORT=%VNS_PORT% "-Djava.util.logging.config.file=%UIMA_HOME%\config\Logger.properties" org.apache.uima.adapter.vinci.VinciAnalysisEngineService_impl %SERVICE%
@goto end
