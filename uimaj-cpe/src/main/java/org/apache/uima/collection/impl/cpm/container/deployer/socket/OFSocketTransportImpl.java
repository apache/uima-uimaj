...
public class OFSocketTransportImpl implements SocketTransport
{
	...
	/* (non-Javadoc)
	 * @see org.apache.uima.collection.impl.cpm.container.deployer.socket.SocketTransport#connect(java.net.URL, long)
	 */
	...
	/* (non-Javadoc)
	 * @see org.apache.uima.collection.impl.cpm.container.deployer.socket.SocketTransport#invoke(java.net.Socket, org.apache.uima.cas.CAS)
	 */
