...
public class DATACasUtils
{
	...
	public static boolean isValidType(String aKey, String[] typeList)
	{
		...
		{
			aKey = StringUtils.replaceAll(aKey,org.apache.uima.collection.impl.cpm.Constants.SHORT_DASH_TERM,
		...
		{
			aKey = StringUtils.replaceAll(aKey,org.apache.uima.collection.impl.cpm.Constants.SHORT_COLON_TERM,
