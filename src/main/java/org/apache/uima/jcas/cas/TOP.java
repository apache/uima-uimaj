 ...
 * super type of all feature structures. This type implements FeatureStructure
 * since subclasses of it are the FSs generated by this system.
 */
public class TOP extends FeatureStructureImpl {
	 ...
	 * add one more slot (the casImpl ref) to every instance.
	 */
	...
	protected TOP() {
		...
		throw new RuntimeException(
				"Internal Error: TOP() constructor should never be called.");
	}

	/**
	 * (Internal) make a new instance of TOP, linking it with a pre-existing Cas
	 * FeatureStructure object. Note: this function invoked via the generator in
	 * TOP_Type whenever the CAS needs to make a java instance
	 */
	...
	public TOP(JCas jcas) {
		...
		CAS cas = jcas.getCas();
		if (cas instanceof TCASImpl
				&& ((TCASImpl) cas).isAnnotationType(jcasType.casTypeCode)) {
  ...
  public void removeFromIndexes(JCas jcas) {
	...
	/*
	 * functions needed to to implement the FeatureStructure interface Note we
	 * don't simply implement this class as a subclass of FeatureStructureImpl
	...
	public boolean equals(Object o) {
		...
		if ((this.addr == fs.addr)
				&& (this.jcasType.casImpl == fs.jcasType.casImpl)) {
			return true;
		}
		return false;
	}
