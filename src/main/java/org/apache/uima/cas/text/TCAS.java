 ...
 * <p>
 * This interface exists only for backwards-compatiblity with UIMA SDK v1.x. New applications should
 * use the {@link CAS} or {@link JCAS} interface.
 * <p>
 * Historially, this interface contained convenience methods for text analysis. In v2.0, all methods
