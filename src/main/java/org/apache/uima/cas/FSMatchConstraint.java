 ...
 * These constraints are created as the result of combining primitive
 * constraints with a "path" that specifies how to find the value to 
 * test, starting with a feature structure instance, and specifying which
 * feature (or possibly a chain of features) to use as the value, 
 * using the {@link org.apache.uima.cas.ConstraintFactory#embedConstraint(FeaturePath, FSConstraint)}
 * method.  These constraints are also produced by "anding" and "oring" together
 * other instances of these constraints.
