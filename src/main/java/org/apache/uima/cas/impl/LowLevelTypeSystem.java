 ...
 * <p>
 * Use
 * {@link org.apache.uima.cas.impl.LowLevelCAS#ll_getTypeSystem() LowLevelCAS.ll_getTypeSystem()}
 * to access a low-level type system.
 * 
 */
public interface LowLevelTypeSystem {
     ...
     * @return The code for the type. A return value of <code>0</code> means
     *         that the a type of that name does not exist in the type system.
     */
     ...
     * @return The code for the feature. A return value of <code>0</code>
     *         means that the name does not represent a feature in the type
     *         system.
     */
     ...
     * @return A type object, or <code>null</code> if <code>typeCode</code>
     ...
     * @return A feature object, or <code>null</code> if
     *         <code>featureCode</code> is not a valid feature code.
     */
     ...
     * @param type1
     * @param type2
     * @return <code>true</code> iff <code>type1</code> subsumes
     *         <code>type2</code>.
     */
     ...
     * <li><code>TYPE_CLASS_FS</code> -- FS type, i.e., all other types,
     * including all user-defined types.</li>
     * </ul>
     * This method is on the CAS, not the type system, since the specific
     * properties of types are specific to the CAS. The type system does not
     * know, for example, that the CAS treats arrays specially.
     * 
     * @param typeCode
     *            The type code.
     * @return A type class for the type code. <code>TYPE_CLASS_INVALID</code>
     ...
     * @return <code>true</code> iff <code>type</code> is a subtype of
     *         String.
     */
     ...
     * @return <code>true</code> iff <code>typeCode</code> is the type code
     *         of a reference type.
     */
     ...
     * @param typeCode
     *            The type code to check.
     * @return <code>true</code> iff <code>typeCode</code> is an array type
     *         code.
     */
     ...
     * @param typeCode
     *            The type code to check.
     * @return <code>true</code> iff <code>typeCode</code> is a primitive
     *         type code.
     */
    boolean ll_isPrimitiveType(int typeCode);

    /**
     * Get the type code for the array type with <code>componentTypeCode</code>
     * as component type code.
     * 
     * @param componentTypeCode
     *            The type code of the component type.
     * @return The type code for the requested array type, or
     *         {@link #UNKNOWN_TYPE_CODE UNKNOWN_TYPE_CODE} if
     *         <code>componentTypeCode</code> is not a valid type code.
     */
     ...
     * @param typeCode
     *            Type code to check.
     * @return <code>true</code> iff <code>typeCode</code> is a valid type
     *         code.
     */
     ...
     * @return The type code for the component type, or
     *         {@link #UNKNOWN_TYPE_CODE UNKNOWN_TYPE_CODE} if
     *         <code>arrayTypeCode</code> is not valid or not an array type.
     */
