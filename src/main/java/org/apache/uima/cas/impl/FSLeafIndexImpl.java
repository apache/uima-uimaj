 ...
 * 
 */
public abstract class FSLeafIndexImpl implements IntComparator, FSIndex,
        FSIndexImpl {
    ...
    public abstract ComparableIntPointerIterator pointerIterator(
            IntComparator comp, 
  ...
  private static final int getKeyCode(Feature feat) {
    ...
    private final int getFeatureOffset(Feature feat) {
        return this.comparator.getLowLevelCAS().getFeatureOffset(
    ...
    public int compare(FeatureStructure fs1, FeatureStructure fs2) {
        return compare(((FeatureStructureImpl) fs1).getAddress(),
                ((FeatureStructureImpl) fs2).getAddress());
    }
    ...
    public FSIterator iterator(FeatureStructure fs) {
        return new FSIteratorWrapper(refIterator(((FeatureStructureImpl) fs)
                .getAddress()), this.lowLevelCAS);
    }
