 ...
 * This extends <code>RuntimeException</code> and so does not need to be 
 * delcared in the throws clause of methods.
 * 
 * 
 */
...
/**
  ...
  */
   ...
   * "Class {0} does not support method {1}."
   */
 ...
 /**
  * Message key for a standard UIMA exception message:
  * "Attribute {0} of class {1} is not modifiable."
  */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "This is a shared resource and cannot be reconfigured."
   */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * "The Flow class {0} does not support the production of new CASes in the middle of
   *  the flow and so cannot be deployed in an Aggregate AnalysisEngine that includes a 
   *  CAS Multiplier component."
   */
