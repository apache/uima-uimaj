...
public abstract class CasMultiplier_ImplBase extends AnalysisComponent_ImplBase
{
  ...
  /**
   * This method should be overriden by subclasses.  Inputs a CAS to the AnalysisComponent. 
   * The AnalysisComponent "owns" this CAS until such time as {@link #hasNext()} is
