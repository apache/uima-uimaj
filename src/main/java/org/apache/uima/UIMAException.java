 ...
 * <p>
 * <code>UIMAException</code> extends {@link InternationalizedException} 
 * for internationalization support.  Since UIMA Exceptions are 
 * internationalized, the thrower does not supply a hardcoded message.
 * Instead, the thrower specifies a key that identifies the message.  That key
 * is then looked up in a locale-specific
