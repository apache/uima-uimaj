...
/**
 * The CapabilityContainer maps the capabilites of an AnalysisEngine to hash maps for 
 * a quick search of supported ToFs or languages.
 * 
 */
public class CapabilityContainer
{
	 ...
	 * 
	 * @param capabilities Annotator capabilities
	 */
	 ...
	 * 
	 * @param capabilities Annotator capabilities
	 * @param input create input capability hash map
	 * @param output create output capability hash map
	 */
	...
	/**
	 * method hasOutputTypeOrFeature() returns true if the given tof is supported by this 
	 * annotator for the given language
	 * 
	 * @param tof ToF to search for
	 * @param language current document language
	 * @param fuzzySearch do loose search also (e.g. language: 'en-US' -> search for 'en-US' and 'en') 
	...
	/**
	 * method hasOutputTypeOrFeature() returns true if the given tof is supported for this 
	 * annotator
	 * 
	 * @param tof ToF to search for
	...
	/**
	 * method createToFCapabilities() create a HashMap which includes all ToFs with
	 * their assigned languages
	 *  
	 * @param outputCapabilities - true to create ouput capabilities, false to create input capabilities
	...
	/**
	 * method createLanguageCapabilities() create a HashMap which includes all languages
	 * supported by this annotator with their assigned ToFs
	 *  
	 * @param outputCapabilities - true to create ouput capabilities, false to create input capabilities
	 * @return HashMap - HashMap includes languages supported by this annotator with their assigned ToFs 
	 */
