...
/**
 * Thrown by the Index to indicate that a failure has occurred
 * during indexing.
 * 
 * 
 */
...
/**
  ...
  */
  public IndexingException(String aResourceBundleName,
  ...
  */
                        ...
                        Throwable aCause)
  {
	 ...
	 * The filter syntax {0} is not supported by this implementation.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid filter expression:  '{0}' cannot start a feature name.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid filter expression: Expected a string or number but found '{0}'.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid filter expression: Invalid escape sequence {0}.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid filter expression: Expected a digit or '.' but found {0}.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid filter expression: Expected a digit but found {0}.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid filter expression: Expected the end of the expression but found {0}.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid filter expression: Unterminated String: {0}.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid filter expression: Expected operator but found {0}.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid filter expression: The operator {0} cannot be applied to strings.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Feature {0} referenced in build item {1} is not known.
	 */
	...
	/**
	 * Message key for a standard UIMA exception message:
	 * Invalid attributes in build item {0}: The combination [{1}] is not allowed.
	 */
  ...
  /**
   * Message key for a standard UIMA exception message:
   * The semantic search index at "{0}" was built with a UIMA version prior to v2.0.  
