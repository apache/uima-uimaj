...
/**
 * Red-Black Tree node. Not for public use. Use the interface in RedBlackTree
 * instead. This should probably be an internal class to RedBlackTree, but it's
 * easier to read in a seperate file. See comments in RedBlackTree.
 * 
 */
class RBTNode {
     ...
     */
    private RBTNode(int key, boolean color, RBTNode parent, RBTNode left,
            RBTNode right, Object element) {
        this.key = key;
        this.color = color;
        this.parent = parent;
        this.left = left;
