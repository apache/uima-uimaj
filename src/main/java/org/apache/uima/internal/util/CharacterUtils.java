...
/**
 * Collection of utilities for character handling.  Contains utilities for
 * semi-automatically creating lexer rules.
 */
public class CharacterUtils {
    ...
    /**
     * Create a hex representation of the UTF-16 encoding of a Java char. This
     * is the representation that's understood by Java when reading source code.
     * 
     * @param c
     *            The char to be encoded.
     * @return String Hex representation of character. For example, the result
     *         of encoding <code>'A'</code> would be <code>"\u0041"</code>.
     */
    ...
    /**
     * Create a hex representation of the UTF-16 encoding of a Java char. This
     * is the representation that's understood by the JavaCC lexer.
     * 
     * @param c
     *            The char to be encoded.
     * @return String Hex representation of character. For example, the result
     *         of encoding <code>'A'</code> would be <code>"0x0041"</code>.
     */
    ...
    /**
     * Generate an ArrayList of CharRanges for what Java considers to be a
     * letter. I use this as input to Unicode agnostic lexers like ANTLR.
     * 
     * @return ArrayList A list of character ranges.
     */
    public static ArrayList getLetterRange() {
        int[] types = new int[] { Character.UPPERCASE_LETTER,
    ...
    /**
     * Generate an ArrayList of CharRanges for what Java considers to be a
     * digit. I use this as input to Unicode agnostic lexers like ANTLR.
     * 
     * @return ArrayList A list of character ranges.
     */
