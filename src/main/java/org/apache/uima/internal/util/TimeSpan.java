...
/**
 * Encode a span of time. The main purpose of this class is to provide a
 * printing utility for time spans. E.g., 1081 ms should be printed as 1.081 s,
 * 108101 ms should be printed as 1 min 48.101 s, etc.
 * <p>
 * 
 * Note that the largest value you can represent with this class is
 * 9223372036854775807 (<code>Long.MAX_VALUE</code>), or equivalently,
 * 292471208 yrs 247 days 7 hrs 12 min 55.807 sec. Overflow is not handled
 * gracefully by this class.
 * <p>
 * 
 * Also note that for the purposes of this class, a year has 365 days. I.e., a
 * year corresponds to <code>365 * 24 * 60 * 60 * 1000</code> ms.
 */
public class TimeSpan {
     ...
     *            The interval in ms. If <code>milliseconds
     &lt; 0</code>, an
     *            uninstantiated <code>TimeSpan</code> is created.
     */
    ...
    /**
     * @return <code>true</code>, if the object has been instantiated with a
     *         legal interval; <code>false</code>, else.
     */
     ...
     * @param years
     *            The number of years.
     * @return <code>false</code>, if <code>years &lt; 0</code>;
     *         <code>true</code>, else.
     */
     ...
     * @param days
     *            The number of days.
     * @return <code>false</code>, if <code>days &lt; 0</code>;
     *         <code>true</code>, else.
     */
     ...
     * @param hours
     *            The number of hours.
     * @return <code>false</code>, if <code>hours &lt; 0</code>;
     *         <code>true</code>, else.
     */
     ...
     * @return <code>false</code>, if <code>minutes &lt; 0</code>;
     *         <code>true</code>, else.
     */
     ...
     * @return <code>false</code>, if <code>seconds &lt; 0</code>;
     *         <code>true</code>, else.
     */
     ...
     * @return <code>false</code>, if <code>milliseconds &lt; 0</code>;
     *         <code>true</code>, else.
     */
     ...
     * 
     * @return The number of milliseconds, if known. <code>-1</code>, else
     *         (e.g., when the <code>TimeSpan</code> is not instantiated).
     */
     ...
     * 
     * @return <code>-1</code>, if this object is not instantiated; the year
     *         fraction, else.
     */
    public int getYears() {
        ensureFull();
     ...
     * 
     * @return <code>-1</code>, if this object is not instantiated; the day
     *         fraction, else.
     */
    public int getDays() {
        ensureFull();
     ...
     * 
     * @return <code>-1</code>, if this object is not instantiated; the hour
     *         fraction, else.
     */
    public int getHours() {
        ensureFull();
     ...
     * 
     * @return <code>-1</code>, if this object is not instantiated; the
     *         minute fraction, else.
     */
