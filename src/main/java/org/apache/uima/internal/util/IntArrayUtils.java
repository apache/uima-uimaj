...
public final class IntArrayUtils {
    ...
    public static final int[] ensure_size(int[] array, int req) {
        return ensure_size(array, req, default_growth_factor,
                default_multiplication_limit);
    }

    public static final int[] ensure_size(int[] array, int req,
            int growth_factor, int multiplication_limit) {
        if (array.length < req) {
            int new_array_size;
            if (array.length > 0) {
    ...
    public static final boolean[] ensure_size(boolean[] array, int req,
            int growth_factor, int multiplication_limit) {
        if (array.length < req) {
            int new_array_size;
            if (array.length > 0) {
    ...
    public static final char[] ensure_size(char[] array, int req,
            int growth_factor, int multiplication_limit) {
        if (array.length < req) {
            int new_array_size;
            if (array.length > 0) {
    ...
    /**
     * Binary search on a span of a sorted integer array. If array is not
     * sorted, results are unpredictable. If you want to search the whole array,
     * use the version in {@link java.util.Arrays java.util.Arrays} instead;
     ...
     * @return The position of <code>ele</code>, if found;
     *         <code>-insertPos-1</code>, if not. <code>insertPos</code> is
     *         the position where <code>ele</code> would be inserted. Note
     *         that the return value is <code>&gt;= start</code> iff
     *         <code>ele</code> was found; see
     *         {@link java.util.Arrays java.util.Arrays}.
     */
    public static final int binarySearch(int[] array, int ele, int start,
            int end) {
     ...
     * @param a
     *            The array.
     * @return The position (first occurence) where <code>x</code> was found;
