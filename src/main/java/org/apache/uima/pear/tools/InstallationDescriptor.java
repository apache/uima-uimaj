...
/**
 * The <code>InstallationDescriptor</code> class encapsulates all elements and 
 * parameters included in the XML Installation Descriptor file.
 * 
...
public class InstallationDescriptor implements Serializable {
	/**
	 * The <code>ActionInfo</code> class defines 'installation action' 
	 * attributes.
	 * 
	 * @author LK
	 */
	...
	/**
	 * The <code>ArgInfo</code> class defines attributes of a 
	...
	/**
	 * The <code>ServiceInfo</code> class defines attributes of a 'service' 
	 * component.
	 * 
	 * @author LK
	 */
	 ...
	 * <code>Properties</code> object. If the given object already contains a
	 * property with the given name, adds a new value to this property using
	 * PROPERTY_DELIMITER as the delimiter, unless the existing property value
	 * list already contains the given new value.
	 *  
	 * @param props The given <code>Properties</code> object to be modified.
	 * @param name The given property name.
	 * @param value The given new value of the property.
	 * @return The modified <code>Properties</code> object.
	 */
	protected static Properties addProperty( 
		...
		if( curValue == null ) // set new property value
			...
			StringTokenizer curValueList = 
				new StringTokenizer( curValue, PROPERTY_DELIMITER );
	 ...
	 * <code>Properties</code> object. If the given object contains one or more
	 * PROPERTY_DELIMITER separated values under the given property name, 
	 * removes the value that is equal to the specified value. If no values 
	 * remain under the given name, removes the property associated with the 
	 * specified name from the given object.
	 * 
	 * @param props The given <code>Properties</code> object to be modified.
	 * @param name The given property name.
	 * @param value The given new value of the property.
	 * @return The modified <code>Properties</code> object.
	 */
	protected static Properties deleteProperty( 
		Properties props, String name, String value ) {
		String curValue = props.getProperty( name );
		if( curValue != null ) {
	...
	/**
	 * Constructs a relative path of a given component object, based on its 
	 * absolute path.
	 * 
	 ...
	 */
	protected static String getRelativePathForComponentObject( 
			String absolutePath, ComponentInfo component ) {
	 ...
	 * 
	 * @param insdFile The given original InsD file.
	 */
	public InstallationDescriptor( File insdFile ) {
		_insdFile = insdFile;
	}
	/**
	 * Creates and adds a delegate component specification to the list (for 
	 * aggregate component).
	 * 
	 * @param id The given delegate component ID.
	 * @param name The given delegate component name.
	 */
	...
	/**
	 * Adds a specification defined by given name and value to the set of  
	 * Framework specifications. If the Framework specifications already 
	 * contain the given name, adds a new value using PROPERTY_DELIMITER as 
	 * the delimiter.
	 * 
	 * @param specName The given specification name.
	 * @param specValue The given specification value.
	 */
	public synchronized void addFrameworkSpec( 
		String specName, String specValue ) {
		addProperty( _frameworkSpecs, specName, specValue );
	}
	/**
	 * Adds a specified 'installation action' to the list.
	 * 
	 * @param action The specified 'installation action' object.
	 */
	...
	/**
	 * Adds a specification defined by given name and value to the set of OS 
	 * specifications. If the OS specifications already contain the given name, 
	 * adds a new value using PROPERTY_DELIMITER as the delimiter.
	 * 
	 * @param specName The given specification name.
	 * @param specValue The given specification value.
	 */
	...
	/**
	 * Adds a specification defined by given name and value to the set of 
	 * Toolkits specifications. If the Toolkits specifications already contain 
	 * the given name, adds a new value using PROPERTY_DELIMITER as the 
	 * delimiter.
	 * 
	 * @param specName The given specification name.
	 * @param specValue The given specification value.
	 */
	public synchronized void addToolkitsSpec( 
		String specName, String specValue ) {
	...
	/**
	 * Removes a specified delegate component associated with a given component
	 * ID.
	 * 
	 * @param id The given delegate component ID to be removed.
	 */
	public synchronized void deleteDelegateComponent( String id ) {
		_delegateComponents.remove( id );
	}
	/**
	 * Removes a specification defined by given name and value from the set of
	 * Framework specifications.
	 * 
	 * @param specName The given specification name.
	 * @param specValue The given specification value.
	 */
	public synchronized void deleteFrameworkSpec( 
		String specName, String specValue ) {
		deleteProperty( _frameworkSpecs, specName, specValue );
	}
	/**
	 * Removes all installation actions associated with a given action name
	 * (FIND_AND_REPLACE_PATH_ACT or SET_ENV_VARIABLE_ACT).
	 * 
	 ...
	 * @param specValue The given specification value.
	 */
	public synchronized void deleteOSSpec( 
		String specName, String specValue ) {
		deleteProperty( _osSpecs, specName, specValue );
	}
	/**
	 * Removes a specification defined by given name and value from the set of
	 * Toolkits specifications.
	 * 
	 * @param specName The given specification name.
	 * @param specValue The given specification value.
	 */
	public synchronized void deleteToolkitsSpec( 
		String specName, String specValue ) {
		deleteProperty( _toolkitsSpecs, specName, specValue );
	}
	/**
	 * @return The list of the <code>ComponentInfo</code> objects that
	 * encapsulate specifications of the registered delegate components (for 
	 * aggregate component).
	 */
	...
	/**
	 * @return The specifications of the UIMA framework - (key, value) pairs.
	 * Value may contain one string or a list of strings, separated by 
	 * PROPERTY_DELIMITER.
	 */
	...
	/**
	 * @return The list of the <code>ActionInfo</code> objects that encapsulate 
	 * specifications of all requested installation actions.
	 */
	public Collection getInstallationActions() {
		return _installationActions;
	}
	/**
	 * Returns the list of specified <code>ActionInfo</code> objects that have
	 * a given action name.
	 * 
	 * @param actionName The given action name.
	 * 
	 * @return The list of the <code>ActionInfo</code> objects that have the 
	 * given action name.
	 */
	...
	/**
	 * @return Absolute path to the specified CAS Consumer descriptor for 
	 * the main (submitted) component, or <code>null</code>, if the main 
	...
	/**
	 * Returns absolute or relative path to the specified CAS Consumer 
	 * descriptor for the main (submitted) component, or <code>null</code>, 
	 * if the main component was not specified. If the relative path is 
	 * requested, returns the path relative to the main component root dir.
	 * 
	 * @param relativePath If <code>true</code>, returns relative path, 
	 * otherwise returns absolute path.
	 * @return Absolute or relative path to the specified CAS Consumer 
	 * descriptor for the main (submitted) component, or <code>null</code>, 
	...
	/**
	 * @return Absolute path to the specified CAS Initializer descriptor for 
	 * the main (submitted) component, or <code>null</code> if the main 
	 * component was not specified.
	 */
	...
	/**
	 * Returns absolute or relative path to the specified CAS Initializer 
	 * descriptor for the main (submitted) component, or <code>null</code>, 
	 * if the main component was not specified. If the relative path is 
	 * requested, returns the path relative to the main component root dir.
	 * 
	 * @param relativePath If <code>true</code>, returns relative path, 
	 * otherwise returns absolute path.
	 * @return Absolute or relative path to the specified CAS Initializer 
	 * descriptor for the main (submitted) component, or <code>null</code>, 
	 * if the main component was not specified.
	 */
	...
	/**
	 * @return Absolute path to the specified Collection Iterator descriptor 
	 * for the main (submitted) component, or <code>null</code> if the main 
	 * component was not specified.
	 */
	...
	/**
	 * Returns absolute or relative path to the specified Collection Iterator 
	 * descriptor for the main (submitted) component, or <code>null</code>, 
	 * if the main component was not specified. If the relative path is 
	 * requested, returns the path relative to the main component root dir.
	 * 
	 * @param relativePath If <code>true</code>, returns relative path, 
	 * otherwise returns absolute path.
	 * @return Absolute or relative path to the specified Collection Iterator 
	 * descriptor for the main (submitted) component, or <code>null</code>, 
	 * if the main component was not specified.
	 */
	...
	/**
	 * @return The specified main component deployment type, or default 
	 * deployment type (<code>standard</code>), if no deployment type 
	 * specified.
	 */
	...
	/**
	 * @return Absolute path to the specified XML AE descriptor for the main 
	 * (submitted) component, or <code>null</code> if the main component was 
	 * not specified.
	 */
	...
	/**
	 * Returns absolute or relative path to the specified XML AE 
	 * descriptor for the main (submitted) component, or <code>null</code>, 
	 * if the main component was not specified. If the relative path is 
	 * requested, returns the path relative to the main component root dir.
	 * 
	 * @param relativePath If <code>true</code>, returns relative path, 
	 * otherwise returns absolute path.
	 * @return Absolute or relative path to the specified XML AE 
	 * descriptor for the main (submitted) component, or <code>null</code>, 
	 * if the main component was not specified.
	 */
	public synchronized String getMainComponentDesc( boolean relativePath ) {
		if( _mainComponent != null ) {
			if( _mainComponent.descFilePath != null && 
					_mainComponent.descFilePath.length() > 0 ) {
				if( _mainComponent.descFilePath.charAt( 0 ) == '$' ) {
					if( relativePath ) {
						int relPathIndex = 
							_mainComponent.descFilePath.indexOf( '/' ) + 1;
						return 
							_mainComponent.descFilePath.substring( relPathIndex );
					} else
	...
	/**
	 * @return The specified ID for the main (submitted) component, or 
	...
	/**
	 * @return The specified name for the main (submitted) component, or 
	 * <code>null</code> if the main component was not specified.
	 */
	...
	/**
	 * @param paramName The given network component parameter name.
	...
	public synchronized Properties getMainComponentNetworkParam( String paramName ) {
		return 
			(_mainComponent != null && _mainComponent.networkParams != null) ? 
				(Properties)_mainComponent.networkParams.get( paramName ) :
				null;
	}
	/**
	...
	public synchronized Set getMainComponentNetworkParamNames() {
		return 
		(_mainComponent != null && _mainComponent.networkParams != null) ? 
			_mainComponent.networkParams.keySet() : null;
	}
	/**
	 * @return The specified additional properties of the main (submitted) 
	...
	/**
	 * @return The specified root directory path for the main (submitted) 
	 * component, or <code>null</code> if the main component was not specified.
	 */
	...
	/**
	 * @return The specified attributes of the OS environment - (name, value) 
	 * pairs. Value may contain one string or a list of strings, separated
	 * by PROPERTY_DELIMITER.
	 */
	public Properties getOSSpecs() {
		return _osSpecs;
	}
	/**
	 * @return The specified attributes of the standard system toolkits - 
	 * (name, value) pairs. Value may contain one string or a list of strings, 
	 * separated by PROPERTY_DELIMITER.
	 */
	public Properties getToolkitsSpecs() {
		return _toolkitsSpecs;
	}
	/**
	 * Assignes a given installation descriptor file to this object. This
	 * method does not perform parsing of the file.
	 * 
	 * @param insdFile The given installation descriptor file.
	 */
	 ...
	 * 
	 * @param id The given delegate component ID.
	 * @param descFilePath The given descriptor file path.
	 */
	public synchronized void setDelegateComponentDesc( 
		String id, String descFilePath ) {
		String dlgId = id.trim();
		ComponentInfo dCompInfo = 
			(ComponentInfo)_delegateComponents.get( dlgId );
		if( dCompInfo != null ) {
			if( dCompInfo.rootDirPath == null ) // set relative path
				dCompInfo.descFilePath = 
					descFilePath.trim().replace( '\\', '/' );
			else {
				// substitute '$dlg_comp_id$root' macros 
				dCompInfo.descFilePath = InstallationProcessor.
					substituteCompIdRootInString( 
						dCompInfo.descFilePath, 
						dlgId, dCompInfo.rootDirPath );
			}
		}
	}
	/**
	 ...
	 * @param name The given delegate component name.
	 */
	public synchronized void setDelegateComponentName( 
	 ...
	 * @param propValue The given property value.
	 */
	public synchronized void setDelegateComponentProperty( String id,
	...
	/**
	 * Sets a given directory path as the root path for a given delegate
	 * component.
	 * 
	 * @param id The given delegate component ID.
	 * @param rootDirPath The given root directory path.
	 */
	public synchronized void setDelegateComponentRoot( 
		String id, String rootDirPath ) {
			String dlgId = id.trim();
			ComponentInfo dCompInfo = 
				(ComponentInfo)_delegateComponents.get( dlgId );
			if( dCompInfo != null ) {
				dCompInfo.rootDirPath = 
					rootDirPath.trim().replace( '\\', '/' );
			...
			while( list.hasNext() ) {
				...
				while( keys.hasMoreElements() ) {
					...
					if( key.equals( InstallationDescriptorHandler.FILE_TAG ) ||
						...
						value = InstallationProcessor.
							substituteCompIdRootInString( 
								value, dlgId, dCompInfo.rootDirPath );
	 ...
	 *  
	 * @param descFilePath The given CAS consumer descriptor file path.
	 */
		...
		if( _mainComponent != null ) {
			if( _mainComponent.rootDirPath == null ) // set relative path
				_mainComponent.casConsumerDescFilePath = 
					...
					_mainComponent.casConsumerDescFilePath = 
						InstallationProcessor.substituteMainRootInString( 
	 ...
	 * 
	 * @param descFilePath The given CAS initializer descriptor file path.
	 */
	 ...
	 * 
	 * @param descFilePath The given Collection iterator descriptor file path.
	 */
	...
	/**
	 * Sets a given main component using a given component ID. This method 
	 * creates a new main component instance, overriding all previously set 
	 * attributes of the main component.
	 * 
	 * @param id The given main component ID.
	 */
	public synchronized void setMainComponent( String id ) {
		setMainComponent( id, "" );
	}
	/**
	 * Sets a given main component using given component ID and name. This 
	 * method creates a new main component instance, overriding all previously 
	 * set attributes of the main component.
	 * 
	 * @param id The given main component ID.
	 * @param name The given main component name.
	 */
	...
	/**
	 * Sets a given main component deployment type: <code>standard</code>, 
	 * <code>service</code> or <code>network</code>.
	 * 
	 * @param deplType The specified deployment type.
	 */
	public synchronized void setMainComponentDeployment( 
			String deplType ) {
		if( _mainComponent != null )
	 ...
	 * 
	 * @param descFilePath The given main component descriptor file path.
	 */
	 ...
	 * 
	 * @param id The given new ID of the main component.
	 */
	 ...
	 * 
	 * @param paramName The given network component parameter name.
	 * @param paramSpecs The specifications of the given network component 
	 * parameter.
	 */
	public synchronized void setMainComponentNetworkParam( String paramName, 
	 ...
	 * 
	 * @param propNname The given property name.
	 * @param propValue The given property value.
	 */
	public synchronized void setMainComponentProperty( 
		String propNname, String propValue ) {
		if( _mainComponent != null ) {
	 ...
	 * 
	 * @param rootDirPath The given main component root directory path.
	 */
	...
	/**
	 * Sets a given main component service specifications. The service 
	 * specifications are valid only for <code>service</code> deployment type.
	 * 
	 * @param serviceInfo The given main component service specifications.
	 */
	public synchronized void setMainComponentService( 
