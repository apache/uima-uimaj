...
public final class TTTypeSystemConsts {
    ...
    private static final String[] POS_CONSTS = { "UnspecifiedPOS", "Pronoun",
            "Verb", "Noun", "Adjective", "Adverb", "Preposition",
            "Interjection", "Conjunction", "MasculinNoun", "FemininNoun",
            "VerbPronominal", "TransitiveVerb", "IntransitiveVerb",
            "PluralNoun", "NeuterNoun" };
