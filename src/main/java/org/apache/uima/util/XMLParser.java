...
/**
 * A UIMA <code>XMLParser</code> parses XML documents and generates 
 * UIMA components represented by the XML.
 * <p>
 * An application obtains a reference to the <code>XMLParser</code> by calling
 * the {@link org.apache.uima.UIMAFramework#getXMLParser()} method.  The
 * application then uses the <code>XMLParser</code> by passing an 
 * <code>InputStream</code> to one of its <code>parse</code> methods - for
 * example {@link #parseAnalysisEngineDescription(XMLInputSource)} for parsing an 
 * {@link AnalysisEngineDescription} from its XML representation.
 * <p>
 * XML schema validation is off by default; it can be turned on by calling
 * the method {@link #enableSchemaValidation(boolean)}.  
 * <p>
 * UIMA developers who provide new types of XMLizable components must configure
 * the XML parser by using the {@link #addMapping(String,String)} method to 
 * specify mappings between XML Element names and the class names of the objects
 * to be built from elements with those names.  All objects to be built by
 * the XML parser must implement {@link XMLizable} and provide an implementation
 * of {@link XMLizable#buildFromXMLElement(Element,XmlParserBak)}.
 * <p>
 * Note that we are considering replacing this ad-hoc XML data binding 
 * interface with the java standard extension JAXB.  See 
...
public interface XMLParser
{
   ...
   * 
   * @param aEnable true to enable validation, false to disable validation
   */
   ...
   *    against XML schema.  If null, no schema will be used (unless one is 
   *    declared in the document itself).  This parameter is ignored if
   *    schema validation has not been enabled via 
   *    {@link #enableSchemaValidation(boolean)}.
   * @param aSchemaUrl URL to XML schema that will be used to validate the
   *    XML document.  If null, no schema will be used (unless one is declared
   *    in the document itself).  This parameter is ignored if
   *    schema validation has not been enabled via 
   *    {@link #enableSchemaValidation(boolean)}.  
  ...
  /**
   * Parses an XML input stream and produces an object.  This method will
   * expand XInclude (<code>xi:include</code>) elements. 
   *  
   * @param aInput the input source from which to read the XML document
   * @param aNamespaceForSchema XML namespace for elements to be validated 
   *    against XML schema.  If null, no schema will be used (unless one is 
  ...
  /**
   * Parses an XML input stream and produces an object.  XIncludes will be
   * expanded but no schema validation will be done.
   * 
   * @param aInput the input source from which to read the XML document
   * 
   * @return an <code>XMLizable</code> object constructed from the XML document
   ...
   * @param aInput the input source from which to read the XML document
	 * @param aOptions option settings
   * 
   * @return an <code>AnalysisEngineDescription</code> object constructed from 
   *    the XML document
   * 
   * @throws InvalidXMLException if the input XML is not valid or does not
   ...
   *    
   * @deprecated As of v2.0, {@link #parseAnalysisEngineDescription(XMLInputSource)}
   ...
   * @param aInput the input source from which to read the XML document
   * 
   * @return a <code>CasConsumerDescription</code> object constructed from the XML 
   *    document
   * 
   * @throws InvalidXMLException if the input XML is not valid or does not
   *    specify a valid CasConsumerDescription
   */
  public CasConsumerDescription parseCasConsumerDescription(XMLInputSource aInput)
	 ...
	 * @param aInput the input source from which to read the XML document
	 * 
	 * @return a <code>CasInitializerDescription</code> object constructed from the XML 
	 *    document
	 * 
	 * @throws InvalidXMLException if the input XML is not valid or does not
	 *    specify a valid CasInitializerDescription
	 */
  ...
  /**
	 ...
	 * @param aInput the input source from which to read the XML document
	 * 
	 * @return a <code>CollectionReaderDescription</code> object constructed from the XML 
	 *    document
	 * 
	 * @throws InvalidXMLException if the input XML is not valid or does not
	 *    specify a valid CollectionReaderDescription
	 */
	 ...
	 * <p>
	 * NOTE: the option settings {@link ParsingOptions} are not currently
	 * available for parsing CpeDescriptions, because they use a different
	 * parsing mechanism than the other specifier types.
	 * 
	 * @param aInput the input source from which to read the XML document
	 * 
	 * @return a <code>cpeDescription</code> object constructed from the 
	 *    XML document
	 * 
	 * @throws InvalidXMLException if the input XML is not valid or does not
	 *    specify a valid IndexingSpecification
	 */
   ...
   * @param aInput the input source from which to read the XML document
   * 
   * @return a <code>ResultSpecification</code> object constructed from the XML 
   *    document
   * 
   * @throws InvalidXMLException if the input XML is not valid or does not
   *    specify a valid ResultSpecification
   */
  public ResultSpecification parseResultSpecification(XMLInputSource aInput)
	 ...
	 * @param aInput the input source from which to read the XML document
	 * 
	 * @return a <code>TypeSystemDescription</code> object constructed from the XML 
	 *    document
	 * 
	 * @throws InvalidXMLException if the input XML is not valid or does not
	 *    specify a valid TypeSystemDescription
	 */
	 ...
	 * @param aInput the input source from which to read the XML document
	 * 
	 * @return a <code>TypePriorities</code> object constructed from the XML 
	 *    document
	 * 
	 * @throws InvalidXMLException if the input XML is not valid or does not
	 *    specify a valid TypePriorities
	 */
	 ...
	 * @param aInput the input source from which to read the XML document
	 * 
	 * @return a <code>FsIndexCollection</code> object constructed from the XML 
	 *    document
	 * 
	 * @throws InvalidXMLException if the input XML is not valid or does not
	 *    specify a valid FsIndexCollection
	 */
	 ...
	 * @param aInput the input source from which to read the XML document
	 * 
	 * @return a <code>ResourceManagerConfiguration</code> object constructed from the XML 
	 *    document
	 * 
	 * @throws InvalidXMLException if the input XML is not valid or does not
	 *    specify a valid ResourceManagerConfiguration
	 */
	...
	/**
		...
		* @param aInput the input source from which to read the XML document
		* 
		* @return an <code>IndexBuildSpecification</code> object constructed from the 
		*    XML document
		* 
		* @throws InvalidXMLException if the input XML is not valid or does not
		*    specify a valid IndexBuildSpecification
		*/
 ...
 /**
   * Builds an object from its XML DOM representation.  This method is not
   * typically called by applications.  It may be called from within
   * a {@link XMLizable#buildFromXMLElement(Element,XmlParserBak)} method to
   ...
   * 
   * @throws InvalidXMLException if the XML element does not specify a valid
   *    object
   */
   ...
   * Builds an object from its XML DOM representation.  This method is not
   * typically called by applications.  It may be called from within
   * a {@link XMLizable#buildFromXMLElement(Element,XmlParser)} method to
   * construct sub-objects.
   * <p>
   * This method is similar to {@link #buildObject(Element, XMLParser.ParsingOptions)}
   * but can also parse primitive-typed objects wrapped as XML elements, such as
   * <code>&lt;integer>42&lt;/integer</code>.
   * 
   * @param aElement a DOM Element
   * @param aOptions option settings
   * 
   * @return an object constructed from the DOM element.  This can be either an instance
   *   of {@link Xmlizable}, {@link String}, or one of the primitive type wrapper objects
   *   (e.g. {@link Integer}, {@link Float}, {@link Boolean}).
   * 
   * @throws InvalidXMLException if the XML element does not specify a valid
   *    object
   */
  ...
  /**
   * Creates a new <code>SaxDeserializer</code> object, which implements the
   * SAX {@link org.xml.sax.ContentHandler} interface and can be used to
   * deserialize an {@link XMLizable} object from the events sent from a SAX
   * parser.  This can be used if the application already has a SAX parser
   * that generates these events.  In most cases, it is easier to  
   * use one of the <code>parse</code> methods on this interface.
   * <p>
   * The SAX deserializer returned my this method will expand XIncludes but
   * will not do schema validation.
   * 
   * @return an object that implements {@link org.xml.sax.ContentHandler} and
   *   can be used to deserialize an {@link XMLizable} object from SAX events.
   * 
   * @throws InvalidXMLException if the XML element does not specify a valid
   *    object
   */
  ...
  public SaxDeserializer newSaxDeserializer(String aNamespaceForSchema, 
	 ...
	 */
	public SaxDeserializer newSaxDeserializer(String aNamespaceForSchema, 
			URL aSchemaUrl, ParsingOptions aOptions);
  ...
  /**
   * XML namespace for ResourceSpecifiers.  XML ResourceSpecifier documents
   * must use this namespace or they will be considered invalid by the
   * schema validator.
   */
   ...
   * the classpath.
   */
  public static final String RESOURCE_SPECIFIER_SCHEMA_NAME = 
  ...
  public static class ParsingOptions
  {
  	 ...
  	 */
		...
		/** 
		 * Whether to expand &lt;envVarRef&gt;VARNAME&lt;/envVarRef&gt; elements by substituting 
		 * the value of the System proprery VARNAME.
		 */
  	 ...
  	 * 
  	 * @param aExpandXIncludes  Whether to expand &lt;xi:include&gt; elements according to the 
  	 *     XInclude spec.
  	 * @param aExpandEnvVarRefs  Whether to expand &lt;envVarRef&gt;VARNAME&lt;/envVarRef&gt; 
  	 *     elements by substituting the value of the System proprery VARNAME.
  	 */
