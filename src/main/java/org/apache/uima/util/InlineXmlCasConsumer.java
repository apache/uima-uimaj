 ...
 *   <li><code>OutputFilter</code> (optional) - an FSMatchConstraint which
 *       annotations must match in order to be included in the output.  If
...
public class InlineXmlCasConsumer extends CasConsumer_ImplBase 
{
	 ...
	 * output file .
	 * 
	 * @param aCAS a CAS which has been populated by the Analysis Engines
	 * 
