 ...
 * It provides the means of configuring behavior that is common to all CasProcessor
 * types. 
 * 
 * 
 * 
...
public interface CpeCasProcessor extends MetaDataObject
{
	...
	public void setSOFA( String aSOFA )
		throws CpeDescriptorException;
...
//	public CpeComponentDescriptor  getCpeComponentDescriptor();
	 ...
	 * Sets CasProcessor filter expression used by the CPE to route CASs.
 	 ...
 	 * not supported.	 
 	 * @param aFilterExpression - filter
	 * @throws CpeDescriptorException
	 */
	 ...
	 *  
	 * @param aBatchSize - size of CasProcessor batch
	 */
	...
	/**
	 * Returns {@link org.apache.uima.collection.metadata.CasProcessorErrorHandling} object 
	 * containing strategies to deal with errors that may occur during processing. This object
	 * provides the means of modifying error thresholds and actions to take when error thresholds
	 * are exceeded.
	 *   
	...
	/**
	 * Returns {@link org.apache.uima.collection.metadata.CpeCheckpoint} object containing
	 * checkpoint configuration ( checkpoint file, frequency of checkpoints )
	 * 
	 * @return {@link org.apache.uima.collection.metadata.CasProcessorErrorHandling}
	 */
	 ...
	 * containing deployment parameters used for launching CasProcessor. This object provides
	 * the means of adding, getting, and removing  {@link org.apache.uima.collection.metadata.CasProcessorDeploymentParam}
	 * objects.
	 * 
	 * @return - object containing list of {@link org.apache.uima.collection.metadata.CasProcessorDeploymentParam} 
	 */
	public CasProcessorDeploymentParams getDeploymentParams(  );
	/**
	 * Sets the max number of errors tolerated by the CPE. If the the threshold is exceeded
	 * the CPE will take an action based on defined strategy. Max Error is defined in terms
	 * of a quotient, like 3/1000. Where 3 is the actual max error tolerance and 1000 is a 
	 * sample size. So the above is interpreted as 3 errors per thousand entities processed. 
	 * 
	 * @param aErrorCount - max error threshold
	 */
	public void setMaxErrorCount(int aErrorCount);
	/**
	 * Returns the max number of errors tolerated by the CPE. If the the threshold is exceeded
	 * the CPE will take an action based on defined strategy. Max Error is defined in terms
	 * of a quotient, like 3/1000. Where 3 is the actual max error tolerance and 1000 is a 
	 * sample size. So the above is interpreted as 3 errors per thousand entities processed.
	 * 
	...
	/**
	 * Sets the sample size. Max Error is defined in terms
	 * of a quotient, like 3/1000. Where 3 is the actual max error tolerance and 1000 is a 
	 * sample size. So the above is interpreted as 3 errors per thousand entities processed.
	 * 
	...
	/**
	 * Returns sample size. Max Error is defined in terms
	 * of a quotient, like 3/1000. Where 3 is the actual max error tolerance and 1000 is a 
	 * sample size. So the above is interpreted as 3 errors per thousand entities processed.
	 * 
	 * @return - sample size
	...
	/**
	 * Sets a strategy for dealing with exceeding error thresholds. The three supported 
	 * strategies are:
	 * <ul>
	...
	/**
	 * Returns strategy for dealing with exceeding error thresholds. The three supported 
	 * strategies are:
	 * <ul>
	 * <li> terminate - termines the CPE
	 * <li> continue - continue despite the error
	 ...
	 * 
	 * @param aErrorCount - max restart count
	 */
	...
	/**
	 * Sets strategy for dealing with exceeding error thresholds. The three supported 
	 * strategies are:
	 * <ul>
	 * <li> terminate - termines the CPE
	 * <li> continue - continue despite the error
	 ...
	 *  
	 * @param aTimeoutValue - timeout value
	 */
	 ...
	 * @param aParamValue - param value
	 * @throws CpeDescriptorException
	 */
	public void addDeployParam(String aParamName, String aParamValue )
	throws CpeDescriptorException;
    
    /**
     * Returns {@link org.apache.uima.collection.metadata.CasProcessorConfigurationParameterSettings} object
     * containing overrides to parameter settings for this CAS Processor.
     * 
