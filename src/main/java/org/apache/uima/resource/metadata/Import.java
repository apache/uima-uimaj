 ...
 * priorities.  Imports may be by location (relative URL) or name (a Java-style compound name, 
...
public interface Import extends MetaDataObject
{
	 ...
	 * 
	 * @return a Java-style compound name which specifies the target of this import.
	 ...
	 * 
	 * @param aName a Java-style compound name which specifies the target of this import.
	 *   This will be located by appending ".xml" to the name and searching the classpath.	 
	 */ 
  ...
  /**
   * Computes the absolute URL for this import, using the relative location
   * or name, whichever is specified by this import object.
   * 
   * @param aResourceManager resource manager to use to do name lookups
   * 
