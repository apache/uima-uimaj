 ...
 * 
 * As with all {@link MetaDataObject}s, a <code>ResourceMetaData</code>
...
public interface ResourceMetaData extends MetaDataObject 
{
   ...
   * 
   * @param aUUID the UUID for this Resource
   * 
   ...
   * 
   * @param aName the name of this Resource
   * 
   * @throws UIMA_UnsupportedOperationException if this object is not modifiable
   */
   ...
   * 
   * @param aVersion the version number of this Resource, as a String
   * 
   * @throws UIMA_UnsupportedOperationException if this object is not modifiable
   */
   ...
   * 
   * @param aDescription the description of this Resource
   * 
   * @throws UIMA_UnsupportedOperationException if this object is not modifiable
   */
   ...
   * 
   * @param aVendor the vendor of this Resource, as a String
   * 
   * @throws UIMA_UnsupportedOperationException if this object is not modifiable
   */
   ...
   * 
   * @param aCopyright the copyright notice for this Resource
   * 
   * @throws UIMA_UnsupportedOperationException if this object is not modifiable
   */ 
   ...
   * Gets the configuration parameter declarations for this Resource.  
   * 
   * @param aDeclarations an object containig the configuration parameter 
   *   declarations
   */
   ...
   * 
   * @return an object containing the settings for thie Resource's configuration
   *    parameters.
   */
   ...
   * 
   * @param aSettings an object containing the settings for this Resource's
  ...
  public void validateConfigurationParameterSettings()
	...
	/**
	 * Resolves any import declarations throughout this metadata.  This base
	 * interface cannot contain any interfaces, but subinterfaces may
	 * introduce new properties that can have imports that need to be resolved.
	 * 
