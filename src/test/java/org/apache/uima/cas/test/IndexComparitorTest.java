  ...
  private class SetupForIndexCompareTesting implements AnnotatorInitializer {
      ...
      type1Sub2Ignored = tsm.addFeature("ignored", type1Sub2, integerType);      
		...
		public void initIndexes(FSIndexRepositoryMgr irm, TypeSystem ts) {
			...
			irm.createIndex(newComparatorTypePriority(type1), "SortedType1TypeOrder", FSIndex.SORTED_INDEX);
			...
			irm.createIndex(newComparatorTypePriority(type1Sub1), "SortedType1Sub1TypeOrder", FSIndex.SORTED_INDEX);
			irm.createIndex(newComparatorTypePriority(type1Sub1), "SetType1Sub1TypeOrder", FSIndex.SET_INDEX);
			irm.createIndex(newComparatorTypePriority(type1Sub1), "BagType1Sub1TypeOrder", FSIndex.BAG_INDEX);
