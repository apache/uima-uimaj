...
public class CASTestSetup extends TestCase implements AnnotatorInitializer {
  ...
  public void initTypeSystem(TypeSystemMgr tsm) {
    ...
    /* String subtypes cannot be inherited from.
     * String subtypes can't have features added - they're
  ...
  public void testNothing() {}  // to avoid junit warning about no tests found
}
