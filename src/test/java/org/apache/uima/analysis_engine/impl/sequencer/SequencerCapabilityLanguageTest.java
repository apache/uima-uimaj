...
public class SequencerCapabilityLanguageTest extends TestCase
{
	...
	public void testSequencerCapabilityLanguageEsEn() throws Exception
	{
		...
		try 
		{
			...
			outputReferenceFile.deleteOnExit(); //delete file after closing VM
  			...
  			XMLInputSource in = new XMLInputSource(junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageAggregateES.xml");
  			// Parse the specifier.
  			...
  			tae.process(cas);
   			//check fileoutput
  			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedEsEn.txt"));
	...
	public void testSequencerCapabilityLanguageEsEnResultSpec() throws Exception
	{
		...
		try 
		{
			...
			cas.setDocumentLanguage("en");
			// Process the sample document.
			ResultSpecification resultSpec = UIMAFramework.getResourceSpecifierFactory().createResultSpecification();
			resultSpec.addCapabilities(tae.getAnalysisEngineMetaData().getCapabilities());
			tae.process(cas,resultSpec);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedEsEnResultSpec.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
	...
	public void testSequencerCapabilityLanguageEsAr() throws Exception
	{
		...
		try 
		{
			...
			tae.process(cas);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedEsAr.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
	...
	public void testSequencerCapabilityLanguageEsUnkown() throws Exception
	{
		...
		try 
		{
			...
			tae.process(cas);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedEsUnknown.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
	...
	public void testSequencerCapabilityLanguageEsZhCN() throws Exception
	{
		...
		try 
		{
			...
			tae.process(cas);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedEsZhCN.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
	...
	public void testSequencerCapabilityLanguageEsZhCNResultSpec() throws Exception
	{
		...
		try 
		{
			...
			tae.process(cas,resultSpec);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedEsZhCNResultSpec.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
	...
	public void testSequencerCapabilityLanguageEn() throws Exception
	{
		...
		try 
		{
			...
			// Create an XML input source from the specifier file.
			XMLInputSource in = new XMLInputSource(junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageAggregate.xml");
			// Parse the specifier.
			ResourceSpecifier specifier = UIMAFramework.getXMLParser().parseResourceSpecifier(in);
			// Create the Text Analysis Engine.
			tae = UIMAFramework.produceTAE(specifier, null, null);
			...
			tae.process(cas);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedEn.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
	...
	public void testSequencerCapabilityLanguageEnResultSpec() throws Exception
	{
		...
		try 
		{
			...
			tae.process(cas,resultSpec);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedEnResultSpec.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
	...
	public void testSequencerCapabilityLanguageJa() throws Exception
	{
		...
		try 
		{
			...
			tae.process(cas);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedJa.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
	...
	public void testSequencerCapabilityLanguageJaResultSpec() throws Exception
	{
		...
		try 
		{
			...
			tae.process(cas,resultSpec);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedJaResultSpec.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
	...
	public void testSequencerCapabilityLanguageXunSpec() throws Exception
	{
		...
		try 
		{
			...
			tae.process(cas);
			//check fileoutput
			Assert.assertTrue(FileCompare.compare(junitTestBasePath + "SequencerTest/SequencerTest.txt",junitTestBasePath + "SequencerTest/SequencerCapabilityLanguageExpectedXunSpec.txt"));
			outputReferenceFile.delete();
		} 
		catch(Exception ex)
		{
