...
public class Meeting_Type extends Annotation_Type {
	 ...
	 * @modifiable
	 */
	public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.fit.examples.tutorial.type.Meeting");
	...
	public int getRoom(int addr) {
		if (featOkTst && casFeat_room == null) jcas.throwFeatMissing("room", "org.apache.uima.fit.examples.tutorial.type.Meeting");
	...
	public int getDate(int addr) {
		if (featOkTst && casFeat_date == null) jcas.throwFeatMissing("date", "org.apache.uima.fit.examples.tutorial.type.Meeting");
	...
	public int getStartTime(int addr) {
		if (featOkTst && casFeat_startTime == null) jcas.throwFeatMissing("startTime", "org.apache.uima.fit.examples.tutorial.type.Meeting");
	...
	public int getEndTime(int addr) {
		if (featOkTst && casFeat_endTime == null) jcas.throwFeatMissing("endTime", "org.apache.uima.fit.examples.tutorial.type.Meeting");
	...
	public Meeting_Type(JCas jcas, Type casType) {
		...
		casFeat_room = jcas.getRequiredFeatureDE(casType, "room", "org.apache.uima.fit.examples.tutorial.type.RoomNumber", featOkTst);
		casFeatCode_room = (null == casFeat_room) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl) casFeat_room).getCode();

		casFeat_date = jcas.getRequiredFeatureDE(casType, "date", "org.apache.uima.fit.examples.tutorial.type.DateAnnotation", featOkTst);
		casFeatCode_date = (null == casFeat_date) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl) casFeat_date).getCode();

		casFeat_startTime = jcas.getRequiredFeatureDE(casType, "startTime", "org.apache.uima.fit.examples.tutorial.type.TimeAnnotation", featOkTst);
		casFeatCode_startTime = (null == casFeat_startTime) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl) casFeat_startTime).getCode();

		casFeat_endTime = jcas.getRequiredFeatureDE(casType, "endTime", "org.apache.uima.fit.examples.tutorial.type.TimeAnnotation", featOkTst);
