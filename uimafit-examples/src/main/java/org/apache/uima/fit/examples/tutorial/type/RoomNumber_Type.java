...
public class RoomNumber_Type extends Annotation_Type {
	 ...
	 * @modifiable
	 */
	public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.fit.examples.tutorial.type.RoomNumber");
	...
	public String getBuilding(int addr) {
		if (featOkTst && casFeat_building == null) jcas.throwFeatMissing("building", "org.apache.uima.fit.examples.tutorial.type.RoomNumber");
