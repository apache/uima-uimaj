...
public class UimaAcronym_Type extends Annotation_Type {
	 ...
	 * @modifiable
	 */
	public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.uima.fit.examples.tutorial.type.UimaAcronym");
	...
	public String getExpandedForm(int addr) {
		if (featOkTst && casFeat_expandedForm == null) jcas.throwFeatMissing("expandedForm", "org.apache.uima.fit.examples.tutorial.type.UimaAcronym");
